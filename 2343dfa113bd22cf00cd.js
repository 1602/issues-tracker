	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p43.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p45, model),
					_1: {
						ctor: '::',
						_0: A3(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p49 = page;
				if ((_p49.ctor === 'Just') && (_p49._0.ctor === 'Story')) {
					return _p49._0._2;
				} else {
					return '';
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p50 = persistentData.accessToken;
								if (_p50.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p50._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
			...
			switch (_p52.ctor) {
				...
				case 'PinMilestone':
					...
					var pinnedMilestone = A2(
						...
						'',
						A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
					var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p53) ? '' : _p53;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p56) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p57.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p57.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p57.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p52._0, addIssueToMilestone: _p52._1}),
						{
							ctor: '::',
														...
														_0: {
															...
															_1: _elm_lang$core$Json_Encode$list(
																function () {
																	...
																	switch (_p59.ctor) {
																		case 'Backlog':
																			var _p60 = model.addIssueToMilestone;
																			if (_p60 === '') {
																				return {
																					ctor: '::',
																		...
																		if (_p62.ctor === 'Current') {
																			...
																			if (_p63.ctor === 'Just') {
																				return _elm_lang$core$Json_Encode$list(
																					{
																						ctor: '::',
																						_0: _elm_lang$core$Json_Encode$string(_p63._0.login),
																						_1: {ctor: '[]'}
																					});
																			} else {
																				return _elm_lang$core$Json_Encode$list(
						...
						if (_p66.ctor === 'Just') {
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p67 = _p69;
										if (_p67.ctor === 'Backlog') {
											var _p68 = _p52._1;
											if (_p68.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p68._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p69);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p70.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p70._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p52._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p72 = _p52._0;
					var _p71 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v58_2:
					do {
						if (_p71.ctor === 'Just') {
							switch (_p71._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p72.number, _p71._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p72.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p73 = _p52._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p73.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p73, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p74.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p75.ctor === 'Just') {
												var _p77 = _p75._0;
												var _p76 = _p83;
												if (_p76.ctor === 'IssueOpen') {
													var m = _p77.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p82)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p77,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p82),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p82)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p77,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p82),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p78 = updatedModel.milestones;
							if (_p78.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p78._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p79 = _p83;
									if (_p79.ctor === 'IssueClosed') {
										var _p80 = ms.closedIssues;
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p52._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p92.ctor === 'Just') {
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p52._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
				...
				case 'SetMilestone':
					...
					if (_p93.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p94.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p95.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p93._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p95)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
						...
						function () {
							...
							if (_p97.ctor === 'Just') {
								...
								if (_p98.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p98._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p99.ctor === 'Just') {
								...
								if (_p100.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p100._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p101.ctor === 'Just') {
								...
								if (_p102.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p102._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
				...
				default:
					...
					if (_p103.ctor === 'Just') {
						...
						switch (_p104) {
							case 'unplan':
								var _p105 = _p108.milestone;
								if (_p105.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p108.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p108,
												_p107,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p105._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p108.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p106._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p107,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p108.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p108.number}),
									{
										...
										_0: A5(
											...
											_p107,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p108.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p108.number}),
									{
										...
										_0: A5(
											...
											_p107,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p108.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p108)
										}),
									{ctor: '[]'});
							case 'ice':
								return A2(
