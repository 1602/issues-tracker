...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.12.1") ] );
...
/***/ function(module, exports) {
									...
									var _p5 = _elm_lang$core$List$head(
										A2(
											...
											function (_p3) {
												...
												return _elm_lang$core$Native_Utils.eq(
													'etag',
													_elm_lang$core$String$toLower(_p4._0)) ? _elm_lang$core$Maybe$Just(_p4._1) : _elm_lang$core$Maybe$Nothing;
											},
											_elm_lang$core$Dict$toList(
												A2(
													_elm_lang$core$Debug$log,
													A2(_elm_lang$core$Basics_ops['++'], 'headers ', url),
													res.headers))));
									if (_p5.ctor === 'Just') {
										return _elm_lang$core$Result$Ok(
											A3(_moarwick$elm_webpack_starter$Models$CachedData, url, _p5._0, res.body));
									} else {
										return _elm_lang$core$Result$Ok(
	...
	var _moarwick$elm_webpack_starter$Services$fetchIssues = F2(
		function (model, column) {
			...
			var since = function () {
				var _p6 = column;
				if (_p6.ctor === 'Done') {
					var _p7 = model.settings.doneLimit;
					switch (_p7) {
						case 'a day':
			...
			var filterByUser = function () {
				...
				switch (_p11.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p11._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p11._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p11._0);
					default:
						return '';
				}
			}();
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F3(
		function (model, issueState, ms) {
			...
			var since = function () {
				var _p12 = issueState;
				if (_p12.ctor === 'ClosedIssue') {
					var _p13 = model.settings.doneLimit;
					switch (_p13) {
						case 'a day':
							return A2(pastMoment, -1, _justinmimbs$elm_date_extra$Date_Extra$Day);
						case 'a week':
			...
			var filterByUser = function () {
				...
				switch (_p15.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p15._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p15._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p15._0);
					default:
						return '';
				}
			}();
				...
				switch (_p60.ctor) {
					...
					case 'FetchComplete':
						...
						if (_p61.ctor === 'Ok') {
							...
							switch (_p62.ctor) {
								case 'CachedData':
									var _v50 = _p65(
										_elm_lang$core$Maybe$Just(_p62._2)),
										_v51 = _elm_lang$core$Native_Utils.update(
										model,
										{
											etags: A3(_elm_lang$core$Dict$insert, _p62._0, _p62._1, model.etags)
										});
									msg = _v50;
									model = _v51;
									continue update;
								case 'NotModified':
									var _v52 = _p65(_elm_lang$core$Maybe$Nothing),
										_v53 = model;
									msg = _v52;
									model = _v53;
									continue update;
							...
							var _p64 = _p61._0;
							var _p63 = _p64;
							if (_p63.ctor === 'BadStatus') {
								if (_elm_lang$core$Native_Utils.eq(_p63._0.status.code, 304)) {
									var _v57 = _p65(_elm_lang$core$Maybe$Nothing),
										_v58 = model;
									msg = _v57;
									model = _v58;
									continue update;
					...
					case 'PinMilestone':
						...
						var pinnedMilestone = A2(
							...
							'',
							A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
						var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p66) ? '' : _p66;
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
							...
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									filter: function () {
										...
										switch (_p69) {
											case 'assigned to me':
												return _moarwick$elm_webpack_starter$Models$AssignedTo(_p70.login);
											case 'created by me':
												return _moarwick$elm_webpack_starter$Models$CreatedBy(_p70.login);
											case 'mentioning me':
												return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p70.login);
											default:
									...
									_1: {
										...
										_0: {
											...
											_1: _elm_lang$core$Json_Encode$list(
												function () {
													...
													switch (_p71.ctor) {
														case 'Backlog':
															var _p72 = model.addIssueToMilestone;
															if (_p72 === '') {
																return {
																	ctor: '::',
										...
										_1: {
											...
											_0: {
												...
												_0: 'milestone',
												_1: function () {
													var _p73 = model.addIssueToMilestone;
													if (_p73 === '') {
											...
											_1: {
												...
												_0: {
													...
													_1: function () {
														var _p74 = _p76;
														if (_p74.ctor === 'Current') {
															var _p75 = model.user;
															if (_p75.ctor === 'Just') {
																return _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p75._0.login),
																		_1: {ctor: '[]'}
																	});
															} else {
																return _elm_lang$core$Json_Encode$list(
						...
						var cmd = (!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
							...
							_1: {
								...
								_0: A4(
									...
									model.accessToken,
									encodedIssue,
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p76, milestone)),
								_1: {ctor: '[]'}
							}
						} : {ctor: '[]'};
						return A2(
						...
						if (_p77.ctor === 'Err') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p78 = _p80;
										if (_p78.ctor === 'Backlog') {
											var _p79 = _p60._1;
											if (_p79.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p79._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p80);
										}
									}(),
									_1: {ctor: '[]'}
								});
					...
					case 'LoadUser':
						...
						if (_p81.ctor === 'Ok') {
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p81._0),
									error: _elm_lang$core$Maybe$Nothing
								});
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'SelectStory':
						var _p85 = _p60._0;
						var _p84 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
						_v71_2:
						do {
							if (_p84.ctor === 'Just') {
								switch (_p84._0.ctor) {
									case 'Story':
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(_p85.number, _p84._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'#/',
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															model.repo,
															A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p85.number)))),
												_1: {ctor: '[]'}
											});
									case 'IssuesIndex':
										return A2(
					...
					case 'UrlChange':
						var _p86 = _p60._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p86.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p86, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var updateMilestoneIssues = F2(
							function (issues, s) {
								...
								if (_p87.ctor === 'Just') {
									var _p89 = _p87._0;
									var _p88 = _p95;
									if (_p88.ctor === 'OpenIssue') {
										var m = _p89.milestone;
						...
						var mss = function () {
							var _p91 = updatedModel.milestones;
							if (_p91.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p91._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p92 = _p95;
									if (_p92.ctor === 'ClosedIssue') {
										var _p93 = ms.closedIssues;
					...
					case 'LoadMilestones':
						var result = A2(
							...
							A2(_elm_lang$core$Maybe$withDefault, '[]', _p60._0));
						var _p96 = result;
						if (_p96.ctor === 'Err') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'SetMilestone':
						var _p105 = _p60._1;
						var _p104 = _p60._0;
						var _p103 = model.accessToken;
						if (_p103.ctor === 'Just') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p104.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p105.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p103._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p105)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						return A2(
							...
							function () {
								...
								if (_p106.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p106._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p107.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p107._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
					...
					default:
						...
						if (_p109.ctor === 'Just') {
							...
							switch (_p110) {
								case 'unplan':
									var _p111 = _p115.milestone;
									if (_p111.ctor === 'Just') {
										return A2(
											_elm_lang$core$Platform_Cmd_ops['!'],
											_elm_lang$core$Native_Utils.update(
												model,
												{lockedIssueNumber: _p115.number}),
											{
												ctor: '::',
												_0: A5(
													_moarwick$elm_webpack_starter$Services$updateIssueWith,
													...
													_p114,
													_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p111._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p115.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p112._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p114,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p115.milestone)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p115.number}),
										{
											...
											_0: A5(
												...
												_p114,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p115.milestone)),
											_1: {ctor: '[]'}
										});
								case 'reopen':
									return A2(
											...
											{lockedIssueNumber: _p115.number}),
										{
											...
											_0: A5(
												...
												_p114,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p115.milestone)),
											_1: {ctor: '[]'}
										});
								case 'unstart':
									return A2(
								...
								case 'plan':
									return A2(
										...
										_elm_lang$core$Native_Utils.update(
											model,
											{
												pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p115)
											}),
										{ctor: '[]'});
								case 'ice':
									return A2(
