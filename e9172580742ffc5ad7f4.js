...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.14.0") ] );
						...
						_1: {
							...
							_0: A3(
								...
								A2(
									_elm_lang$core$Maybe$andThen,
									function (htmlNode) {
										var _p48 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$OpenIssue);
										if (_p48.ctor === 'Just') {
											return _elm_lang$core$Maybe$Just(
												A2(
													_elm_lang$html$Html$div,
								...
								_1: {
									...
									_0: A3(
										...
										A2(
											_elm_lang$core$Maybe$andThen,
											function (htmlNode) {
												var _p49 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$ClosedIssue);
												if (_p49.ctor === 'Just') {
													return _elm_lang$core$Maybe$Just(
														A2(
															_elm_lang$html$Html$div,
				...
				switch (_p62.ctor) {
					...
					case 'UrlChange':
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p93, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var mss = function () {
							var _p97 = updatedModel.milestones;
							if (_p97.ctor === 'Just') {
