								...
								'Version',
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('this app is in development, sometimes you need to refresh app very hard in order to have some old bugs fixed (and grab some new bugs at the same time), this version number will help you to find whether your cached app version is latest (same as '),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$a,
		...
		function (msg, model) {
			...
			while (true) {
				...
				switch (_p57.ctor) {
					...
					case 'FetchComplete':
						...
						if (_p58.ctor === 'Ok') {
							...
							if (_p60.ctor === 'BadStatus') {
								return _elm_lang$core$Native_Utils.eq(_p60._0.status.code, 304) ? A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'}) : A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
							...
							if (_p76.ctor === 'Just') {
								return A2(
									...
									model,
									{
										...
										_0: function () {
											var _p77 = _p79;
											if (_p77.ctor === 'Backlog') {
												var _p78 = _p57._1;
												if (_p78.ctor === 'Just') {
													return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p78._0);
												} else {
													return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
												}
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p79);
											}
										}(),
										_1: {ctor: '[]'}
									});
					...
					case 'LoadUser':
						...
						if (_p80.ctor === 'Ok') {
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p80._0),
									error: _elm_lang$core$Maybe$Nothing
								});
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'SelectStory':
						var _p82 = _p57._0;
						var _p81 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
						_v67_2:
						do {
							if (_p81.ctor === 'Just') {
								switch (_p81._0.ctor) {
									case 'Story':
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(_p82.number, _p81._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'#/',
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															model.repo,
															A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p82.number)))),
												_1: {ctor: '[]'}
											});
									case 'IssuesIndex':
										return A2(
					...
					case 'UrlChange':
						var _p83 = _p57._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p83.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p83, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
									...
									A3(
										...
										function (s) {
											...
											if (_p84.ctor === 'Just') {
												var _p86 = _p84._0;
												var _p85 = _p91;
												if (_p85.ctor === 'IssueOpen') {
													var m = _p86.milestone;
						...
						var mss = function () {
							var _p87 = updatedModel.milestones;
							if (_p87.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p87._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p88 = _p91;
									if (_p88.ctor === 'IssueClosed') {
										var _p89 = ms.closedIssues;
						...
						if (_p92.ctor === 'Err') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p92._0))
									}),
								{ctor: '[]'});
						} else {
							var _p95 = _p92._0;
						...
						return A2(
							...
							function () {
								...
								if (_p98.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p57._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
					...
					case 'SetMilestone':
						...
						if (_p99.ctor === 'Just') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p100.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p101.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p99._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p101)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
							...
							function () {
								...
								if (_p103.ctor === 'Just') {
									...
									if (_p104.ctor === 'Just') {
										return {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p104._0),
											_1: {
												ctor: '::',
												_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
												_1: {ctor: '[]'}
							...
							function () {
								...
								if (_p105.ctor === 'Just') {
									...
									if (_p106.ctor === 'Just') {
										return {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p106._0),
											_1: {
												ctor: '::',
												_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
												_1: {ctor: '[]'}
							...
							function () {
								...
								if (_p107.ctor === 'Just') {
									...
									if (_p108.ctor === 'Just') {
										return {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p108._0),
											_1: {
												ctor: '::',
												_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
												_1: {ctor: '[]'}
