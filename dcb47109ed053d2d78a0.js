...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F7(
		function (_p10, allowAdd, issues, col, model, addto, milestoneNumber) {
			var _p11 = _p10;
			var milestone = function () {
				var _p12 = _elm_lang$core$List$head(issues);
				if (_p12.ctor === 'Just') {
					return _p12._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
											...
											_0: A2(
												...
												},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															A2(_elm_lang$core$Maybe$withDefault, '', _p11._0),
					...
					function (expandedMilestone) {
						var heading = {
							...
							_1: A2(
								...
								function () {
									var _p15 = expandedMilestone.milestone.dueOn;
									if (_p15.ctor === 'Just') {
										var _p16 = _p15._0;
										return (_elm_lang$core$Native_Utils.cmp(
											...
											_elm_lang$core$Basics_ops['++'],
											' due in ',
											A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p16));
									} else {
										return ' (no due date)';
									}
								}())
							...
							function (head, issues) {
								...
								if (_p17.ctor === 'Just') {
									...
									if (_p18.ctor === 'IssueOpen') {
										...
										return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p19, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
		...
		function (user, model, route) {
					...
					return A2(
						...
						A2(
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p25._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p26.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p27, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								...
								_elm_lang$core$Dict$values(_p23._0))));
				} else {
						...
						function (list, title, add, result) {
							return (_elm_lang$core$List$isEmpty(list) && (!add)) ? result : ((_elm_lang$core$List$isEmpty(list) && add) ? A2(
								...
								result,
								{
									...
									_0: A7(
										_moarwick$elm_webpack_starter$Main$listIssues,
										{ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: title},
										add,
										list,
										col,
										model,
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p29.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p29._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p30.ctor === 'Just') {
						var _p34 = _p30._0;
						var mss = _elm_lang$core$Dict$values(_p34);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p31 = issueState;
									if (_p31.ctor === 'IssueClosed') {
										var _p32 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p34, issueState, model.now, model) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
								...
								_1: {
									...
									_0: function () {
										...
										if (_p36.ctor === 'Just') {
											...
											var filteredIssues = A2(_elm_lang$core$List$filter, filter, _p36._0);
											return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, filteredIssues, _moarwick$elm_webpack_starter$Models$Icebox, model, _moarwick$elm_webpack_starter$Models$Backlog, '');
										} else {
											return A2(
												_elm_lang$html$Html$span,
												{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: function () {
											var _p37 = model.currentIssues;
											if (_p37.ctor === 'Just') {
												return A2(
													_elm_lang$html$Html$div,
													{ctor: '[]'},
													A2(displayIssuesGroupedByDate, _p37._0, _moarwick$elm_webpack_starter$Models$Current));
											} else {
												return _elm_lang$html$Html$text('Loading current issues');
											}
										}(),
										_1: {ctor: '[]'}
									}
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p42.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A3(_moarwick$elm_webpack_starter$Main$viewTopbar, _p45, model.location, model),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p43 = model.pickMilestoneForIssue;
									if (_p43.ctor === 'Just') {
										var _p44 = _p43._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p44.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p44.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p44, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
			...
			switch (_p48.ctor) {
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p50) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p51.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p51.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p51.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p48._0, addIssueToMilestone: _p48._1}),
						{ctor: '[]'});
						...
						return A2(
							...
							(!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
								...
								_0: A4(
													...
													_1: {
																...
																if (_p54.ctor === 'Just') {
																	return _elm_lang$core$Json_Encode$int(
																		A2(
																			_elm_lang$core$Result$withDefault,
																			0,
																			_elm_lang$core$String$toInt(_p54._0.number)));
																} else {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p55 = _p57;
																	if (_p55.ctor === 'Current') {
																		var _p56 = model.user;
																		if (_p56.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p56._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
									...
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p57, _p58)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'});
					} else {
						return A2(
						...
						if (_p60.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p61 = _p64;
										if (_p61.ctor === 'Backlog') {
											var _p62 = _p48._1;
											if (_p62.ctor === 'Just') {
												return A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p63, _moarwick$elm_webpack_starter$Models$IssueOpen, _p62._0);
											} else {
												return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p63, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p63, _p64);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p65.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p65._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p48._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p67 = _p48._0;
					var _p66 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v53_2:
					do {
						if (_p66.ctor === 'Just') {
							switch (_p66._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p67.number, _p66._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p67.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p68 = _p48._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p68.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p68, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p69.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p70.ctor === 'Just') {
												var _p72 = _p70._0;
												var _p71 = _p78;
												if (_p71.ctor === 'IssueOpen') {
													var m = _p72.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p77)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p72,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p77),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p77)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p72,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p77),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p73 = updatedModel.milestones;
							if (_p73.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p73._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p74 = _p78;
									if (_p74.ctor === 'IssueClosed') {
										var _p75 = ms.closedIssues;
							...
							function () {
								...
								if (_p81.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p82, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p82, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
					...
					if (_p85.ctor === 'Ok') {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p87),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p87),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p87),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p85._0))
								}),
							{ctor: '[]'});
					}
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p48._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p88 = model.accessToken;
							if (_p88.ctor === 'Just') {
								var _p89 = _p88._0;
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p89, _moarwick$elm_webpack_starter$Models$IssueOpen, _p48._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p89, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					...
					if (_p90.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p91.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p92.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p90._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p92)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'MilestoneSet':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p93 = model.accessToken;
							if (_p93.ctor === 'Just') {
								var _p94 = _p93._0;
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$IssueOpen, _p48._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p95.ctor === 'Just') {
								...
								if (_p96.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$IssueClosed, _p96._0),
										_1: {
											ctor: '::',
									...
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p98.ctor === 'Just') {
								...
								if (_p99.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p100, _moarwick$elm_webpack_starter$Models$IssueOpen, _p99._0),
										_1: {
											ctor: '::',
									...
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p100, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p101.ctor === 'Just') {
								...
								if (_p102.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p103, _moarwick$elm_webpack_starter$Models$IssueClosed, _p102._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p103, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p103, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p104.ctor === 'Just') {
						...
						switch (_p105) {
							case 'unplan':
								var _p106 = _p109.milestone;
								if (_p106.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p109.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p109,
												_p108,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p106._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p109.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p107._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p108,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p109.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p109.number}),
									{
										...
										_0: A5(
											...
											_p108,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p109.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p109.number}),
									{
										...
										_0: A5(
											...
											_p108,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p109.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p109)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p110 = page;
				if ((_p110.ctor === 'Just') && (_p110._0.ctor === 'Story')) {
					return _p110._0._2;
				} else {
					return '';
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p111 = persistentData.accessToken;
								if (_p111.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p111._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
