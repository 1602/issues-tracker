...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		...
		if (_p31.ctor === 'Nothing') {
			var _p32 = model.accessToken;
			if (_p32.ctor === 'Just') {
				var _p34 = _p32._0;
				var _p33 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p33.ctor === 'Just') {
					switch (_p33._0.ctor) {
						case 'Story':
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p34);
						case 'IssuesIndex':
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p34);
						default:
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p34);
			...
			switch (_p36.ctor) {
					...
					if (_p37.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p37._0),
									error: _elm_lang$core$Maybe$Nothing
								}),
							{ctor: '[]'});
					} else {
				...
				case 'CurrentTime':
					return A2(
						...
						function () {
							var _p38 = model.accessToken;
							if (_p38.ctor === 'Just') {
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p38._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p40 = _p36._0;
					var _p39 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v33_2:
					do {
						if (_p39.ctor === 'Just') {
							switch (_p39._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p40.number, _p39._0._0) ? _elm_lang$navigation$Navigation$modifyUrl('#/stories') : _elm_lang$navigation$Navigation$modifyUrl(
												A2(_elm_lang$core$Basics_ops['++'], '#/stories/', _p40.number)),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
										...
										A3(
											...
											function (s) {
												...
												if (_p43.ctor === 'Just') {
													var _p45 = _p43._0;
													var _p44 = _p36._1;
													if (_p44.ctor === 'IssueOpen') {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p45,
																{
																	openIssues: _elm_lang$core$Maybe$Just(_p46)
																}));
													} else {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p45,
																{
																	closedIssues: _elm_lang$core$Maybe$Just(_p46)
																}));
													}
												} else {
													return _elm_lang$core$Maybe$Nothing;
							...
							function () {
								...
								if (_p49.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p50, _moarwick$elm_webpack_starter$Models$IssueOpen),
											_p51),
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p50, _moarwick$elm_webpack_starter$Models$IssueClosed),
											_p51));
								} else {
									return {ctor: '[]'};
								}
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p54),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p54),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
				...
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p55 = model.accessToken;
							if (_p55.ctor === 'Just') {
								var _p56 = _p55._0;
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p56, _moarwick$elm_webpack_starter$Models$IssueOpen, _p36._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p56, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					...
					if (_p57.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p58.number}),
							{
								ctor: '::',
								_0: A4(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p59.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p57._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p59)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p60.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p61, _moarwick$elm_webpack_starter$Models$IssueOpen, _p36._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p61, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p62.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p63, _moarwick$elm_webpack_starter$Models$IssueClosed, _p36._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p63, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p64.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p65, _moarwick$elm_webpack_starter$Models$IssueOpen, _p36._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p65, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p66.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p67, _moarwick$elm_webpack_starter$Models$IssueClosed, _p36._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p67, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				default:
					...
					if (_p68.ctor === 'Just') {
						...
						switch (_p69) {
							case 'unplan':
								var _p70 = _p76.milestone;
								if (_p70.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p76.number}),
										{
											ctor: '::',
											_0: A3(
												...
												_p76,
												_p75,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p70._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p76.number}),
										{
											...
											_0: A4(
												...
												_p75,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p71._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p76.number}),
										{
											...
											_0: A4(
												...
												_p75,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p72._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p76.number}),
										{
											...
											_0: A4(
												...
												_p75,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p73._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'gh':
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$load(_p76.htmlUrl),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								var _p74 = _p76.milestone;
								if (_p74.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p76)
										}),
									{ctor: '[]'});
							default:
								return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p77 = persistentData.accessToken;
								if (_p77.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p77._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
							_1: {
								ctor: '::',
								_0: function () {
									var _p78 = _moarwick$elm_webpack_starter$Route$parseHash(location);
