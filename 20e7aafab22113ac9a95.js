...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Models$PersistedData = function (a) {
						...
						return function (f) {
							return function (g) {
								return function (h) {
									return function (i) {
										return function (j) {
											return {number: a, state: b, title: c, description: d, creator: e, assignees: f, milestone: g, htmlUrl: h, labels: i, createdAt: j};
										};
									};
								};
							};
	...
	var _moarwick$elm_webpack_starter$Messages$CreateStory = F2(
		function (a, b) {
			return {ctor: 'CreateStory', _0: a, _1: b};
		});
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestones = F2(
		function (repo, accessToken) {
			return A2(
				_elm_lang$http$Http$send,
				_moarwick$elm_webpack_starter$Messages$LoadMilestones,
				_elm_lang$http$Http$request(
					{
						method: 'GET',
						headers: {
						...
						url: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								repo,
								A2(_elm_lang$core$Basics_ops['++'], '/milestones?access_token=', accessToken))),
	...
	var _moarwick$elm_webpack_starter$Services$fetchIssues = F4(
		function (filter, repo, accessToken, column) {
			var filterByUser = function () {
				var _p2 = filter;
				switch (_p2.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p2._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p2._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p2._0);
					default:
						return '';
				}
			}();
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												state,
												A2(_elm_lang$core$Basics_ops['++'], milestone, filterByUser))))))),
						expect: _elm_lang$http$Http$expectJson(
							A2(
								_elm_lang$core$Json_Decode$at,
								{ctor: '[]'},
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F5(
		function (filter, repo, accessToken, issueState, ms) {
			var filterByUser = function () {
				var _p6 = filter;
				switch (_p6.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p6._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p6._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p6._0);
					default:
						return '';
				}
			}();
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												'&milestone=',
												A2(_elm_lang$core$Basics_ops['++'], ms.number, filterByUser))))))),
						expect: _elm_lang$http$Http$expectJson(
							A2(
								_elm_lang$core$Json_Decode$at,
								{ctor: '[]'},
	...
	var _moarwick$elm_webpack_starter$Main$viewTopbar = F3(
		function (user, location, model) {
			return A2(
	...
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p2 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p2.ctor === 'Just') && (_p2._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p3 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p2._0._2)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadAllIssues = function (model) {
		...
		if (_p4.ctor === 'Just') {
			...
			return {
				ctor: '::',
				_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p5, _moarwick$elm_webpack_starter$Models$Current),
				_1: {
					ctor: '::',
					_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p5, _moarwick$elm_webpack_starter$Models$Icebox),
					_1: {
						ctor: '::',
						_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p5, _moarwick$elm_webpack_starter$Models$Done),
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Services$fetchMilestones, model.repo, _p5),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p6 = model.currentIssues;
		if (_p6.ctor === 'Nothing') {
			var _p7 = model.user;
			if (_p7.ctor === 'Just') {
				var _p8 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p8.ctor === 'Just') {
					switch (_p8._0.ctor) {
						case 'Story':
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F6(
		function (head, issues, col, model, addto, milestoneNumber) {
			var milestone = function () {
				var _p10 = _elm_lang$core$List$head(issues);
				if (_p10.ctor === 'Just') {
					return _p10._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
			...
			var getPriorityColor = function (issue) {
				return A2(
					...
					A3(
						...
						F2(
							function (l, res) {
								return _elm_lang$core$Native_Utils.eq(l.name, 'Priority: High') ? _elm_lang$core$Maybe$Just('orange') : (_elm_lang$core$Native_Utils.eq(l.name, 'Priority: Critical') ? _elm_lang$core$Maybe$Just('#fd4242') : res);
							}),
						_elm_lang$core$Maybe$Nothing,
						issue.labels));
			};
				...
				function (list) {
							...
							_0: A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _moarwick$elm_webpack_starter$Main$cellExStyle(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'width', _1: '408px'},
											_1: {
												ctor: '::',
					...
					function (list) {
						...
						if (_p12.ctor === 'Done') {
							...
							return {
								ctor: '::',
								_0: (_elm_lang$core$Native_Utils.eq(model.addIssueToColumn, addto) && _elm_lang$core$Native_Utils.eq(model.addIssueToMilestone, milestoneNumber)) ? A2(
									_elm_lang$html$Html$form,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onSubmit(
												A2(_moarwick$elm_webpack_starter$Messages$CreateStory, col, milestone)),
											_1: {ctor: '[]'}
										}
									},
									{
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('add another story'),
										_1: {ctor: '[]'}
									}),
								_1: list
							};
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_0: A2(
																									button,
																									issue,
																									A2(_moarwick$elm_webpack_starter$Main$hasLabel, 'Status: Ready', issue) ? 'put on ice' : 'just do it'),
																								_1: {ctor: '[]'}
																							}
																						}
																					};
				...
				A2(
					...
					function (expandedMilestone) {
						var heading = A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$strong,
									{
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'color', _1: 'yellowgreen'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'line-height', _1: '22px'},
													_1: {
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href(expandedMilestone.milestone.htmlUrl),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														A2(_elm_lang$core$Basics_ops['++'], expandedMilestone.milestone.title, ' ')),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p14 = expandedMilestone.milestone.dueOn;
										if (_p14.ctor === 'Just') {
											var _p15 = _p14._0;
											return (_elm_lang$core$Native_Utils.cmp(
												...
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(now))) < 0) ? _elm_lang$html$Html$text(' overdue') : _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													' due in ',
													A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p15)));
										} else {
											return _elm_lang$html$Html$text(' (no due date)');
										}
									}(),
									_1: {ctor: '[]'}
								}
							...
							function (head, issues) {
								...
								if (_p16.ctor === 'Just') {
									...
									if (_p17.ctor === 'IssueOpen') {
										...
										return A6(_moarwick$elm_webpack_starter$Main$listIssues, head, _p18, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
						...
						var issues = function (head) {
							var _p19 = issueState;
							if (_p19.ctor === 'IssueOpen') {
								return A2(
									displayIssuesOrLoading,
									_elm_lang$core$Maybe$Just(head),
									expandedMilestone.openIssues);
							} else {
								return A2(
									displayIssuesOrLoading,
									_elm_lang$core$Maybe$Just(head),
									expandedMilestone.closedIssues);
							}
						};
		...
		function (user, model, route) {
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									var _p23 = s.milestone.dueOn;
									if (_p23.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p23._0),
														...
														_1: {
															...
															_1: {
																...
																_0: {
																	...
																	_0: 'border-left',
																	_1: function () {
																		var _p24 = s.milestone.dueOn;
																		if (_p24.ctor === 'Just') {
																			return A2(
																				_elm_lang$core$Basics_ops['++'],
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p24._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p25.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p26, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								_elm_lang$core$List$sortBy,
								function (s) {
									var _p27 = s.milestone.dueOn;
									if (_p27.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p27._0));
									} else {
										return 1 / 0;
									}
								},
								_elm_lang$core$Dict$values(_p22._0))));
				} else {
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p28.ctor === 'Just') {
						return A6(
							_moarwick$elm_webpack_starter$Main$listIssues,
							head,
							A2(_elm_lang$core$List$filter, filter, _p28._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p29.ctor === 'Just') {
						var _p33 = _p29._0;
						var mss = _elm_lang$core$Dict$values(_p33);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p30 = issueState;
									if (_p30.ctor === 'IssueClosed') {
										var _p31 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p33, issueState, model.now, model) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A6(
									displayIssues,
									_elm_lang$core$Maybe$Nothing,
									_moarwick$elm_webpack_starter$Main$hasNoLabel('Status: Ready'),
									model.iceboxIssues,
										...
										_elm_lang$core$Maybe$Just(
											A2(
												...
												function (s) {
													...
													_elm_lang$html$Html$text('😞 Just do it')))),
										function (which) {
												...
												_elm_lang$core$Maybe$Just(
													A2(
														...
														function (s) {
															...
															_elm_lang$html$Html$text('💪 We just did it')))),
												function (_p35) {
													return true;
												},
												model.closedIssues,
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p39.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A3(_moarwick$elm_webpack_starter$Main$viewTopbar, _p42, model.location, model),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p40 = model.pickMilestoneForIssue;
									if (_p40.ctor === 'Just') {
										var _p41 = _p40._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p41.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p41.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p41, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
			...
			switch (_p45.ctor) {
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p47) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p48.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p48.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p48.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p45._0, addIssueToMilestone: _p45._1}),
						{ctor: '[]'});
				case 'EditNewStoryTitle':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{newIssueTitle: _p45._0}),
						{ctor: '[]'});
				case 'CreateStory':
					var _p55 = _p45._1;
					var _p54 = _p45._0;
					var _p49 = model.accessToken;
					if (_p49.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
							...
							(!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
								...
								_0: A4(
													...
													_1: {
																...
																if (_p51.ctor === 'Just') {
																	return _elm_lang$core$Json_Encode$int(
																		A2(
																			_elm_lang$core$Result$withDefault,
																			0,
																			_elm_lang$core$String$toInt(_p51._0.number)));
																} else {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p52 = _p54;
																	if (_p52.ctor === 'Current') {
																		var _p53 = model.user;
																		if (_p53.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p53._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
									...
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p54, _p55)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'});
					} else {
						return A2(
						...
						if (_p57.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p58 = _p61;
										if (_p58.ctor === 'Backlog') {
											var _p59 = _p45._1;
											if (_p59.ctor === 'Just') {
												return A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p60, _moarwick$elm_webpack_starter$Models$IssueOpen, _p59._0);
											} else {
												return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p60, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p60, _p61);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'UrgentIssueAdded':
					return A2(
						...
						model,
						{
							ctor: '::',
							_0: A4(
								_moarwick$elm_webpack_starter$Services$fetchIssues,
								model.filter,
								model.repo,
				...
				case 'LoadUser':
					...
					if (_p62.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p62._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							...
							_1: {
								...
								_0: _moarwick$elm_webpack_starter$Main$saveData(
									_moarwick$elm_webpack_starter$Models$PersistedData(
										_elm_lang$core$Maybe$Just(model.token))),
								_1: _moarwick$elm_webpack_starter$Main$loadResource(updatedModel)
							}
						});
				case 'CurrentDate':
					return A2(
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p45._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p64 = _p45._0;
					var _p63 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v49_2:
					do {
						if (_p63.ctor === 'Just') {
							switch (_p63._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p64.number, _p63._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p64.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p65 = _p45._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p65.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p65, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p66.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p67.ctor === 'Just') {
												var _p69 = _p67._0;
												var _p68 = _p75;
												if (_p68.ctor === 'IssueOpen') {
													var m = _p69.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p74)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p69,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p74),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p74)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p69,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p74),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p70 = updatedModel.milestones;
							if (_p70.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p70._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p71 = _p75;
									if (_p71.ctor === 'IssueClosed') {
										var _p72 = ms.closedIssues;
					...
					if (_p76.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p76._0))
								}),
							{ctor: '[]'});
					} else {
						var _p80 = _p76._0;
							...
							function () {
								...
								if (_p78.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p79, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p79, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
					...
					if (_p81.ctor === 'Ok') {
						return A2(
								...
								{error: _elm_lang$core$Maybe$Nothing}),
							{
								ctor: '::',
								_0: A2(
									_moarwick$elm_webpack_starter$Services$fetchMilestones,
									model.repo,
									A2(_elm_lang$core$Maybe$withDefault, '', model.accessToken)),
								_1: {ctor: '[]'}
							});
					...
					if (_p82.ctor === 'Ok') {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p84),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p84),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p84),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p82._0))
								}),
							{ctor: '[]'});
					}
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p45._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p85 = model.accessToken;
							if (_p85.ctor === 'Just') {
								var _p86 = _p85._0;
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p86, _moarwick$elm_webpack_starter$Models$IssueOpen, _p45._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p86, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p89 = _p45._1;
					var _p88 = _p45._0;
					var _p87 = model.accessToken;
					if (_p87.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p88.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p89.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p87._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p89)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'MilestoneSet':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p90 = model.accessToken;
							if (_p90.ctor === 'Just') {
								var _p91 = _p90._0;
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p91, _moarwick$elm_webpack_starter$Models$IssueOpen, _p45._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p91, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p92.ctor === 'Just') {
								...
								if (_p93.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$IssueClosed, _p93._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p95.ctor === 'Just') {
								...
								if (_p96.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$IssueOpen, _p96._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p98.ctor === 'Just') {
								...
								if (_p99.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p100, _moarwick$elm_webpack_starter$Models$IssueClosed, _p99._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p100, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p100, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p101.ctor === 'Just') {
						...
						switch (_p102) {
							case 'unplan':
								var _p103 = _p106.milestone;
								if (_p103.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p106.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p106,
												_p105,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p103._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p106.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p104._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p105,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p106.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p106.number}),
									{
										...
										_0: A5(
															...
															A2(
																...
																A2(
																	...
																	A2(
																		_elm_lang$core$List$filter,
																		function (s) {
																			return !_elm_lang$core$Native_Utils.eq(s, 'Status: In Progress');
																		},
																		A2(
																			_elm_lang$core$List$map,
																			function (_) {
											...
											_p105,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p106.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p106.number}),
									{
										...
										_0: A5(
											...
											_p105,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p106.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p106)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
														...
														_1: _elm_lang$core$Json_Encode$list(
															A2(
																...
																A2(
																	_elm_lang$core$List$filter,
																	function (s) {
																		return !_elm_lang$core$Native_Utils.eq(s, 'Status: Ready');
																	},
																	A2(
																		_elm_lang$core$List$map,
																		function (_) {
																...
																return function (p) {
																	return function (q) {
																		return function (r) {
																			return function (s) {
																				return function (t) {
																					return {user: a, token: b, accessToken: c, repo: d, location: e, now: f, error: g, currentIssues: h, iceboxIssues: i, closedIssues: j, milestones: k, pickMilestoneForIssue: l, lockedIssueNumber: m, highlightStory: n, newMilestoneTitle: o, newIssueTitle: p, needFocus: q, addIssueToColumn: r, addIssueToMilestone: s, filter: t};
																				};
																			};
																		};
																	};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p107 = page;
				if ((_p107.ctor === 'Just') && (_p107._0.ctor === 'Story')) {
					return _p107._0._2;
				} else {
					return '';
				}
			}();
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				!_elm_lang$core$Native_Utils.eq(highlightStory, ''))(_moarwick$elm_webpack_starter$Models$Done)('')(_moarwick$elm_webpack_starter$Models$All);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p108 = persistentData.accessToken;
								if (_p108.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p108._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
									...
									if (_p109.ctor === 'Nothing') {
										return _elm_lang$navigation$Navigation$modifyUrl(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'#/',
												A2(_elm_lang$core$Basics_ops['++'], model.repo, '/stories')));
									} else {
										return _elm_lang$core$Platform_Cmd$none;
									}
								}(),
