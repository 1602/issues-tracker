...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Models$Issue = F8(
		function (a, b, c, d, e, f, g, h) {
			return {number: a, state: b, title: c, description: d, assignees: e, milestone: f, htmlUrl: g, labels: h};
		});
	var _moarwick$elm_webpack_starter$Models$Label = F3(
		function (a, b, c) {
			return {id: a, name: b, color: c};
		});
	var _moarwick$elm_webpack_starter$Models$Milestone = F8(
		function (a, b, c, d, e, f, g, h) {
			return {id: a, number: b, state: c, title: d, description: e, openIssues: f, closedIssues: g, dueOn: h};
		});
	...
	var _moarwick$elm_webpack_starter$Decoders$decodeStringToDate = A2(
		...
		_elm_lang$core$Json_Decode$string);
	var _moarwick$elm_webpack_starter$Decoders$milestoneDecoder = A9(
		_elm_lang$core$Json_Decode$map8,
		_moarwick$elm_webpack_starter$Models$Milestone,
		A2(_elm_lang$core$Json_Decode$field, 'id', _moarwick$elm_webpack_starter$Decoders$decodeIntToString),
		A2(_elm_lang$core$Json_Decode$field, 'number', _moarwick$elm_webpack_starter$Decoders$decodeIntToString),
		...
		A2(_elm_lang$core$Json_Decode$field, 'closed_issues', _elm_lang$core$Json_Decode$int),
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'due_on', _moarwick$elm_webpack_starter$Decoders$decodeStringToDate)));
	var _moarwick$elm_webpack_starter$Decoders$issueDecoder = A9(
		_elm_lang$core$Json_Decode$map8,
		_moarwick$elm_webpack_starter$Models$Issue,
		A2(_elm_lang$core$Json_Decode$field, 'number', _moarwick$elm_webpack_starter$Decoders$decodeIntToString),
		A2(_elm_lang$core$Json_Decode$field, 'state', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
		...
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'milestone', _moarwick$elm_webpack_starter$Decoders$milestoneDecoder)),
	...
	var _moarwick$elm_webpack_starter$Services$fetchIssues = F3(
		function (repo, accessToken, column) {
			var state = function () {
				var _p2 = column;
				if (_p2.ctor === 'Done') {
					return '&state=closed';
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											labels,
											A2(_elm_lang$core$Basics_ops['++'], state, milestone)))))),
						expect: _elm_lang$http$Http$expectJson(
							A2(
								_elm_lang$core$Json_Decode$at,
								{ctor: '[]'},
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F4(
		function (repo, accessToken, issueState, ms) {
			var state = function () {
				var _p5 = issueState;
				if (_p5.ctor === 'IssueOpen') {
					return '&state=open';
				} else {
					return '&state=closed';
				}
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											state,
											A2(_elm_lang$core$Basics_ops['++'], '&milestone=', ms.number)))))),
						expect: _elm_lang$http$Http$expectJson(
							A2(
								_elm_lang$core$Json_Decode$at,
								{ctor: '[]'},
	...
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p1 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p1.ctor === 'Just') && (_p1._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p2 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p1._0._2)));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	};
	var _moarwick$elm_webpack_starter$Main$loadAllIssues = F2(
		function (repo, accessToken) {
			return {
				ctor: '::',
				_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, repo, accessToken, _moarwick$elm_webpack_starter$Models$Current),
				_1: {
					ctor: '::',
					_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, repo, accessToken, _moarwick$elm_webpack_starter$Models$Icebox),
					_1: {
						ctor: '::',
						_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, repo, accessToken, _moarwick$elm_webpack_starter$Models$Done),
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Services$fetchMilestones, repo, accessToken),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		...
		if (_p3.ctor === 'Nothing') {
			...
			if (_p4.ctor === 'Just') {
				...
				if (_p5.ctor === 'Just') {
					var _p7 = _p5._0;
					var _p6 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					if (_p6.ctor === 'Just') {
						switch (_p6._0.ctor) {
							case 'Story':
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p7);
							case 'IssuesIndex':
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p7);
							default:
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p7);
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F6(
		function (head, issues, col, model, addto, milestoneNumber) {
			var milestone = function () {
				var _p9 = _elm_lang$core$List$head(issues);
				if (_p9.ctor === 'Just') {
					return _p9._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
			...
			return _elm_lang$core$List$isEmpty(issues) ? _elm_lang$html$Html$text('') : A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				function (list) {
					var _p10 = head;
								...
								_0: (_elm_lang$core$Native_Utils.eq(model.addIssueToColumn, addto) && _elm_lang$core$Native_Utils.eq(model.addIssueToMilestone, milestoneNumber)) ? A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('add a story'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
			...
			return A2(
				...
				A2(
						...
						var heading = A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p13 = expandedMilestone.milestone.dueOn;
										if (_p13.ctor === 'Just') {
											var _p14 = _p13._0;
											return (_elm_lang$core$Native_Utils.cmp(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' due in ',
													A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p14)));
										} else {
							...
							function (head, issues) {
								...
								if (_p15.ctor === 'Just') {
									...
									if (_p16.ctor === 'IssueOpen') {
										...
										return A6(_moarwick$elm_webpack_starter$Main$listIssues, head, _p17, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
					...
					A2(
						...
						function (ems) {
							var _p20 = ems.milestone.dueOn;
							if (_p20.ctor === 'Nothing') {
								return 1 / 0;
							} else {
								return _elm_lang$core$Time$inSeconds(
									_elm_lang$core$Date$toTime(_p20._0));
							}
						},
		...
		function (user, model, route) {
					...
					return A2(
						...
						A2(
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p23._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p24.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p25, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								_elm_lang$core$List$sortBy,
								function (s) {
									var _p26 = s.milestone.dueOn;
									if (_p26.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p26._0));
									} else {
										return 1 / 0;
									}
								},
								_elm_lang$core$Dict$values(_p21._0))));
				} else {
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p27.ctor === 'Just') {
						return A6(
							_moarwick$elm_webpack_starter$Main$listIssues,
							head,
							A2(_elm_lang$core$List$filter, filter, _p27._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p28.ctor === 'Just') {
						var _p32 = _p28._0;
						var mss = _elm_lang$core$Dict$values(_p32);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p29 = issueState;
									if (_p29.ctor === 'IssueClosed') {
										var _p30 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p32, issueState, model.now, model) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		var error = function () {
			...
			if (_p37.ctor === 'Just') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p37._0),
						_1: {ctor: '[]'}
					});
			} else {
		...
		if (_p38.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p41, model.location),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p39 = model.pickMilestoneForIssue;
									if (_p39.ctor === 'Just') {
										var _p40 = _p39._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p40.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p40.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p40, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
			...
			var _p42 = model.accessToken;
			if (_p42.ctor === 'Nothing') {
				var _p43 = model.error;
				if (_p43.ctor === 'Just') {
					return A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p43._0),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
			...
			switch (_p44.ctor) {
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p44._0, addIssueToMilestone: _p44._1}),
						{ctor: '[]'});
				case 'EditNewStoryTitle':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{newIssueTitle: _p44._0}),
						{ctor: '[]'});
				case 'CreateStory':
					var _p51 = _p44._1;
					var _p50 = _p44._0;
					var _p45 = model.accessToken;
					if (_p45.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								...
								{newIssueTitle: ''}),
							{
								...
								_0: A4(
													...
													_1: {
																...
																if (_p47.ctor === 'Just') {
																	return _elm_lang$core$Json_Encode$int(
																		A2(
																			_elm_lang$core$Result$withDefault,
																			0,
																			_elm_lang$core$String$toInt(_p47._0.number)));
																} else {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p48 = _p50;
																	if (_p48.ctor === 'Backlog') {
																		var _p49 = model.user;
																		if (_p49.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p49._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
									...
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p50, _p51)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
						...
						if (_p53.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p54 = _p57;
										if (_p54.ctor === 'Backlog') {
											var _p55 = _p44._1;
											if (_p55.ctor === 'Just') {
												return A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p56, _moarwick$elm_webpack_starter$Models$IssueOpen, _p55._0);
											} else {
												return A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p56, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p56, _p57);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p58.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p58._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p44._0)
							}),
						function () {
							var _p59 = model.accessToken;
							if (_p59.ctor === 'Just') {
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p59._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p61 = _p44._0;
					var _p60 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v47_2:
					do {
						if (_p60.ctor === 'Just') {
							switch (_p60._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p61.number, _p60._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p61.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p62 = _p44._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p62.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p62, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p63.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p64.ctor === 'Just') {
												var _p66 = _p64._0;
												var _p65 = _p72;
												if (_p65.ctor === 'IssueOpen') {
													var m = _p66.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p71)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p66,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p71),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p71)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p66,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p71),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p67 = updatedModel.milestones;
							if (_p67.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p67._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p68 = _p72;
									if (_p68.ctor === 'IssueClosed') {
										var _p69 = ms.closedIssues;
							...
							function () {
								...
								if (_p75.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
					...
					if (_p79.ctor === 'Ok') {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p81),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p81),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p81),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p79._0))
								}),
							{ctor: '[]'});
					}
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p44._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p82 = model.accessToken;
							if (_p82.ctor === 'Just') {
								var _p83 = _p82._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p83, _moarwick$elm_webpack_starter$Models$IssueOpen, _p44._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p83, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p86 = _p44._1;
					var _p85 = _p44._0;
					var _p84 = model.accessToken;
					if (_p84.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p85.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p86.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p84._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p86)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p87.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p88, _moarwick$elm_webpack_starter$Models$IssueOpen, _p44._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p88, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p89.ctor === 'Just') {
								...
								if (_p90.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p91, _moarwick$elm_webpack_starter$Models$IssueClosed, _p90._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p91, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p91, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p91, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p92.ctor === 'Just') {
								...
								if (_p93.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p94, _moarwick$elm_webpack_starter$Models$IssueOpen, _p93._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p94, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p95.ctor === 'Just') {
								...
								if (_p96.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p97, _moarwick$elm_webpack_starter$Models$IssueClosed, _p96._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p97, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p98.ctor === 'Just') {
						...
						switch (_p99) {
							case 'unplan':
								var _p100 = _p103.milestone;
								if (_p100.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p103.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p103,
												_p102,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p100._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p103.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p101._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p102,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p103.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p103.number}),
									{
										...
										_0: A5(
											...
											_p102,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p103.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p103.number}),
									{
										...
										_0: A5(
											...
											_p102,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p103.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p103)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
															...
															return function (o) {
																return function (p) {
																	return function (q) {
																		return function (r) {
																			return function (s) {
																				return {user: a, token: b, accessToken: c, repo: d, location: e, now: f, error: g, currentIssues: h, iceboxIssues: i, closedIssues: j, milestones: k, pickMilestoneForIssue: l, lockedIssueNumber: m, highlightStory: n, newMilestoneTitle: o, newIssueTitle: p, needFocus: q, addIssueToColumn: r, addIssueToMilestone: s};
																			};
																		};
																	};
																};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p104 = page;
				if ((_p104.ctor === 'Just') && (_p104._0.ctor === 'Story')) {
					return _p104._0._2;
				} else {
					return '';
				}
			...
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				!_elm_lang$core$Native_Utils.eq(highlightStory, ''))(_moarwick$elm_webpack_starter$Models$Done)('');
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p105 = persistentData.accessToken;
								if (_p105.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p105._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
