						...
						var heading = A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p12 = expandedMilestone.milestone.dueOn;
										if (_p12.ctor === 'Just') {
											var _p13 = _p12._0;
											return (_elm_lang$core$Native_Utils.cmp(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' due in ',
													A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p13)));
										} else {
							...
							function (head, issues) {
								...
								if (_p14.ctor === 'Just') {
									...
									if (_p15.ctor === 'IssueOpen') {
										...
										return A5(_moarwick$elm_webpack_starter$Main$listIssues, head, _p16, _moarwick$elm_webpack_starter$Models$Done, lockedIssueNumber, highlightStory);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
		...
		function (user, model, route) {
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p22._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p23.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p24, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
								...
								function (s) {
									...
									if (_p25.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p25._0));
									} else {
										return 1 / 0;
									}
								},
								_elm_lang$core$Dict$values(_p20._0))));
				} else {
				...
				function (head, filter, issues, col, highlightStory) {
					...
					if (_p26.ctor === 'Just') {
						return A5(
							_moarwick$elm_webpack_starter$Main$listIssues,
							head,
							A2(_elm_lang$core$List$filter, filter, _p26._0),
							col,
			...
			var displayIssuesWithinMilestones = F3(
				function (milestones, issueState, highlightStory) {
					...
					if (_p27.ctor === 'Just') {
						var _p31 = _p27._0;
						var mss = _elm_lang$core$Dict$values(_p31);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p28 = issueState;
									if (_p28.ctor === 'IssueClosed') {
										var _p29 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A5(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p31, issueState, model.now, model.lockedIssueNumber, highlightStory) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		var error = function () {
			...
			if (_p36.ctor === 'Just') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p36._0),
						_1: {ctor: '[]'}
					});
			} else {
		...
		if (_p37.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p40, model.location),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p38 = model.pickMilestoneForIssue;
									if (_p38.ctor === 'Just') {
										var _p39 = _p38._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p39.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p39.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p39, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p43.ctor) {
				...
				case 'LoadUser':
					...
					if (_p44.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p44._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p43._0)
							}),
						function () {
							var _p45 = model.accessToken;
							if (_p45.ctor === 'Just') {
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p45._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p47 = _p43._0;
					var _p46 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v37_2:
					do {
						if (_p46.ctor === 'Just') {
							switch (_p46._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p47.number, _p46._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p47.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p48 = _p43._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p48.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p48, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p49.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p50.ctor === 'Just') {
												var _p52 = _p50._0;
												var _p51 = _p58;
												if (_p51.ctor === 'IssueOpen') {
													var m = _p52.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p57)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p52,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p57),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p57)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p52,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p57),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p53 = updatedModel.milestones;
							if (_p53.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p53._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p54 = _p58;
									if (_p54.ctor === 'IssueClosed') {
										var _p55 = ms.closedIssues;
							...
							function () {
								...
								if (_p61.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p62, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p62, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p67),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p67),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p67),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p43._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p68 = model.accessToken;
							if (_p68.ctor === 'Just') {
								var _p69 = _p68._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p69, _moarwick$elm_webpack_starter$Models$IssueOpen, _p43._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p69, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p72 = _p43._1;
					var _p71 = _p43._0;
					var _p70 = model.accessToken;
					if (_p70.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p71.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p72.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p70._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p72)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p73.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p74, _moarwick$elm_webpack_starter$Models$IssueOpen, _p43._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p74, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p75.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$IssueClosed, _p43._0),
									_1: {
										ctor: '::',
				...
				default:
					...
					if (_p83.ctor === 'Just') {
						...
						switch (_p84) {
							case 'unplan':
								var _p85 = _p89.milestone;
								if (_p85.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p89.number}),
										{
											ctor: '::',
											_0: A4(
									...
									return A2(
											...
											{lockedIssueNumber: _p89.number}),
										{
											...
											_0: A5(
												...
												_p88,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p89.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p89.number}),
									{
										...
										_0: A5(
											...
											_p88,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p89.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								var _p87 = _p89.milestone;
								if (_p87.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											...
											{lockedIssueNumber: _p89.number}),
										{
											...
											_0: A5(
												...
												_p88,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p87._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p89)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var isStory = function () {
				var _p90 = page;
				if ((_p90.ctor === 'Just') && (_p90._0.ctor === 'Story')) {
					return true;
				} else {
					return false;
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p91 = persistentData.accessToken;
								if (_p91.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p91._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
