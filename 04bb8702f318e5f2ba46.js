		...
		function (user, model, route) {
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p27._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p28.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p29, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
								...
								function (s) {
									...
									if (_p30.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p30._0));
									} else {
										return 1 / 0;
									}
								},
								_elm_lang$core$Dict$values(_p25._0))));
				} else {
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p31.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p31._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p32.ctor === 'Just') {
						var _p36 = _p32._0;
						var mss = _elm_lang$core$Dict$values(_p36);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p33 = issueState;
									if (_p33.ctor === 'IssueClosed') {
										var _p34 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p36, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$andThen,
								function (htmlNode) {
									var _p37 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueOpen);
									if (_p37.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Maybe$andThen,
										function (htmlNode) {
											var _p38 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueClosed);
											if (_p38.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								showColumns: A2(
									_elm_lang$core$List$filter,
									function (a) {
										return !_elm_lang$core$Native_Utils.eq(a, _p48._0);
									},
									model.showColumns)
							}),
						{ctor: '[]'});
