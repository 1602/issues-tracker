...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.13.0") ] );
...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Services$fetchIssues = F2(
		function (model, column) {
			...
			var since = function () {
				var _p7 = column;
				if (_p7.ctor === 'Done') {
					var _p8 = model.settings.doneLimit;
					switch (_p8) {
						case 'a day':
			...
			var filterByUser = function () {
				...
				switch (_p12.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p12._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p12._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p12._0);
					default:
						return '';
				}
			}();
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F3(
		function (model, issueState, ms) {
			...
			var since = function () {
				var _p13 = issueState;
				if (_p13.ctor === 'ClosedIssue') {
					var _p14 = model.settings.doneLimit;
					switch (_p14) {
						case 'a day':
							return A2(pastMoment, -1, _justinmimbs$elm_date_extra$Date_Extra$Day);
						case 'a week':
			...
			var filterByUser = function () {
				...
				switch (_p16.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p16._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p16._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p16._0);
					default:
						return '';
				}
			}();
		...
		function (user, model, route) {
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									...
									if (_p35.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p35._0),
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p36._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p37.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p38, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								_elm_lang$core$List$sortBy,
								function (s) {
									var _p39 = s.milestone.dueOn;
									if (_p39.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p39._0));
									} else {
										return 1 / 0;
									}
								},
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p40.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p40._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p41.ctor === 'Just') {
						var _p45 = _p41._0;
						var mss = _elm_lang$core$Dict$values(_p45);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p42 = issueState;
									if (_p42.ctor === 'ClosedIssue') {
										var _p43 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p45, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$Maybe$andThen,
									function (htmlNode) {
										var _p46 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$OpenIssue);
										if (_p46.ctor === 'Just') {
											return _elm_lang$core$Maybe$Just(
												A2(
													_elm_lang$html$Html$div,
								...
								_1: {
									...
									_0: A2(
										...
										A2(
											_elm_lang$core$Maybe$andThen,
											function (htmlNode) {
												var _p47 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$ClosedIssue);
												if (_p47.ctor === 'Just') {
													return _elm_lang$core$Maybe$Just(
														A2(
															_elm_lang$html$Html$div,
		...
		var error = function () {
			...
			if (_p50.ctor === 'Just') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p50._0),
						_1: {ctor: '[]'}
					});
			} else {
				return _elm_lang$html$Html$text('');
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									...
									function (_p51) {
										return _elm_lang$core$Maybe$Just(
											pickMilestoneModal(_p51));
									},
									model.pickMilestoneForIssue)),
							_1: {
								ctor: '::',
								_0: function () {
									var _p52 = model.accessToken;
									if (_p52.ctor === 'Just') {
										return _elm_lang$html$Html$text('');
									} else {
										return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (_p53, location) {
			var _p54 = _p53;
			var _p59 = _p54._0;
			var recentRepos = _p59.recentRepos;
			...
			var settings = initSettings(_p59);
			...
			var showColumns = A2(
				...
				_p59.columns);
			var pinnedMilestones = _elm_lang$core$Dict$fromList(_p59.pinnedMilestones);
			var a = A2(_elm_lang$core$Debug$log, 'persistent data', _p59);
			var page = _moarwick$elm_webpack_starter$Route$parseHash(location);
			var highlightStory = function () {
				var _p56 = page;
				if ((_p56.ctor === 'Just') && (_p56._0.ctor === 'Story')) {
					return _p56._0._2;
				} else {
					return '';
				}
			}();
			var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_p54._1)(_elm_lang$core$Maybe$Nothing)('')(_p59.accessToken)(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p57 = _p59.accessToken;
								if (_p57.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p57._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
	...
	var _moarwick$elm_webpack_starter$Main$subscriptions = function (model) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, 10 * _elm_lang$core$Time$second, _moarwick$elm_webpack_starter$Messages$CurrentTime),
				_1: {
					ctor: '::',
				...
				switch (_p60.ctor) {
								...
								_0: _elm_lang$navigation$Navigation$modifyUrl(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_p60._0._0,
											A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p60._0._1)))),
								_1: {ctor: '[]'}
							});
					case 'SettingsMsgProxy':
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: A2(_moarwick$elm_webpack_starter$Main$updateSettings, _p60._0, model.settings)
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
					...
					case 'FetchComplete':
						...
						if (_p61.ctor === 'Ok') {
								...
								var _v50 = _p69(_p63),
									...
									model,
									{
										etags: A3(
											_elm_lang$core$Dict$insert,
											_p62._0,
											{ctor: '_Tuple2', _0: _p62._1, _1: _p63},
											model.etags)
									});
								msg = _v50;
								model = _v51;
							...
							var _p68 = _p61._0;
							var _p64 = _p68;
							if (_p64.ctor === 'BadStatus') {
								var _p67 = _p64._0;
								var _p65 = function () {
									var _p66 = A2(_elm_lang$core$Dict$get, _p67.url, model.etags);
									if (_p66.ctor === 'Just') {
										return {ctor: '_Tuple2', _0: _p66._0._0, _1: _p66._0._1};
									} else {
										return {ctor: '_Tuple2', _0: '', _1: ''};
									}
								}();
								var etag = _p65._0;
								var body = _p65._1;
								if (_elm_lang$core$Native_Utils.eq(_p67.status.code, 304) && (!_elm_lang$core$Native_Utils.eq(body, ''))) {
									var _v56 = _p69(body),
										_v57 = model;
									msg = _v56;
									model = _v57;
					...
					case 'PinMilestone':
						...
						var pinnedMilestone = A2(
							...
							'',
							A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
						var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p70) ? '' : _p70;
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
							...
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									filter: function () {
										...
										switch (_p73) {
											case 'assigned to me':
												return _moarwick$elm_webpack_starter$Models$AssignedTo(_p74.login);
											case 'created by me':
												return _moarwick$elm_webpack_starter$Models$CreatedBy(_p74.login);
											case 'mentioning me':
												return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p74.login);
											default:
					...
					case 'ShowIssueCreationForm':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{addIssueToColumn: _p60._0, addIssueToMilestone: _p60._1}),
							{
								ctor: '::',
									...
									_1: {
										...
										_0: {
											...
											_1: _elm_lang$core$Json_Encode$list(
												function () {
													...
													switch (_p75.ctor) {
														case 'Backlog':
															var _p76 = model.addIssueToMilestone;
															if (_p76 === '') {
																return {
																	ctor: '::',
										...
										_1: {
											...
											_0: {
												...
												_0: 'milestone',
												_1: function () {
													var _p77 = model.addIssueToMilestone;
													if (_p77 === '') {
											...
											_1: {
												...
												_0: {
													...
													_1: function () {
														var _p78 = _p80;
														if (_p78.ctor === 'Current') {
															var _p79 = model.user;
															if (_p79.ctor === 'Just') {
																return _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p79._0.login),
																		_1: {ctor: '[]'}
																	});
															} else {
																return _elm_lang$core$Json_Encode$list(
						...
						var cmd = (!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
							...
							_1: {
								...
								_0: A4(
									...
									model.accessToken,
									encodedIssue,
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p80, milestone)),
								_1: {ctor: '[]'}
							}
						} : {ctor: '[]'};
						return A2(
						...
						if (_p81.ctor === 'Err') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p81._0))
									}),
								{ctor: '[]'});
						} else {
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p82 = _p84;
										if (_p82.ctor === 'Backlog') {
											var _p83 = _p60._1;
											if (_p83.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p83._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p84);
										}
									}(),
									_1: {ctor: '[]'}
								});
					...
					case 'LoadUser':
						...
						if (_p85.ctor === 'Ok') {
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p85._0),
									error: _elm_lang$core$Maybe$Nothing
								});
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'CurrentTime':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									now: _elm_lang$core$Date$fromTime(_p60._0)
								}),
							_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
					case 'SelectStory':
						var _p89 = _p60._0;
						var _p88 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
						_v70_2:
						do {
							if (_p88.ctor === 'Just') {
								switch (_p88._0.ctor) {
									case 'Story':
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(_p89.number, _p88._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'#/',
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															model.repo,
															A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p89.number)))),
												_1: {ctor: '[]'}
											});
									case 'IssuesIndex':
										return A2(
					...
					case 'UrlChange':
						var _p90 = _p60._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p90.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p90, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var updateMilestoneIssues = F2(
							function (issues, s) {
								...
								if (_p91.ctor === 'Just') {
									var _p93 = _p91._0;
									var _p92 = _p98;
									if (_p92.ctor === 'OpenIssue') {
										var m = _p93.milestone;
						...
						var mss = function () {
							var _p94 = updatedModel.milestones;
							if (_p94.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p94._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p95 = _p98;
									if (_p95.ctor === 'ClosedIssue') {
										var _p96 = ms.closedIssues;
						...
						if (_p99.ctor === 'Err') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p99._0))
									}),
								{ctor: '[]'});
						} else {
					...
					case 'CopyText':
						return A2(
							...
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$clipboard(_p60._0),
								_1: {ctor: '[]'}
							});
					case 'UnsetMilestone':
						return A2(
							...
							{
								ctor: '::',
								_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p60._0),
								_1: {
									ctor: '::',
									_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
									_1: {ctor: '[]'}
					...
					case 'SetMilestone':
						...
						if (_p105.ctor === 'Just') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p106.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p107.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p105._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p107)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						return A2(
							...
							function () {
								...
								if (_p108.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p108._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p109.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p109._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p110.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p110._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
					...
					default:
						var _p117 = _p60._0;
						var _p111 = model.accessToken;
						if (_p111.ctor === 'Just') {
							var _p116 = _p111._0;
							var _p112 = _p60._1;
							switch (_p112) {
								case 'unplan':
									var _p113 = _p117.milestone;
									if (_p113.ctor === 'Just') {
										return A2(
											_elm_lang$core$Platform_Cmd_ops['!'],
											_elm_lang$core$Native_Utils.update(
												model,
												{lockedIssueNumber: _p117.number}),
											{
												ctor: '::',
												_0: A5(
													_moarwick$elm_webpack_starter$Services$updateIssueWith,
													...
													_p116,
													_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p113._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p117.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p114._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p116,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p117.milestone)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p117.number}),
										{
											...
											_0: A5(
												...
												_p116,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p117.milestone)),
											_1: {ctor: '[]'}
										});
								case 'restart':
									return A2(
											...
											{lockedIssueNumber: _p117.number}),
										{
											...
											_0: A5(
												...
												_p116,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p117.milestone)),
											_1: {ctor: '[]'}
										});
								case 'unstart':
									return A2(
								...
								case 'plan':
									return A2(
										...
										_elm_lang$core$Native_Utils.update(
											model,
											{
												pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p117)
											}),
										{ctor: '[]'});
								case 'ice':
									return A2(
