...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.11.0") ] );
...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Messages$CheckVersion = function (a) {
		return {ctor: 'CheckVersion', _0: a};
	};
	...
	var _moarwick$elm_webpack_starter$Services$checkVersion = function (etags) {
		return A3(_moarwick$elm_webpack_starter$Services$cachingFetch, 'https://raw.githubusercontent.com/1602/issues-tracker/master/package.json', etags, _moarwick$elm_webpack_starter$Messages$CheckVersion);
	};
		...
		function (msg, settings) {
			...
			switch (_p4.ctor) {
				...
				case 'UpdateDefaultRepository':
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepository: _p4._0});
				default:
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepositoryType: _p4._0});
			}
		});
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p5 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p5.ctor === 'Just') && (_p5._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p6 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p5._0._2)));
		} else {
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									function () {
										var _p18 = expandedMilestone.milestone.dueOn;
										if (_p18.ctor === 'Just') {
											var _p19 = _p18._0;
											return (_elm_lang$core$Native_Utils.cmp(
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(_p19)),
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(now))) < 0) ? ' overdue' : A2(
												_elm_lang$core$Basics_ops['++'],
												' due in ',
												A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p19));
										} else {
											return ' (no due date)';
										}
									}())),
					...
					function (head, issues) {
						...
						if (_p20.ctor === 'Just') {
							...
							if (_p21.ctor === 'OpenIssue') {
								...
								return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p22, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
							}
						} else {
							return A2(
								_elm_lang$html$Html$span,
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$andThen,
								function (htmlNode) {
									var _p40 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$OpenIssue);
									if (_p40.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Maybe$andThen,
										function (htmlNode) {
											var _p41 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$ClosedIssue);
											if (_p41.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (_p50, location) {
			var _p51 = _p50;
			var _p56 = _p51._0;
			var recentRepos = _p56.recentRepos;
			...
			var settings = initSettings(_p56);
			...
			var showColumns = A2(
				...
				_p56.columns);
			var pinnedMilestones = _elm_lang$core$Dict$fromList(_p56.pinnedMilestones);
			var page = _moarwick$elm_webpack_starter$Route$parseHash(location);
			var highlightStory = function () {
				var _p53 = page;
				if ((_p53.ctor === 'Just') && (_p53._0.ctor === 'Story')) {
					return _p53._0._2;
				} else {
					return '';
				}
			}();
			var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_p51._1)(_elm_lang$core$Maybe$Nothing)('')(_p56.accessToken)(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p54 = _p56.accessToken;
								if (_p54.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p54._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
				...
				switch (_p57.ctor) {
					...
					case 'SettingsMsgProxy':
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: A2(_moarwick$elm_webpack_starter$Main$updateSettings, _p57._0, model.settings)
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
					...
					case 'FetchComplete':
						...
						if (_p58.ctor === 'Ok') {
							...
							switch (_p59.ctor) {
								case 'CachedData':
									var _v49 = _p62(
										_elm_lang$core$Maybe$Just(_p59._2)),
										_v50 = _elm_lang$core$Native_Utils.update(
										model,
										{
											etags: A3(_elm_lang$core$Dict$insert, _p59._0, _p59._1, model.etags)
										});
									msg = _v49;
									model = _v50;
									continue update;
								case 'NotModified':
									var _v51 = _p62(_elm_lang$core$Maybe$Nothing),
										_v52 = model;
									msg = _v51;
									model = _v52;
									continue update;
							...
							var _p61 = _p58._0;
							var _p60 = _p61;
							if (_p60.ctor === 'BadStatus') {
								if (_elm_lang$core$Native_Utils.eq(_p60._0.status.code, 304)) {
									var _v56 = _p62(_elm_lang$core$Maybe$Nothing),
										_v57 = model;
									msg = _v56;
									model = _v57;
									continue update;
					...
					case 'PinMilestone':
						...
						var pinnedMilestone = A2(
							...
							'',
							A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
						var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p63) ? '' : _p63;
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
							...
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									filter: function () {
										...
										switch (_p66) {
											case 'assigned to me':
												return _moarwick$elm_webpack_starter$Models$AssignedTo(_p67.login);
											case 'created by me':
												return _moarwick$elm_webpack_starter$Models$CreatedBy(_p67.login);
											case 'mentioning me':
												return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p67.login);
											default:
					...
					case 'ShowIssueCreationForm':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{addIssueToColumn: _p57._0, addIssueToMilestone: _p57._1}),
							{
								ctor: '::',
										...
										_0: {
											...
											_1: _elm_lang$core$Json_Encode$list(
												function () {
													...
													switch (_p68.ctor) {
														case 'Backlog':
															var _p69 = model.addIssueToMilestone;
															if (_p69 === '') {
																return {
																	ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: {
													...
													_1: function () {
														var _p71 = _p73;
														if (_p71.ctor === 'Current') {
															var _p72 = model.user;
															if (_p72.ctor === 'Just') {
																return _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p72._0.login),
																		_1: {ctor: '[]'}
																	});
															} else {
																return _elm_lang$core$Json_Encode$list(
						...
						var cmd = (!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
							...
							_1: {
								...
								_0: A4(
									...
									model.accessToken,
									encodedIssue,
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p73, milestone)),
								_1: {ctor: '[]'}
							}
						} : {ctor: '[]'};
						return A2(
						...
						if (_p74.ctor === 'Err') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p75 = _p77;
										if (_p75.ctor === 'Backlog') {
											var _p76 = _p57._1;
											if (_p76.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p76._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p77);
										}
									}(),
									_1: {ctor: '[]'}
								});
					...
					case 'LoadUser':
						...
						if (_p78.ctor === 'Ok') {
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p78._0),
									error: _elm_lang$core$Maybe$Nothing
								});
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'CurrentTime':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									now: _elm_lang$core$Date$fromTime(_p57._0)
								}),
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Services$checkVersion(model.etags),
								_1: _moarwick$elm_webpack_starter$Main$loadAllIssues(model)
							});
					case 'CheckVersion':
						var a = A2(_elm_lang$core$Debug$log, 'package', _p57._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
					case 'SelectStory':
						var _p80 = _p57._0;
						var _p79 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
						_v69_2:
						do {
							if (_p79.ctor === 'Just') {
								switch (_p79._0.ctor) {
									case 'Story':
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(_p80.number, _p79._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'#/',
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															model.repo,
															A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p80.number)))),
												_1: {ctor: '[]'}
											});
									case 'IssuesIndex':
										return A2(
					...
					case 'UrlChange':
						var _p81 = _p57._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p81.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p81, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var updateMilestoneIssues = F2(
							function (issues, s) {
								...
								if (_p82.ctor === 'Just') {
									var _p84 = _p82._0;
									var _p83 = _p90;
									if (_p83.ctor === 'OpenIssue') {
										var m = _p84.milestone;
						...
						var mss = function () {
							var _p86 = updatedModel.milestones;
							if (_p86.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p86._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p87 = _p90;
									if (_p87.ctor === 'ClosedIssue') {
										var _p88 = ms.closedIssues;
					...
					case 'LoadMilestones':
						var result = A2(
							...
							A2(_elm_lang$core$Maybe$withDefault, '[]', _p57._0));
						var _p91 = result;
						if (_p91.ctor === 'Err') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p91._0))
									}),
								{ctor: '[]'});
						} else {
					...
					case 'CopyText':
						return A2(
							...
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$clipboard(_p57._0),
								_1: {ctor: '[]'}
							});
					case 'UnsetMilestone':
						return A2(
							...
							{
								ctor: '::',
								_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p57._0),
								_1: {
									ctor: '::',
									_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
									_1: {ctor: '[]'}
					...
					case 'SetMilestone':
						...
						if (_p98.ctor === 'Just') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p99.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p100.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p98._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p100)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						return A2(
							...
							function () {
								...
								if (_p101.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p101._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p102.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p102._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p103.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p103._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
