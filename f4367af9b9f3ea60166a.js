...
/***/ function(module, exports) {
							...
							A2(
								...
								A2(
									...
									function (_p4) {
										var _p5 = _p4;
										var _p6 = _p5._0;
										return (!_elm_lang$core$Native_Utils.eq(_p6, 'margin-top')) && (!_elm_lang$core$Native_Utils.eq(_p6, 'background'));
									},
									_moarwick$elm_webpack_starter$Main$buttonStyle))),
						_1: {
							ctor: '::',
		...
		function (msg, settings) {
			...
			switch (_p8.ctor) {
				...
				case 'UpdateDefaultRepository':
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepository: _p8._0});
				default:
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepositoryType: _p8._0});
			}
		});
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p9 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p9.ctor === 'Just') && (_p9._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p10 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p9._0._2)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p12 = model.currentIssues;
		if (_p12.ctor === 'Nothing') {
			var _p13 = model.user;
			if (_p13.ctor === 'Just') {
				var _p14 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p14.ctor === 'Just') {
					switch (_p14._0.ctor) {
						case 'Settings':
							return {ctor: '[]'};
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F7(
		function (_p16, allowAdd, issues, col, model, addto, milestoneNumber) {
			var _p17 = _p16;
			var milestone = function () {
				var _p18 = _elm_lang$core$List$head(issues);
				if (_p18.ctor === 'Just') {
					return _p18._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
		...
		function (milestones, issueState, now, model) {
			...
			var milestoneSortingRule = function (ems) {
				if (_elm_lang$core$Native_Utils.eq(ems.milestone.number, pinnedMilestoneNumber)) {
					...
					var _p21 = ems.milestone.dueOn;
					if (_p21.ctor === 'Nothing') {
						return 1 / 0;
					} else {
						return _elm_lang$core$Time$inSeconds(
							_elm_lang$core$Date$toTime(_p21._0));
					}
				}
			};
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									function () {
										var _p22 = expandedMilestone.milestone.dueOn;
										if (_p22.ctor === 'Just') {
											var _p23 = _p22._0;
											return (_elm_lang$core$Native_Utils.cmp(
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(_p23)),
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(now))) < 0) ? ' overdue' : A2(
												_elm_lang$core$Basics_ops['++'],
												' due in ',
												A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p23));
										} else {
											return ' (no due date)';
										}
									}())),
					...
					function (head, issues) {
						...
						if (_p24.ctor === 'Just') {
							...
							if (_p25.ctor === 'OpenIssue') {
								...
								return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p26, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
							}
						} else {
							return A2(
								_elm_lang$html$Html$span,
		...
		function (user, model, route) {
			var column = F2(
				function (col, content) {
					var _p29 = _moarwick$elm_webpack_starter$Main$columnTitle(col);
					var icon = _p29._0;
					var title = _p29._1;
					var comment = _p29._2;
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_0: 'width',
										_1: function () {
											var _p30 = _elm_lang$core$List$length(model.showColumns);
											switch (_p30) {
												case 3:
													return '33.33%';
												case 2:
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									var _p32 = s.milestone.dueOn;
									if (_p32.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p32._0),
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p33._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p34.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p35, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p37.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p37._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p38.ctor === 'Just') {
						var _p42 = _p38._0;
						var mss = _elm_lang$core$Dict$values(_p42);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p39 = issueState;
									if (_p39.ctor === 'ClosedIssue') {
										var _p40 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p42, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$andThen,
								function (htmlNode) {
									var _p43 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$OpenIssue);
									if (_p43.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Maybe$andThen,
										function (htmlNode) {
											var _p44 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$ClosedIssue);
											if (_p44.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p48.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p50, model),
					_1: {
						ctor: '::',
						_0: A3(
						...
						if (_p61.ctor === 'Ok') {
							...
							switch (_p62.ctor) {
								case 'CachedData':
									...
									continue update;
								case 'NotModified':
									var _v51 = _p65(_elm_lang$core$Maybe$Nothing),
										_v52 = model;
									msg = _v51;
									model = _v52;
									continue update;
							...
							if (_p63.ctor === 'BadStatus') {
								if (_elm_lang$core$Native_Utils.eq(_p63._0.status.code, 304)) {
									var _v56 = _p65(_elm_lang$core$Maybe$Nothing),
										_v57 = model;
									msg = _v56;
									model = _v57;
									continue update;
