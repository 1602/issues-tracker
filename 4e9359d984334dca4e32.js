...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Models$PersistedData = F2(
		function (a, b) {
			return {accessToken: a, pinnedMilestones: b};
		});
	...
	var _moarwick$elm_webpack_starter$Main$loadAllIssues = function (model) {
		...
		if (_p5.ctor === 'Just') {
			...
			return {
				ctor: '::',
				_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p6, _moarwick$elm_webpack_starter$Models$Current),
				_1: {
					ctor: '::',
					_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p6, _moarwick$elm_webpack_starter$Models$Icebox),
					_1: {
						ctor: '::',
						_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p6, _moarwick$elm_webpack_starter$Models$Done),
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Services$fetchMilestones, model.repo, _p6),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p7 = model.currentIssues;
		if (_p7.ctor === 'Nothing') {
			var _p8 = model.user;
			if (_p8.ctor === 'Just') {
				var _p9 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p9.ctor === 'Just') {
					switch (_p9._0.ctor) {
						case 'Story':
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F7(
		function (_p11, allowAdd, issues, col, model, addto, milestoneNumber) {
			var _p12 = _p11;
			var milestone = function () {
				var _p13 = _elm_lang$core$List$head(issues);
				if (_p13.ctor === 'Just') {
					return _p13._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
											...
											_0: A2(
												...
												},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															A2(_elm_lang$core$Maybe$withDefault, '', _p12._0),
															' ')),
													_1: {
														ctor: '::',
														_0: _p12._1,
										...
										_elm_lang$html$Html$form,
										{
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onSubmit(
													_moarwick$elm_webpack_starter$Messages$CreateStory(col)),
												_1: {ctor: '[]'}
											}
										},
										{
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											function () {
												var _p16 = expandedMilestone.milestone.dueOn;
												if (_p16.ctor === 'Just') {
													var _p17 = _p16._0;
													return (_elm_lang$core$Native_Utils.cmp(
														...
														_elm_lang$core$Basics_ops['++'],
														' due in ',
														A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p17));
												} else {
													return ' (no due date)';
												}
											}())),
							...
							function (head, issues) {
								...
								if (_p18.ctor === 'Just') {
									...
									if (_p19.ctor === 'IssueOpen') {
										...
										return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p20, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
		...
		function (user, model, route) {
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_0: 'width',
										_1: function () {
											var _p26 = _elm_lang$core$List$length(model.showColumns);
											switch (_p26) {
												case 3:
													return '33.33%';
												case 2:
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									var _p28 = s.milestone.dueOn;
									if (_p28.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p28._0),
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p29._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p30.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p31, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p33.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p33._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p34.ctor === 'Just') {
						var _p38 = _p34._0;
						var mss = _elm_lang$core$Dict$values(_p38);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p35 = issueState;
									if (_p35.ctor === 'IssueClosed') {
										var _p36 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p38, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'height', _1: 'calc(100vh - 34px)'},
									_1: {ctor: '[]'}
								}
							}
						}),
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$andThen,
								function (htmlNode) {
									var _p39 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueOpen);
									if (_p39.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Maybe$andThen,
										function (htmlNode) {
											var _p40 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueClosed);
											if (_p40.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p44.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A3(_moarwick$elm_webpack_starter$Main$viewTopbar, _p47, model.location, model),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p45 = model.pickMilestoneForIssue;
									if (_p45.ctor === 'Just') {
										var _p46 = _p45._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p46.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p46.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p46, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
			...
			switch (_p50.ctor) {
				...
				case 'PinMilestone':
					...
					var pinnedMilestone = A2(
						...
						'',
						A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
					var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p51) ? '' : _p51;
					var pinnedMilestones = A3(_elm_lang$core$Dict$insert, model.repo, n, model.pinnedMilestones);
					var save = _moarwick$elm_webpack_starter$Main$saveData(
						A2(
							_moarwick$elm_webpack_starter$Models$PersistedData,
							model.accessToken,
							_elm_lang$core$Dict$toList(pinnedMilestones)));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								showColumns: A2(
									_elm_lang$core$List$filter,
									function (a) {
										return !_elm_lang$core$Native_Utils.eq(a, _p50._0);
									},
									model.showColumns)
							}),
						{ctor: '[]'});
							...
							model,
							{
								showColumns: A2(
									...
									A2(
										_elm_lang$core$List$filter,
										function (a) {
											return !_elm_lang$core$Native_Utils.eq(a, _p52);
										},
										model.showColumns))
							}),
						{ctor: '[]'});
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p54) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p55.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p55.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p55.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p50._0, addIssueToMilestone: _p50._1}),
						{ctor: '[]'});
				case 'EditNewStoryTitle':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{newIssueTitle: _p50._0}),
						{ctor: '[]'});
				case 'CreateStory':
					var _p62 = _p50._0;
					var _p56 = model.accessToken;
					if (_p56.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
												...
												_1: {
													...
													_0: {
														...
														_1: _elm_lang$core$Json_Encode$list(
															function () {
																...
																switch (_p57.ctor) {
																	case 'Icebox':
																		var _p58 = model.addIssueToMilestone;
																		if (_p58 === '') {
																			return {
																				ctor: '::',
													...
													_1: {
														...
														_0: {
															...
															_0: 'milestone',
															_1: function () {
																var _p59 = model.addIssueToMilestone;
																if (_p59 === '') {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p60 = _p62;
																	if (_p60.ctor === 'Current') {
																		var _p61 = model.user;
																		if (_p61.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p61._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
						...
						if (_p64.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p65 = _p68;
										if (_p65.ctor === 'Backlog') {
											var _p66 = _p50._1;
											if (_p66.ctor === 'Just') {
												return A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p67, _moarwick$elm_webpack_starter$Models$IssueOpen, _p66._0);
											} else {
												return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p67, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p67, _p68);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p69.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p69._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p50._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p71 = _p50._0;
					var _p70 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v55_2:
					do {
						if (_p70.ctor === 'Just') {
							switch (_p70._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p71.number, _p70._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p71.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p72 = _p50._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p72.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p72, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p73.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p74.ctor === 'Just') {
												var _p76 = _p74._0;
												var _p75 = _p82;
												if (_p75.ctor === 'IssueOpen') {
													var m = _p76.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p81)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p76,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p81),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p81)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p76,
						...
						var mss = function () {
							var _p77 = updatedModel.milestones;
							if (_p77.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p77._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p78 = _p82;
									if (_p78.ctor === 'IssueClosed') {
										var _p79 = ms.closedIssues;
					...
					if (_p83.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p83._0))
								}),
							{ctor: '[]'});
					} else {
						var _p87 = _p83._0;
							...
							function () {
								...
								if (_p85.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p86, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p86, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p91),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p91),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p91),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p50._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p92.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p93, _moarwick$elm_webpack_starter$Models$IssueOpen, _p50._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p93, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p96 = _p50._1;
					var _p95 = _p50._0;
					var _p94 = model.accessToken;
					if (_p94.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p95.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p96.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p94._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p96)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'MilestoneSet':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p97 = model.accessToken;
							if (_p97.ctor === 'Just') {
								var _p98 = _p97._0;
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$IssueOpen, _p50._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p99.ctor === 'Just') {
								...
								if (_p100.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$IssueClosed, _p100._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p102.ctor === 'Just') {
								...
								if (_p103.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p104, _moarwick$elm_webpack_starter$Models$IssueOpen, _p103._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p104, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p104, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p105.ctor === 'Just') {
								...
								if (_p106.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p107, _moarwick$elm_webpack_starter$Models$IssueClosed, _p106._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p107, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p107, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
									...
									return A2(
											...
											{lockedIssueNumber: _p113.number}),
										{
											...
											_0: A4(
												...
												_p113,
												_p112,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p110._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p111._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
																		...
																		return function (r) {
																			return function (s) {
																				return function (t) {
																					return function (u) {
																						return function (v) {
																							return {user: a, token: b, accessToken: c, repo: d, location: e, now: f, error: g, currentIssues: h, iceboxIssues: i, closedIssues: j, milestones: k, pickMilestoneForIssue: l, lockedIssueNumber: m, highlightStory: n, newMilestoneTitle: o, newIssueTitle: p, needFocus: q, addIssueToColumn: r, addIssueToMilestone: s, filter: t, showColumns: u, pinnedMilestones: v};
																						};
																					};
																				};
																			};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p114 = page;
				if ((_p114.ctor === 'Just') && (_p114._0.ctor === 'Story')) {
					return _p114._0._2;
				} else {
					return '';
				}
			...
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				{
					ctor: '::',
					_0: _moarwick$elm_webpack_starter$Models$Icebox,
					_1: {
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Models$Backlog,
						_1: {
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Models$Current,
							_1: {
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Models$Done,
								_1: {ctor: '[]'}
							}
						}
					}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p115 = persistentData.accessToken;
								if (_p115.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p115._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
			...
			function (accessToken) {
				return A2(
					...
					function (pinnedMilestones) {
						return _elm_lang$core$Json_Decode$succeed(
							{accessToken: accessToken, pinnedMilestones: pinnedMilestones});
					},
					A2(
