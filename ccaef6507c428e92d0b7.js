	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p49.ctor) {
							...
							model,
							{
								showColumns: A2(
									...
									A2(
										_elm_lang$core$List$filter,
										function (a) {
											return !_elm_lang$core$Native_Utils.eq(a, _p50);
										},
										model.showColumns))
							}),
						{ctor: '[]'});
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p52) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p53.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p53.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p53.login);
										default:
						...
						return A2(
							...
							(!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
								...
								_0: A4(
													...
													_1: {
																...
																if (_p56.ctor === 'Just') {
																	return _elm_lang$core$Json_Encode$int(
																		A2(
																			_elm_lang$core$Result$withDefault,
																			0,
																			_elm_lang$core$String$toInt(_p56._0.number)));
																} else {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p57 = _p59;
																	if (_p57.ctor === 'Current') {
																		var _p58 = model.user;
																		if (_p58.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p58._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
									...
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p59, _p60)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'});
					} else {
						return A2(
						...
						if (_p62.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p63 = _p66;
										if (_p63.ctor === 'Backlog') {
											var _p64 = _p49._1;
											if (_p64.ctor === 'Just') {
												return A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p65, _moarwick$elm_webpack_starter$Models$IssueOpen, _p64._0);
											} else {
												return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p65, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p65, _p66);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p67.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p67._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p67._0)),
				...
				case 'SelectStory':
					var _p69 = _p49._0;
					var _p68 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v53_2:
					do {
						if (_p68.ctor === 'Just') {
							switch (_p68._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p69.number, _p68._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p69.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p70 = _p49._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p70.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p70, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p71.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p72.ctor === 'Just') {
												var _p74 = _p72._0;
												var _p73 = _p80;
												if (_p73.ctor === 'IssueOpen') {
													var m = _p74.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p79)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p74,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p79),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p79)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p74,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p79),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p75 = updatedModel.milestones;
							if (_p75.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p75._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p76 = _p80;
									if (_p76.ctor === 'IssueClosed') {
										var _p77 = ms.closedIssues;
							...
							function () {
								...
								if (_p83.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p84, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p84, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
					...
					if (_p87.ctor === 'Ok') {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p89),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p89),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p89),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p87._0))
								}),
							{ctor: '[]'});
					}
				case 'CopyText':
					...
					return A2(
						...
						function () {
							...
							if (_p90.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p91, _moarwick$elm_webpack_starter$Models$IssueOpen, _p49._0),
									_1: {
										ctor: '::',
				...
				case 'SetMilestone':
					...
					if (_p92.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p93.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p94.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p92._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p94)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p95.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p96, _moarwick$elm_webpack_starter$Models$IssueOpen, _p49._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p96, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p97.ctor === 'Just') {
								...
								if (_p98.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p99, _moarwick$elm_webpack_starter$Models$IssueClosed, _p98._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p99, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p99, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p99, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p100.ctor === 'Just') {
								...
								if (_p101.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p102, _moarwick$elm_webpack_starter$Models$IssueOpen, _p101._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p102, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p102, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p103.ctor === 'Just') {
								...
								if (_p104.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p105, _moarwick$elm_webpack_starter$Models$IssueClosed, _p104._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p105, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p105, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p106.ctor === 'Just') {
						...
						switch (_p107) {
							case 'unplan':
								var _p108 = _p111.milestone;
								if (_p108.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p111.number}),
										{
											ctor: '::',
											_0: A4(
									...
									return A2(
											...
											{lockedIssueNumber: _p111.number}),
										{
											...
											_0: A5(
												...
												_p110,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p111.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p111.number}),
									{
										...
										_0: A5(
											...
											_p110,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p111.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p111.number}),
									{
										...
										_0: A5(
											...
											_p110,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p111.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p111)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p112 = page;
				if ((_p112.ctor === 'Just') && (_p112._0.ctor === 'Story')) {
					return _p112._0._2;
				} else {
					return '';
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p113 = persistentData.accessToken;
								if (_p113.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p113._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
