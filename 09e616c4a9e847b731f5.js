...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Main$aboutToLoadResource = F2(
		function (loc, model) {
			...
			var _p8 = page;
			if ((_p8.ctor === 'Just') && (_p8._0.ctor === 'IssuesIndex')) {
				return model;
			} else {
				return model;
			}
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F5(
		function (head, issues, col, lockedIssueNumber, highlightStory) {
			...
			return A2(
				...
				A2(
					...
					function (expandedMilestone) {
						var heading = A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p11 = expandedMilestone.milestone.dueOn;
										if (_p11.ctor === 'Just') {
											var _p12 = _p11._0;
											return (_elm_lang$core$Native_Utils.cmp(
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(_p12)),
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(now))) < 0) ? _elm_lang$html$Html$text(' overdue') : _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													' due in ',
													A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p12)));
										} else {
							...
							function (head, issues) {
								...
								if (_p13.ctor === 'Just') {
									...
									if (_p14.ctor === 'IssueOpen') {
										...
										return A5(_moarwick$elm_webpack_starter$Main$listIssues, head, _p15, _moarwick$elm_webpack_starter$Models$Done, lockedIssueNumber, highlightStory);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
						...
						return hasIssues ? issues(heading) : _elm_lang$html$Html$text('');
					},
					A2(
						_elm_lang$core$List$sortBy,
						function (ems) {
							var _p18 = ems.milestone.dueOn;
		...
		function (user, model, route) {
					...
					return A2(
						...
						A2(
														...
														_1: {
															...
															_1: {
																...
																_0: {
																	...
																	_0: 'border-left',
																	_1: function () {
																		var _p21 = s.milestone.dueOn;
																		if (_p21.ctor === 'Just') {
																			return A2(
																				_elm_lang$core$Basics_ops['++'],
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p21._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p22.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p23, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								...
								_elm_lang$core$Dict$values(_p19._0))));
				} else {
					return _elm_lang$html$Html$text('Loading...');
				}
			}();
			var displayIssues = F5(
				function (head, filter, issues, col, highlightStory) {
					var _p25 = issues;
					if (_p25.ctor === 'Just') {
						return A5(
							_moarwick$elm_webpack_starter$Main$listIssues,
							head,
							A2(_elm_lang$core$List$filter, filter, _p25._0),
							col,
			...
			var displayIssuesWithinMilestones = F3(
				function (milestones, issueState, highlightStory) {
					...
					if (_p26.ctor === 'Just') {
						var _p30 = _p26._0;
						var mss = _elm_lang$core$Dict$values(_p30);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p27 = issueState;
									if (_p27.ctor === 'IssueClosed') {
										var _p28 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A5(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p30, issueState, model.now, model.lockedIssueNumber, highlightStory) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		var error = function () {
			...
			if (_p35.ctor === 'Just') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p35._0),
						_1: {ctor: '[]'}
					});
			} else {
		...
		if (_p36.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p39, model.location),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p37 = model.pickMilestoneForIssue;
									if (_p37.ctor === 'Just') {
										var _p38 = _p37._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p38.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p38.title)),
														_1: {
															ctor: '::',
															_0: A2(
																				...
																				_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('New milestone'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {
																							ctor: '::',
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p38, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p42.ctor) {
				...
				case 'LoadUser':
					...
					if (_p43.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p43._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p42._0)
							}),
						function () {
							var _p44 = model.accessToken;
							if (_p44.ctor === 'Just') {
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p44._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p46 = _p42._0;
					var _p45 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v36_2:
					do {
						if (_p45.ctor === 'Just') {
							switch (_p45._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p46.number, _p45._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p46.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p47 = _p42._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p47.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p47, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p48.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p49.ctor === 'Just') {
												var _p51 = _p49._0;
												var _p50 = _p57;
												if (_p50.ctor === 'IssueOpen') {
													var m = _p51.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p56)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p51,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p56),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p56)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p51,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p56),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p52 = updatedModel.milestones;
							if (_p52.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p52._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p53 = _p57;
									if (_p53.ctor === 'IssueClosed') {
										var _p54 = ms.closedIssues;
							...
							function () {
								...
								if (_p60.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p61, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p61, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p66),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p66),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p66),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p42._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p67 = model.accessToken;
							if (_p67.ctor === 'Just') {
								var _p68 = _p67._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p68, _moarwick$elm_webpack_starter$Models$IssueOpen, _p42._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p68, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p71 = _p42._1;
					var _p70 = _p42._0;
					var _p69 = model.accessToken;
					if (_p69.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p70.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p71.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p69._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p71)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'MilestoneSet':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p72 = model.accessToken;
							if (_p72.ctor === 'Just') {
								var _p73 = _p72._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p73, _moarwick$elm_webpack_starter$Models$IssueOpen, _p42._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p73, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p74.ctor === 'Just') {
								...
								if (_p75.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$IssueClosed, _p75._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p77.ctor === 'Just') {
								...
								if (_p78.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p79, _moarwick$elm_webpack_starter$Models$IssueOpen, _p78._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p79, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p79, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p80.ctor === 'Just') {
								...
								if (_p81.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p82, _moarwick$elm_webpack_starter$Models$IssueClosed, _p81._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p82, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										...
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p82, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p83.ctor === 'Just') {
						...
						switch (_p84) {
							case 'unplan':
								var _p85 = _p88.milestone;
								if (_p85.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p88.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p88,
												_p87,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p85._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p86._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p87,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p88.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p88.number}),
									{
										...
										_0: A5(
											...
											_p87,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p88.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p88.number}),
									{
										...
										_0: A5(
											...
											_p87,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p88.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p88)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
											...
											return function (k) {
												return function (l) {
													return function (m) {
														return function (n) {
															return function (o) {
																return {user: a, token: b, accessToken: c, repo: d, location: e, now: f, error: g, currentIssues: h, iceboxIssues: i, closedIssues: j, milestones: k, pickMilestoneForIssue: l, lockedIssueNumber: m, newMilestoneTitle: n, needFocus: o};
															};
														};
													};
												};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var isStory = function () {
				var _p89 = page;
				if ((_p89.ctor === 'Just') && (_p89._0.ctor === 'Story')) {
					return true;
				} else {
					return false;
				}
			...
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				_elm_lang$core$Date$fromTime(
					_elm_lang$core$Time$millisecond * _elm_lang$core$Basics$toFloat(0)))(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)('')('')(isStory);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p90 = persistentData.accessToken;
								if (_p90.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p90._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
