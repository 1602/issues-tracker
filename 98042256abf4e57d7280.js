...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.15.0") ] );
...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Models$PersistedData = F8(
		function (a, b, c, d, e, f, g, h) {
			return {accessToken: a, pinnedMilestones: b, columns: c, defaultRepositoryType: d, defaultRepository: e, recentRepos: f, doneLimit: g, powerOfNow: h};
		});
									...
									}),
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'filter', _1: 'grayscale(0.9) '},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'height', _1: '30px'},
													_1: {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p15 = model.currentIssues;
		if (_p15.ctor === 'Nothing') {
			var _p16 = model.user;
			if (_p16.ctor === 'Just') {
				var _p17 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p17.ctor === 'Just') {
					switch (_p17._0.ctor) {
						case 'Settings':
							return {ctor: '[]'};
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F7(
		function (_p19, allowAdd, issues, col, model, addto, milestoneNumber) {
			var _p20 = _p19;
			var milestone = function () {
				var _p21 = _elm_lang$core$List$head(issues);
				if (_p21.ctor === 'Just') {
					return _p21._0.milestone;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			}();
											...
											_0: A2(
												...
												},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															A2(_elm_lang$core$Maybe$withDefault, '', _p20._0),
															' ')),
													_1: {
														ctor: '::',
														_0: _p20._1,
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									function () {
										var _p25 = expandedMilestone.milestone.dueOn;
										if (_p25.ctor === 'Just') {
											var _p26 = _p25._0;
											return (_elm_lang$core$Native_Utils.cmp(
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(_p26)),
												_elm_lang$core$Time$inSeconds(
													_elm_lang$core$Date$toTime(now))) < 0) ? ' overdue' : A2(
												_elm_lang$core$Basics_ops['++'],
												' due in ',
												A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p26));
										} else {
											return ' (no due date)';
										}
									}())),
					...
					function (head, issues) {
						...
						if (_p27.ctor === 'Just') {
							...
							if (_p28.ctor === 'OpenIssue') {
								...
								return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p29, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
							}
						} else {
							return A2(
								_elm_lang$html$Html$span,
		...
		function (user, model, route) {
			var column = F3(
				function (col, colHtml, content) {
					var _p32 = _moarwick$elm_webpack_starter$Main$columnTitle(col);
					var icon = _p32._0;
					var title = _p32._1;
					var comment = _p32._2;
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_0: 'width',
										_1: function () {
											var _p33 = _elm_lang$core$List$length(model.showColumns);
											switch (_p33) {
												case 3:
			...
			var milestonesIndex = function () {
				var _p35 = A2(_elm_lang$core$Dict$get, model.repo, model.milestones);
				if (_p35.ctor === 'Just') {
					return A2(
						_elm_lang$html$Html$ul,
						{
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									...
									if (_p36.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p36._0),
														...
														_1: {
															...
															_1: {
																...
																_0: {
																	...
																	_0: 'border-left',
																	_1: function () {
																		var _p37 = s.milestone.dueOn;
																		if (_p37.ctor === 'Just') {
																			return A2(
																				_elm_lang$core$Basics_ops['++'],
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p37._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p38.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p39, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								_elm_lang$core$List$sortBy,
								function (s) {
									var _p40 = s.milestone.dueOn;
									if (_p40.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p40._0));
									} else {
										return 1 / 0;
									}
								},
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p41.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p41._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p42.ctor === 'Just') {
						var _p46 = _p42._0;
						var mss = _elm_lang$core$Dict$values(_p46);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p43 = issueState;
									if (_p43.ctor === 'ClosedIssue') {
										var _p44 = ms.closedIssues;
										if (_p44.ctor === 'Nothing') {
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p46, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
											...
											_0: _elm_lang$html$Html_Attributes$style(
												{
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'border-color', _1: 'cornflowerblue'},
														_1: {
															ctor: '::',
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'min-width', _1: '40px'},
																	_1: {ctor: '[]'}
																}
															}
														}
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (_p55, location) {
			...
			var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_p56._1)(_elm_lang$core$Maybe$Nothing)('')(_p61.accessToken)(
				...
				_elm_lang$core$Date$fromTime(
					_elm_lang$core$Time$millisecond * _elm_lang$core$Basics$toFloat(0)))(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Dict$empty)(_elm_lang$core$Maybe$Nothing)('')(highlightStory)('')('')(
				!_elm_lang$core$Native_Utils.eq(highlightStory, ''))(_moarwick$elm_webpack_starter$Models$Done)('')(_moarwick$elm_webpack_starter$Models$All)(showColumns)(pinnedMilestones)('')(recentRepos)(_elm_lang$core$Dict$empty)('')(_moarwick$elm_webpack_starter$Models$NotRequested);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
		...
		function (msg, model) {
			...
			while (true) {
				...
				switch (_p62.ctor) {
					...
					case 'UrlChange':
						var _p93 = _p62._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p93.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p93, repo: repo, currentIssues: issues, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var updateMilestoneIssues = F2(
							function (issues, s) {
								...
								if (_p94.ctor === 'Just') {
									var _p96 = _p94._0;
									var _p95 = _p101;
									if (_p95.ctor === 'OpenIssue') {
										var m = _p96.milestone;
						...
						var mss = function () {
							var _p97 = A2(_elm_lang$core$Dict$get, model.repo, updatedModel.milestones);
							if (_p97.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p97._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p98 = _p101;
									if (_p98.ctor === 'ClosedIssue') {
										var _p99 = ms.closedIssues;
						...
						if (_p105.ctor === 'Ok') {
							...
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p105._0))
									}),
								{ctor: '[]'});
						}
					case 'IssuesLoaded':
					...
					case 'SetMilestone':
						var _p110 = _p62._1;
						var _p109 = _p62._0;
						var _p108 = model.accessToken;
						if (_p108.ctor === 'Just') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p109.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p110.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p108._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p110)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						return A2(
							...
							function () {
								...
								if (_p111.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p111._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p112.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p112._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p113.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p113._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
					...
					default:
						var _p120 = _p62._0;
						var _p114 = model.accessToken;
						if (_p114.ctor === 'Just') {
							var _p119 = _p114._0;
							var _p115 = _p62._1;
							switch (_p115) {
								case 'unplan':
									var _p116 = _p120.milestone;
									if (_p116.ctor === 'Just') {
										return A2(
											_elm_lang$core$Platform_Cmd_ops['!'],
											_elm_lang$core$Native_Utils.update(
												model,
												{lockedIssueNumber: _p120.number}),
											{
												ctor: '::',
												_0: A5(
													_moarwick$elm_webpack_starter$Services$updateIssueWith,
													...
													_p119,
													_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p116._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p120.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p117._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p119,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p120.milestone)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p120.number}),
										{
											...
											_0: A5(
												...
												_p119,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p120.milestone)),
											_1: {ctor: '[]'}
										});
								case 'restart':
									return A2(
											...
											{lockedIssueNumber: _p120.number}),
										{
											...
											_0: A5(
												...
												_p119,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p120.milestone)),
											_1: {ctor: '[]'}
										});
								case 'unstart':
									return A2(
								...
								case 'plan':
									return A2(
										...
										_elm_lang$core$Native_Utils.update(
											model,
											{
												pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p120)
											}),
										{ctor: '[]'});
								case 'ice':
									return A2(
																	...
																	function (powerOfNow) {
																		return A2(
																			...
																			function (recentRepos) {
																				return _elm_lang$core$Json_Decode$succeed(
																					{accessToken: accessToken, columns: columns, defaultRepository: defaultRepository, defaultRepositoryType: defaultRepositoryType, doneLimit: doneLimit, pinnedMilestones: pinnedMilestones, powerOfNow: powerOfNow, recentRepos: recentRepos});
																			},
																			A2(
