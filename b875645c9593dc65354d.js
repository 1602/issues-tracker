					...
					return A2(
						...
						function () {
							...
							if (_p74.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p75, _moarwick$elm_webpack_starter$Models$IssueClosed, _p42._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p75, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p76.ctor === 'Just') {
								...
								if (_p77.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p78, _moarwick$elm_webpack_starter$Models$IssueOpen, _p77._0),
										_1: {
											ctor: '::',
									...
									return {
										...
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p78, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p79.ctor === 'Just') {
								...
								if (_p80.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p81, _moarwick$elm_webpack_starter$Models$IssueClosed, _p80._0),
										_1: {
											ctor: '::',
											_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p81, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A4(
												...
												_p88,
												_p87,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p84._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A5(
												...
												_p87,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p86._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
