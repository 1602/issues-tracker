			...
			return {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Services$fetchMilestones, model.repo, _p7._0),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			switch (_p54.ctor) {
				...
				case 'PinMilestone':
					...
					var pinnedMilestone = A2(
						...
						'',
						A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
					var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p55) ? '' : _p55;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p58) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p59.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p59.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p59.login);
										default:
													...
													_1: {
														...
														_1: {
															...
															_0: {
																...
																_0: 'milestone',
																_1: function () {
																	var _p63 = model.addIssueToMilestone;
																	if (_p63 === '') {
															...
															_1: {
																...
																_0: {
																	...
																	_1: function () {
																		var _p64 = _p66;
																		if (_p64.ctor === 'Current') {
																			var _p65 = model.user;
																			if (_p65.ctor === 'Just') {
																				return _elm_lang$core$Json_Encode$list(
																					{
																						ctor: '::',
																						_0: _elm_lang$core$Json_Encode$string(_p65._0.login),
																						_1: {ctor: '[]'}
																					});
																			} else {
																				return _elm_lang$core$Json_Encode$list(
						...
						if (_p68.ctor === 'Just') {
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p69 = _p71;
										if (_p69.ctor === 'Backlog') {
											var _p70 = _p54._1;
											if (_p70.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p70._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p71);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p72.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p72._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'SelectStory':
					var _p74 = _p54._0;
					var _p73 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v59_2:
					do {
						if (_p73.ctor === 'Just') {
							switch (_p73._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p74.number, _p73._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p74.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p75 = _p54._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p75.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p75, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p76.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p77.ctor === 'Just') {
												var _p79 = _p77._0;
												var _p78 = _p85;
												if (_p78.ctor === 'IssueOpen') {
													var m = _p79.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p84)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p79,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p84),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p84)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p79,
						...
						var mss = function () {
							var _p80 = updatedModel.milestones;
							if (_p80.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p80._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p81 = _p85;
									if (_p81.ctor === 'IssueClosed') {
										var _p82 = ms.closedIssues;
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p93),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p93),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p93),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'SetMilestone':
					...
					if (_p95.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p96.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p97.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p95._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p97)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
						...
						function () {
							...
							if (_p99.ctor === 'Just') {
								...
								if (_p100.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p100._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p101.ctor === 'Just') {
								...
								if (_p102.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p102._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
