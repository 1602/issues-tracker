...
/***/ function(module, exports) {
							...
							var hasRepoOauthScope = A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Maybe$withDefault,
										'',
										A2(_elm_lang$core$Dict$get, 'X-OAuth-Scopes', res.headers))));
	...
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p32 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p32.ctor === 'Just') && (_p32._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					return A2(
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p32._0._0)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p33 = model.currentIssues;
		if (_p33.ctor === 'Nothing') {
			var _p34 = model.user;
			if (_p34.ctor === 'Just') {
				var _p35 = model.accessToken;
				if (_p35.ctor === 'Just') {
					var _p37 = _p35._0;
					var _p36 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					if (_p36.ctor === 'Just') {
						switch (_p36._0.ctor) {
							case 'Story':
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p37);
							case 'IssuesIndex':
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p37);
							default:
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p37);
	...
	var _moarwick$elm_webpack_starter$Main$aboutToLoadResource = F2(
		function (loc, model) {
			...
			var _p38 = page;
			if ((_p38.ctor === 'Just') && (_p38._0.ctor === 'IssuesIndex')) {
				return model;
			} else {
				return model;
			}
	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p39.ctor) {
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p39._0)
							}),
						function () {
							var _p41 = model.accessToken;
							if (_p41.ctor === 'Just') {
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p41._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p43 = _p39._0;
					var _p42 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v36_2:
					do {
						if (_p42.ctor === 'Just') {
							switch (_p42._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p43.number, _p42._0._0) ? _elm_lang$navigation$Navigation$modifyUrl('#/stories') : _elm_lang$navigation$Navigation$modifyUrl(
												A2(_elm_lang$core$Basics_ops['++'], '#/stories/', _p43.number)),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
										...
										A3(
											...
											function (s) {
												...
												if (_p46.ctor === 'Just') {
													var _p48 = _p46._0;
													var _p47 = _p39._1;
													if (_p47.ctor === 'IssueOpen') {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p48,
																{
																	openIssues: _elm_lang$core$Maybe$Just(_p49)
																}));
													} else {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p48,
																{
																	closedIssues: _elm_lang$core$Maybe$Just(_p49)
																}));
													}
												} else {
													return _elm_lang$core$Maybe$Nothing;
							...
							function () {
								...
								if (_p52.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p53, _moarwick$elm_webpack_starter$Models$IssueOpen),
											_p54),
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p53, _moarwick$elm_webpack_starter$Models$IssueClosed),
											_p54));
								} else {
									return {ctor: '[]'};
								}
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p57),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p57),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p39._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p58.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p59, _moarwick$elm_webpack_starter$Models$IssueOpen, _p39._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p59, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					...
					if (_p60.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p61.number}),
							{
								ctor: '::',
								_0: A4(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p62.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p60._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p62)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p63.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p64, _moarwick$elm_webpack_starter$Models$IssueOpen, _p39._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p64, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p65.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p66, _moarwick$elm_webpack_starter$Models$IssueClosed, _p39._0),
									_1: {
										ctor: '::',
					...
					return A2(
						...
						function () {
							...
							if (_p67.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p68, _moarwick$elm_webpack_starter$Models$IssueOpen, _p39._0),
									_1: {
										ctor: '::',
					...
					return A2(
						...
						function () {
							...
							if (_p69.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p70, _moarwick$elm_webpack_starter$Models$IssueClosed, _p39._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p70, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				default:
					...
					if (_p71.ctor === 'Just') {
						...
						switch (_p72) {
							case 'unplan':
								var _p73 = _p79.milestone;
								if (_p73.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p79.number}),
										{
											ctor: '::',
											_0: A3(
												...
												_p79,
												_p78,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p73._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p79.number}),
										{
											...
											_0: A4(
												...
												_p78,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p74._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p79.number}),
										{
											...
											_0: A4(
												...
												_p78,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p75._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p79.number}),
										{
											...
											_0: A4(
												...
												_p78,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p76._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'gh':
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$load(_p79.htmlUrl),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								var _p77 = _p79.milestone;
								if (_p77.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											...
											{lockedIssueNumber: _p79.number}),
										{
											...
											_0: A4(
												...
												_p78,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p77._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p79)
										}),
									{ctor: '[]'});
							default:
								return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p80 = persistentData.accessToken;
								if (_p80.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p80._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
							_1: {
								ctor: '::',
								_0: function () {
									var _p81 = _moarwick$elm_webpack_starter$Route$parseHash(location);
