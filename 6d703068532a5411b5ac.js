							...
							function (head, issues) {
								...
								if (_p15.ctor === 'Just') {
									...
									if (_p16.ctor === 'IssueOpen') {
										...
										return A5(_moarwick$elm_webpack_starter$Main$listIssues, head, _p17, _moarwick$elm_webpack_starter$Models$Done, lockedIssueNumber, highlightStory);
									}
								} else {
									return A2(
										_elm_lang$html$Html$span,
			...
			var displayIssuesWithinMilestones = F3(
				function (milestones, issueState, highlightStory) {
					...
					if (_p28.ctor === 'Just') {
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A5(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p32, issueState, model.now, model.lockedIssueNumber, highlightStory) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A5(
											...
											_moarwick$elm_webpack_starter$Main$hasLabel('Status: Ready'),
											model.iceboxIssues,
											_moarwick$elm_webpack_starter$Models$Icebox,
											highlightStory),
										_1: {
			...
			switch (_p43.ctor) {
					...
					return A2(
						...
						function () {
							...
							if (_p77.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p78, _moarwick$elm_webpack_starter$Models$IssueOpen, _p43._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p78, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'IssueFinished':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p79 = model.accessToken;
							if (_p79.ctor === 'Just') {
								var _p80 = _p79._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p80, _moarwick$elm_webpack_starter$Models$IssueClosed, _p43._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p80, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				default:
					...
					if (_p81.ctor === 'Just') {
						...
						switch (_p82) {
							case 'unplan':
								var _p83 = _p90.milestone;
								if (_p83.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p90.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p90,
												_p89,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p83._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p90.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p85._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p89,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p84._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p90.number}),
										{
											...
											_0: A5(
												...
												_p89,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p86._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'gh':
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$load(_p90.htmlUrl),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								var _p88 = _p90.milestone;
								if (_p88.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											...
											{lockedIssueNumber: _p90.number}),
										{
											...
											_0: A5(
												...
												_p89,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p88._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p90)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var isStory = function () {
				var _p91 = page;
				if ((_p91.ctor === 'Just') && (_p91._0.ctor === 'Story')) {
					return true;
				} else {
					return false;
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p92 = persistentData.accessToken;
								if (_p92.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p92._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
