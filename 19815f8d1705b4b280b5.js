...
/***/ function(module, exports, __webpack_require__) {
	...
	const elm = Elm.Main.embed( document.getElementById( 'main' ), [ appData, ("0.12.0") ] );
...
/***/ function(module, exports) {
									...
									return A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$src(_p7._0.avatar),
													_1: {
														ctor: '::',
		...
		function (msg, settings) {
			...
			switch (_p9.ctor) {
				...
				case 'UpdateDefaultRepository':
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepository: _p9._0});
				default:
					return _elm_lang$core$Native_Utils.update(
						settings,
						{defaultRepositoryType: _p9._0});
			}
		});
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p10 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p10.ctor === 'Just') && (_p10._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p11 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p10._0._2)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p13 = model.currentIssues;
		if (_p13.ctor === 'Nothing') {
			var _p14 = model.user;
			if (_p14.ctor === 'Just') {
				var _p15 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p15.ctor === 'Just') {
					switch (_p15._0.ctor) {
						case 'Settings':
							return {ctor: '[]'};
		...
		function (user, model, route) {
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p34._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p35.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p36, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
								...
								function (s) {
									...
									if (_p37.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p37._0));
									} else {
										return 1 / 0;
									}
								},
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p38.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p38._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p39.ctor === 'Just') {
						var _p43 = _p39._0;
						var mss = _elm_lang$core$Dict$values(_p43);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p40 = issueState;
									if (_p40.ctor === 'ClosedIssue') {
										var _p41 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p43, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$Maybe$andThen,
									function (htmlNode) {
										var _p44 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$OpenIssue);
										if (_p44.ctor === 'Just') {
											return _elm_lang$core$Maybe$Just(
												A2(
													_elm_lang$html$Html$div,
								...
								_1: {
									...
									_0: A2(
										...
										A2(
											_elm_lang$core$Maybe$andThen,
											function (htmlNode) {
												var _p45 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$ClosedIssue);
												if (_p45.ctor === 'Just') {
													return _elm_lang$core$Maybe$Just(
														A2(
															_elm_lang$html$Html$div,
		...
		var error = function () {
			...
			if (_p48.ctor === 'Just') {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p48._0),
						_1: {ctor: '[]'}
					});
			} else {
				return _elm_lang$html$Html$text('');
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									...
									function (_p49) {
										return _elm_lang$core$Maybe$Just(
											pickMilestoneModal(_p49));
									},
									model.pickMilestoneForIssue)),
							_1: {
								ctor: '::',
								_0: function () {
									var _p50 = model.accessToken;
									if (_p50.ctor === 'Just') {
										return _elm_lang$html$Html$text('');
									} else {
										return A2(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (_p51, location) {
			var _p52 = _p51;
			var _p57 = _p52._0;
			var recentRepos = _p57.recentRepos;
			...
			var settings = initSettings(_p57);
			...
			var showColumns = A2(
				...
				_p57.columns);
			var pinnedMilestones = _elm_lang$core$Dict$fromList(_p57.pinnedMilestones);
			var a = A2(_elm_lang$core$Debug$log, 'persistent data', _p57);
			var page = _moarwick$elm_webpack_starter$Route$parseHash(location);
			var highlightStory = function () {
				var _p54 = page;
				if ((_p54.ctor === 'Just') && (_p54._0.ctor === 'Story')) {
					return _p54._0._2;
				} else {
					return '';
				}
			}();
			var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_p52._1)(_elm_lang$core$Maybe$Nothing)('')(_p57.accessToken)(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p55 = _p57.accessToken;
								if (_p55.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p55._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
				...
				switch (_p58.ctor) {
					...
					case 'SettingsMsgProxy':
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: A2(_moarwick$elm_webpack_starter$Main$updateSettings, _p58._0, model.settings)
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
					...
					case 'FetchComplete':
						...
						if (_p59.ctor === 'Ok') {
							...
							switch (_p60.ctor) {
								case 'CachedData':
									var _v48 = _p63(
										_elm_lang$core$Maybe$Just(_p60._2)),
										_v49 = _elm_lang$core$Native_Utils.update(
										model,
										{
											etags: A3(_elm_lang$core$Dict$insert, _p60._0, _p60._1, model.etags)
										});
									msg = _v48;
									model = _v49;
									continue update;
								case 'NotModified':
									var _v50 = _p63(_elm_lang$core$Maybe$Nothing),
										_v51 = model;
									msg = _v50;
									model = _v51;
									continue update;
								default:
									var _v52 = _p63(
										_elm_lang$core$Maybe$Just(_p60._0)),
										_v53 = model;
									msg = _v52;
									model = _v53;
									continue update;
							...
							var _p62 = _p59._0;
							var _p61 = _p62;
							if (_p61.ctor === 'BadStatus') {
								if (_elm_lang$core$Native_Utils.eq(_p61._0.status.code, 304)) {
									var _v55 = _p63(_elm_lang$core$Maybe$Nothing),
										_v56 = model;
									msg = _v55;
									model = _v56;
									continue update;
					...
					case 'PinMilestone':
						...
						var pinnedMilestone = A2(
							...
							'',
							A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
						var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p64) ? '' : _p64;
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
							...
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									filter: function () {
										...
										switch (_p67) {
											case 'assigned to me':
												return _moarwick$elm_webpack_starter$Models$AssignedTo(_p68.login);
											case 'created by me':
												return _moarwick$elm_webpack_starter$Models$CreatedBy(_p68.login);
											case 'mentioning me':
												return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p68.login);
											default:
					...
					case 'ShowIssueCreationForm':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{addIssueToColumn: _p58._0, addIssueToMilestone: _p58._1}),
							{
								ctor: '::',
									...
									_1: {
										...
										_0: {
											...
											_1: _elm_lang$core$Json_Encode$list(
												function () {
													...
													switch (_p69.ctor) {
														case 'Backlog':
															var _p70 = model.addIssueToMilestone;
															if (_p70 === '') {
																return {
																	ctor: '::',
										...
										_1: {
											...
											_0: {
												...
												_0: 'milestone',
												_1: function () {
													var _p71 = model.addIssueToMilestone;
													if (_p71 === '') {
											...
											_1: {
												...
												_0: {
													...
													_1: function () {
														var _p72 = _p74;
														if (_p72.ctor === 'Current') {
															var _p73 = model.user;
															if (_p73.ctor === 'Just') {
																return _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p73._0.login),
																		_1: {ctor: '[]'}
																	});
															} else {
																return _elm_lang$core$Json_Encode$list(
						...
						var cmd = (!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
							...
							_1: {
								...
								_0: A4(
									...
									model.accessToken,
									encodedIssue,
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p74, milestone)),
								_1: {ctor: '[]'}
							}
						} : {ctor: '[]'};
						return A2(
						...
						if (_p75.ctor === 'Err') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p76 = _p78;
										if (_p76.ctor === 'Backlog') {
											var _p77 = _p58._1;
											if (_p77.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p77._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p78);
										}
									}(),
									_1: {ctor: '[]'}
								});
					...
					case 'LoadUser':
						...
						if (_p79.ctor === 'Ok') {
							var updatedModel = _elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p79._0),
									error: _elm_lang$core$Maybe$Nothing
								});
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'CurrentTime':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									now: _elm_lang$core$Date$fromTime(_p58._0)
								}),
							_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
					case 'SelectStory':
						var _p83 = _p58._0;
						var _p82 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
						_v69_2:
						do {
							if (_p82.ctor === 'Just') {
								switch (_p82._0.ctor) {
									case 'Story':
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(_p83.number, _p82._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'#/',
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															model.repo,
															A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p83.number)))),
												_1: {ctor: '[]'}
											});
									case 'IssuesIndex':
										return A2(
					...
					case 'UrlChange':
						var _p84 = _p58._0;
						var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p84.hash);
						...
						var updatedModel = A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{location: _p84, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							updatedModel,
							_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					case 'MilestoneIssuesLoaded':
						...
						var updateMilestoneIssues = F2(
							function (issues, s) {
								...
								if (_p85.ctor === 'Just') {
									var _p87 = _p85._0;
									var _p86 = _p93;
									if (_p86.ctor === 'OpenIssue') {
										var m = _p87.milestone;
						...
						var mss = function () {
							var _p89 = updatedModel.milestones;
							if (_p89.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p89._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p90 = _p93;
									if (_p90.ctor === 'ClosedIssue') {
										var _p91 = ms.closedIssues;
					...
					case 'LoadMilestones':
						var result = A2(
							...
							A2(_elm_lang$core$Maybe$withDefault, '[]', _p58._0));
						var _p94 = result;
						if (_p94.ctor === 'Err') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
						...
						if (_p97.ctor === 'Ok') {
							...
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										error: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$toString(_p97._0))
									}),
								{ctor: '[]'});
						}
					case 'IssuesLoaded':
					...
					case 'CopyText':
						return A2(
							...
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$clipboard(_p58._0),
								_1: {ctor: '[]'}
							});
					case 'UnsetMilestone':
						return A2(
							...
							{
								ctor: '::',
								_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p58._0),
								_1: {
									ctor: '::',
									_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
									_1: {ctor: '[]'}
					...
					case 'SetMilestone':
						...
						if (_p101.ctor === 'Just') {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p102.number}),
								{
									ctor: '::',
									_0: A5(
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(
															...
															0,
															_elm_lang$core$Result$toMaybe(
																_elm_lang$core$String$toInt(_p103.number))))
												},
												_1: {ctor: '[]'}
											}),
										_p101._0,
										_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p103)),
									_1: {ctor: '[]'}
								});
						} else {
							return A2(
						...
						return A2(
							...
							function () {
								...
								if (_p104.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p104._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						return A2(
							...
							function () {
								...
								if (_p105.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p105._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
					...
					default:
						var _p113 = _p58._0;
						var _p107 = model.accessToken;
						if (_p107.ctor === 'Just') {
							var _p112 = _p107._0;
							var _p108 = _p58._1;
							switch (_p108) {
								case 'unplan':
									var _p109 = _p113.milestone;
									if (_p109.ctor === 'Just') {
										return A2(
											_elm_lang$core$Platform_Cmd_ops['!'],
											_elm_lang$core$Native_Utils.update(
												model,
												{lockedIssueNumber: _p113.number}),
											{
												ctor: '::',
												_0: A5(
													_moarwick$elm_webpack_starter$Services$updateIssueWith,
													...
													_p112,
													_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p109._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p113.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p110._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p112,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p113.milestone)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p113.number}),
										{
											...
											_0: A5(
												...
												_p112,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p113.milestone)),
											_1: {ctor: '[]'}
										});
								case 'reopen':
									return A2(
											...
											{lockedIssueNumber: _p113.number}),
										{
											...
											_0: A5(
												...
												_p112,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p113.milestone)),
											_1: {ctor: '[]'}
										});
								case 'unstart':
									return A2(
								...
								case 'plan':
									return A2(
										...
										_elm_lang$core$Native_Utils.update(
											model,
											{
												pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p113)
											}),
										{ctor: '[]'});
								case 'ice':
									return A2(
