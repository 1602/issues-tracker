...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Main$listIssues = F4(
		function (issues, col, lockedIssueNumber, highlightStory) {
			...
			var filterOutInProgress = function (issues) {
				var _p0 = col;
				if (_p0.ctor === 'Icebox') {
					return A2(
						...
						function (issue) {
							return !A2(
								_elm_lang$core$List$any,
								function (label) {
									return _elm_lang$core$Native_Utils.eq(label.name, 'Status: In Progress');
								},
								issue.labels);
						},
						issues);
			...
			return A2(
				...
				A2(
					...
					function (expandedMilestone) {
						...
						var issues = function () {
							var _p6 = issueState;
							if (_p6.ctor === 'IssueOpen') {
								return displayIssuesOrLoading(expandedMilestone.openIssues);
							} else {
								return displayIssuesOrLoading(expandedMilestone.closedIssues);
							}
						}();
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											ctor: '::',
											_0: function () {
												var _p8 = expandedMilestone.milestone.dueOn;
												if (_p8.ctor === 'Just') {
													var _p9 = _p8._0;
													return (_elm_lang$core$Native_Utils.cmp(
														_elm_lang$core$Time$inSeconds(
															_elm_lang$core$Date$toTime(_p9)),
														_elm_lang$core$Time$inSeconds(
															_elm_lang$core$Date$toTime(now))) < 0) ? _elm_lang$html$Html$text(' overdue') : _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															' due in ',
															A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p9)));
												} else {
		...
		function (user, model, route) {
					...
					return A2(
						...
						A2(
														...
														_1: {
															...
															_1: {
																...
																_0: {
																	...
																	_0: 'border-left',
																	_1: function () {
																		var _p13 = s.milestone.dueOn;
																		if (_p13.ctor === 'Just') {
																			return A2(
																				_elm_lang$core$Basics_ops['++'],
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p13._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p14.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p15, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								...
								_elm_lang$core$Dict$values(_p11._0))));
				} else {
			...
			var displayIssues = F3(
				function (issues, col, highlightStory) {
					var _p17 = issues;
					if (_p17.ctor === 'Just') {
						return A4(_moarwick$elm_webpack_starter$Main$listIssues, _p17._0, col, model.lockedIssueNumber, highlightStory);
					} else {
						return A2(
							_elm_lang$html$Html$span,
							{
			...
			var displayIssuesWithinMilestones = F3(
				function (milestones, issueState, highlightStory) {
					...
					if (_p18.ctor === 'Just') {
						var _p22 = _p18._0;
						var mss = _elm_lang$core$Dict$values(_p22);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p19 = issueState;
									if (_p19.ctor === 'IssueClosed') {
										var _p20 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? A5(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p22, issueState, model.now, model.lockedIssueNumber, highlightStory) : A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$cellStyle('400px'),
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p26.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p29, model.location),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p27 = model.pickMilestoneForIssue;
									if (_p27.ctor === 'Just') {
										var _p28 = _p27._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p28.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p28.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p28, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
	...
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p33 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p33.ctor === 'Just') && (_p33._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					var _p34 = s;
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p33._0._2)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p35 = model.currentIssues;
		if (_p35.ctor === 'Nothing') {
			var _p36 = model.user;
			if (_p36.ctor === 'Just') {
				var _p37 = model.accessToken;
				if (_p37.ctor === 'Just') {
					var _p39 = _p37._0;
					...
					if (_p38.ctor === 'Just') {
						switch (_p38._0.ctor) {
							case 'Story':
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p39);
							case 'IssuesIndex':
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p39);
							default:
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p39);
	...
	var _moarwick$elm_webpack_starter$Main$aboutToLoadResource = F2(
		function (loc, model) {
			...
			var _p40 = page;
			if ((_p40.ctor === 'Just') && (_p40._0.ctor === 'IssuesIndex')) {
				return model;
			} else {
				return model;
			}
	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p41.ctor) {
				...
				case 'LoadUser':
					...
					if (_p42.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p42._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p41._0)
							}),
						function () {
							var _p43 = model.accessToken;
							if (_p43.ctor === 'Just') {
								return A2(_moarwick$elm_webpack_starter$Main$loadAllIssues, model.repo, _p43._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p45 = _p41._0;
					var _p44 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v38_2:
					do {
						if (_p44.ctor === 'Just') {
							switch (_p44._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p45.number, _p44._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p45.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p46 = _p41._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p46.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p46, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p47.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p48.ctor === 'Just') {
												var _p50 = _p48._0;
												var _p49 = _p56;
												if (_p49.ctor === 'IssueOpen') {
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p50,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p55)
															}));
												} else {
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p50,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p55)
															}));
												}
											} else {
												return _elm_lang$core$Maybe$Nothing;
						...
						var mss = function () {
							var _p51 = updatedModel.milestones;
							if (_p51.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p51._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p52 = _p56;
									if (_p52.ctor === 'IssueClosed') {
										var _p53 = ms.closedIssues;
							...
							function () {
								...
								if (_p59.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p60, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p60, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p65),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p65),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p41._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p66 = model.accessToken;
							if (_p66.ctor === 'Just') {
								var _p67 = _p66._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p67, _moarwick$elm_webpack_starter$Models$IssueOpen, _p41._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p67, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					...
					if (_p68.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p69.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p70.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p68._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p70)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'MilestoneSet':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p71 = model.accessToken;
							if (_p71.ctor === 'Just') {
								var _p72 = _p71._0;
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p72, _moarwick$elm_webpack_starter$Models$IssueOpen, _p41._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p72, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p73.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p74, _moarwick$elm_webpack_starter$Models$IssueClosed, _p41._0),
									_1: {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchIssues, model.repo, _p74, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p75.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p76, _moarwick$elm_webpack_starter$Models$IssueOpen, _p41._0),
									_1: {
										ctor: '::',
					...
					return A2(
						...
						function () {
							...
							if (_p77.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.repo, _p78, _moarwick$elm_webpack_starter$Models$IssueClosed, _p41._0),
									_1: {
										ctor: '::',
						...
						switch (_p80) {
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A4(
												...
												_p88,
												_p87,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p81._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
										...
										return A2(
												...
												{lockedIssueNumber: _p88.number}),
											{
												...
												_0: A5(
															...
															_1: {
																...
																_0: {
																	...
																	_1: _elm_lang$core$Json_Encode$list(
																		{
																			ctor: '::',
																			_0: _elm_lang$core$Json_Encode$string(_p83._0.login),
																			_1: {ctor: '[]'}
																		})
																},
																_1: {ctor: '[]'}
													...
													_p87,
													_moarwick$elm_webpack_starter$Messages$IssueStarted(_p82._0)),
												_1: {ctor: '[]'}
											});
									} else {
										return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A5(
												...
												_p87,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p84._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A5(
												...
												_p87,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p85._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'gh':
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$load(_p88.htmlUrl),
										_1: {ctor: '[]'}
									});
							case 'unstart':
									...
									return A2(
											...
											{lockedIssueNumber: _p88.number}),
										{
											...
											_0: A5(
												...
												_p87,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p86._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
