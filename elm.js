																										...
																										return function (_1) {
																											return function (_2) {
																												return function (_3) {
																													return function (_4) {
																														return function (_5) {
																															return {settings: a, version: b, user: c, token: d, accessToken: e, repo: f, location: g, now: h, error: i, currentIssues: j, iceboxIssues: k, closedIssues: l, milestones: m, pickMilestoneForIssue: n, lockedIssueNumber: o, highlightStory: p, newMilestoneTitle: q, newIssueTitle: r, needFocus: s, addIssueToColumn: t, addIssueToMilestone: u, filter: v, showColumns: w, pinnedMilestones: x, filterStoriesBy: y, recentRepos: z, etags: _1, searchTerms: _2, searchResults: _3, didSwitch: _4, savedSearches: _5};
																														};
																													};
																												};
																											};
...
var _moarwick$elm_webpack_starter$Models$PersistedData = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {accessToken: a, savedSearches: b, pinnedMilestones: c, columns: d, defaultRepositoryType: e, defaultRepository: f, recentRepos: g, doneLimit: h, powerOfNow: i};
	});
var _moarwick$elm_webpack_starter$Models$Settings = F4(
	function (a, b, c, d) {
		return {defaultRepositoryType: a, defaultRepository: b, doneLimit: c, powerOfNow: d};
	});
...
var _moarwick$elm_webpack_starter$Models$Search = {ctor: 'Search'};
...
var _moarwick$elm_webpack_starter$Models$ClosedIssue = {ctor: 'ClosedIssue'};
var _moarwick$elm_webpack_starter$Models$OpenIssue = {ctor: 'OpenIssue'};
var _moarwick$elm_webpack_starter$Models$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _moarwick$elm_webpack_starter$Models$Loading = {ctor: 'Loading'};
var _moarwick$elm_webpack_starter$Models$NotRequested = {ctor: 'NotRequested'};
...
var _moarwick$elm_webpack_starter$GithubMarkdown$replaceNamedLinksWithIssues = function () {
	var expr = _elm_lang$core$Regex$regex('\\(\\s*https:\\/\\/github.com\\/(.+?)\\/(.+?)\\/issues\\/(\\d+)\\s*\\)');
	var replaceNamedLinkWithIssue = function (match) {
		var _p0 = match.submatches;
		if (((((((_p0.ctor === '::') && (_p0._0.ctor === 'Just')) && (_p0._1.ctor === '::')) && (_p0._1._0.ctor === 'Just')) && (_p0._1._1.ctor === '::')) && (_p0._1._1._0.ctor === 'Just')) && (_p0._1._1._1.ctor === '[]')) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'(#/',
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'/stories/',
								A2(_elm_lang$core$Basics_ops['++'], _p0._1._1._0._0, ')'))))));
		} else {
			return match.match;
		}
	};
	return A3(_elm_lang$core$Regex$replace, _elm_lang$core$Regex$All, expr, replaceNamedLinkWithIssue);
}();
var _moarwick$elm_webpack_starter$GithubMarkdown$replaceLinksWithIssues = function () {
	var expr = _elm_lang$core$Regex$regex('\\shttps:\\/\\/github.com\\/(.+?)\\/(.+?)\\/issues\\/(\\d+)');
	var replaceLinkWithIssue = function (match) {
		var _p1 = match.submatches;
		if (((((((_p1.ctor === '::') && (_p1._0.ctor === 'Just')) && (_p1._1.ctor === '::')) && (_p1._1._0.ctor === 'Just')) && (_p1._1._1.ctor === '::')) && (_p1._1._1._0.ctor === 'Just')) && (_p1._1._1._1.ctor === '[]')) {
			var _p4 = _p1._1._0._0;
			var _p3 = _p1._0._0;
			var _p2 = _p1._1._1._0._0;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				' [',
				A2(
	...
	return A3(_elm_lang$core$Regex$replace, _elm_lang$core$Regex$All, expr, replaceLinkWithIssue);
}();
var _moarwick$elm_webpack_starter$GithubMarkdown$replaceHashesWithLinks = function (repo) {
	var replaceHashWithLink = function (match) {
	...
	var expr = _elm_lang$core$Regex$regex('\\s#(\\d+)');
	return A3(_elm_lang$core$Regex$replace, _elm_lang$core$Regex$All, expr, replaceHashWithLink);
};
var _moarwick$elm_webpack_starter$GithubMarkdown$ghMd = F2(
	function (repo, str) {
		return A2(
			_evancz$elm_markdown$Markdown$toHtml,
			{ctor: '[]'},
			A2(
				_moarwick$elm_webpack_starter$GithubMarkdown$replaceHashesWithLinks,
				repo,
				_moarwick$elm_webpack_starter$GithubMarkdown$replaceNamedLinksWithIssues(
					_moarwick$elm_webpack_starter$GithubMarkdown$replaceLinksWithIssues(str))));
	});
...
var _moarwick$elm_webpack_starter$Messages$ClearSearch = {ctor: 'ClearSearch'};
var _moarwick$elm_webpack_starter$Messages$SearchBy = function (a) {
	return {ctor: 'SearchBy', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$ToggleSaveSearch = {ctor: 'ToggleSaveSearch'};
var _moarwick$elm_webpack_starter$Messages$IssuesSearchResults = function (a) {
	return {ctor: 'IssuesSearchResults', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$ChangeSearchTerms = function (a) {
	return {ctor: 'ChangeSearchTerms', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$SearchIssues = {ctor: 'SearchIssues'};
var _moarwick$elm_webpack_starter$Messages$NavigateToIssue = function (a) {
	return {ctor: 'NavigateToIssue', _0: a};
};
var _moarwick$elm_webpack_starter$Messages$SettingsMsgProxy = function (a) {
	return {ctor: 'SettingsMsgProxy', _0: a};
};
...
var _moarwick$elm_webpack_starter$Messages$IgnoreIdeas = {ctor: 'IgnoreIdeas'};
	...
	function (url, etags, oncomplete) {
			...
			return _elm_lang$core$List$head(
				A2(
					...
					function (_p2) {
						...
						return _elm_lang$core$Native_Utils.eq(
							'etag',
							_elm_lang$core$String$toLower(_p3._0)) ? _elm_lang$core$Maybe$Just(_p3._1) : _elm_lang$core$Maybe$Nothing;
					},
					_elm_lang$core$Dict$toList(res.headers)));
		};
		var _p4 = function () {
			var _p5 = A2(_elm_lang$core$Dict$get, url, etags);
			if (_p5.ctor === 'Just') {
		...
		return A2(
			...
			_elm_lang$http$Http$request(
				{
					method: 'GET',
					headers: (!_elm_lang$core$Native_Utils.eq(etag, '')) ? {
						ctor: '::',
						_0: A2(_elm_lang$http$Http$header, 'If-None-Match', etag),
						_1: {ctor: '[]'}
					} : {
						ctor: '::',
						_0: A2(_elm_lang$http$Http$header, 'If-Modified-Since', '0'),
					...
					expect: _elm_lang$http$Http$expectStringResponse(
						function (res) {
							if (_elm_lang$core$Native_Utils.eq(res.status.code, 304)) {
								return _elm_lang$core$Result$Ok(
									A3(_moarwick$elm_webpack_starter$Models$CachedData, res.url, etag, cachedBody));
							} else {
								var _p6 = extractEtag(res);
								if (_p6.ctor === 'Just') {
									return _elm_lang$core$Result$Ok(
										A3(_moarwick$elm_webpack_starter$Models$CachedData, res.url, _p6._0, res.body));
								} else {
									return _elm_lang$core$Result$Ok(
...
var _moarwick$elm_webpack_starter$Services$searchIssues = function (_p7) {
	var _p8 = _p7;
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$Maybe$withDefault, '', _p8.accessToken),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'&q=repo:',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_p8.repo,
					A2(_elm_lang$core$Basics_ops['++'], ' ', _p8.searchTerms)))));
	return A3(_moarwick$elm_webpack_starter$Services$cachingFetch, url, _p8.etags, _moarwick$elm_webpack_starter$Messages$IssuesSearchResults);
};
var _moarwick$elm_webpack_starter$Services$fetchIssues = F2(
	function (model, column) {
		...
		var since = function () {
			var _p9 = column;
			if (_p9.ctor === 'Done') {
				var _p10 = model.settings.doneLimit;
				switch (_p10) {
					case 'a day':
		...
		var filterByUser = function () {
			...
			switch (_p14.ctor) {
				case 'CreatedBy':
					return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p14._0);
				case 'AssignedTo':
					return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p14._0);
				case 'HasMentionOf':
					return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p14._0);
				default:
					return '';
			}
		}();
...
var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F3(
	function (model, issueState, ms) {
		...
		var since = function () {
			var _p15 = issueState;
			if (_p15.ctor === 'ClosedIssue') {
				var _p16 = model.settings.doneLimit;
				switch (_p16) {
					case 'a day':
						return A2(pastMoment, -1, _justinmimbs$elm_date_extra$Date_Extra$Day);
					case 'a week':
		...
		var filterByUser = function () {
			...
			switch (_p18.ctor) {
				case 'CreatedBy':
					return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p18._0);
				case 'AssignedTo':
					return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p18._0);
				case 'HasMentionOf':
					return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p18._0);
				default:
					return '';
			}
		}();
...
var _moarwick$elm_webpack_starter$Main$viewSettings = function (model) {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border', _1: '1px solid #555'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'padding', _1: '5px'},
									_1: {
	...
	var select = F3(
		function (onSelect, values, currentValue) {
			return A2(
				_elm_lang$html$Html$select,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(onSelect),
					_1: {ctor: '[]'}
				},
				A2(options, values, currentValue));
		});
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				'Default repository',
				{
					...
					_0: A3(
						select,
						_moarwick$elm_webpack_starter$Messages$ChangeDefaultRepositoryType,
						{
							ctor: '::',
							_0: 'last visited',
							_1: {
			...
			_1: {
				...
				_0: A2(
					settingsBlock,
					'Limit for \'We just did it\'',
					{
						ctor: '::',
						_0: A3(
							select,
							_moarwick$elm_webpack_starter$Messages$ChangeDoneLimit,
							{
								ctor: '::',
								_0: 'a day',
								_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$checked(model.settings.powerOfNow),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$type_('checkbox'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Messages$IgnoreIdeas),
													_1: {ctor: '[]'}
												}
											}
										},
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' ignore milestones with no due date'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											model.settings.powerOfNow ? 'keep this box ticked' : 'tick this box'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' if you don\'t want to be bothered by the things that will not happen in the nearest future'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
							...
							'App Version',
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('this app is in active development, sometimes you need to refresh app very hard in order to have some old bugs fixed (and possibly grab some new bugs at the same time, sorry), this version number will help you to find whether your cached app version is latest (same as '),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('https://github.com/1602/issues-tracker/blob/master/package.json#L4'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
...
var _moarwick$elm_webpack_starter$Main$columnTitle = function (col) {
	var _p0 = col;
	switch (_p0.ctor) {
		case 'Search':
			return {ctor: '_Tuple3', _0: '🔎', _1: 'Search', _2: ''};
		case 'Icebox':
			return {ctor: '_Tuple3', _0: '❄', _1: 'Icebox', _2: '(keep this place empty)'};
		case 'Backlog':
			return {ctor: '_Tuple3', _0: '🚥', _1: 'Backlog', _2: '(plan all the things via milestones)'};
		case 'Current':
			return {ctor: '_Tuple3', _0: '🐝', _1: 'In progress', _2: '(issues with status \'In Progress\')'};
		default:
			return {ctor: '_Tuple3', _0: '🎉', _1: 'Done', _2: '(closed issues)'};
	}
};
var _moarwick$elm_webpack_starter$Main$reopeningColumnButton = F3(
	function (col, showColumns, list) {
		var _p1 = _moarwick$elm_webpack_starter$Main$columnTitle(col);
		var icon = _p1._0;
		var title = _p1._1;
		return A2(_elm_lang$core$List$member, col, showColumns) ? {
			ctor: '::',
			_0: A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'transition', _1: 'filter 0.1s, background 0.1s'},
												_1: {ctor: '[]'}
											}
										}
									}
							...
							A2(
								...
								function (_p2) {
									var _p3 = _p2;
									return !_elm_lang$core$Native_Utils.eq(_p3._0, 'margin-top');
								},
					...
					_0: _elm_lang$html$Html_Attributes$style(
						A2(
								...
								}),
							{
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(40,40,40,1)'},
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'filter', _1: 'grayscale(0.9) brightness(50%)'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'height', _1: '30px'},
													_1: {
							...
							A2(
								...
								function (_p4) {
									var _p5 = _p4;
									var _p6 = _p5._0;
									return (!_elm_lang$core$Native_Utils.eq(_p6, 'margin-top')) && ((!_elm_lang$core$Native_Utils.eq(_p6, 'background')) && (!_elm_lang$core$Native_Utils.eq(_p6, 'color')));
								},
								_moarwick$elm_webpack_starter$Main$buttonStyle))),
					_1: {
						ctor: '::',
...
var _moarwick$elm_webpack_starter$Main$viewNavigation = F2(
	function (user, model) {
		var menuListItemStyle = function (isActive) {
			return _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'background',
												_1: isActive ? 'rgb(246,246,247)' : 'rgba(255,255,255, 0.1)'
											},
											_1: {
												ctor: '::',
		...
		var activePage = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
		var isSettingsActive = function () {
			var _p7 = activePage;
			if ((_p7.ctor === 'Just') && (_p7._0.ctor === 'Settings')) {
				return true;
			} else {
				return false;
			}
		...
		var issuesSubnav = A2(
			...
			A3(
				...
				_moarwick$elm_webpack_starter$Models$Search,
				model.showColumns,
				A3(
					_moarwick$elm_webpack_starter$Main$reopeningColumnButton,
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'width', _1: '41px'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#1d1d1d'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'padding', _1: '5px'},
									_1: {ctor: '[]'}
						...
						_0: function () {
							...
							if (_p9.ctor === 'Nothing') {
								...
								return A2(
									...
									{
										ctor: '::',
										_0: menuListItemStyle(isSettingsActive),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$src(_p9._0.avatar),
														_1: {
															ctor: '::',
...
var _moarwick$elm_webpack_starter$Main$updateSettings = F2(
	function (msg, settings) {
		...
		switch (_p11.ctor) {
			case 'IgnoreIdeas':
				return _elm_lang$core$Native_Utils.update(
					settings,
					{powerOfNow: !settings.powerOfNow});
			...
			case 'UpdateDefaultRepository':
				return _elm_lang$core$Native_Utils.update(
					settings,
					{defaultRepository: _p11._0});
			default:
				return _elm_lang$core$Native_Utils.update(
					settings,
					{defaultRepositoryType: _p11._0});
		}
	});
var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
	var _p12 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
	if ((_p12.ctor === 'Just') && (_p12._0.ctor === 'Story')) {
		return A2(
			_elm_lang$core$Task$attempt,
			function (s) {
				var _p13 = s;
			...
			_elm_lang$dom$Dom$focus(
				A2(_elm_lang$core$Basics_ops['++'], 'story-', _p12._0._2)));
	} else {
...
var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
	var _p15 = model.user;
	if (_p15.ctor === 'Just') {
		var _p16 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
		if (_p16.ctor === 'Just') {
			switch (_p16._0.ctor) {
				case 'Settings':
					return {ctor: '[]'};
...
var _moarwick$elm_webpack_starter$Main$listIssues = F7(
	function (_p17, allowAdd, issues, col, model, addto, milestoneNumber) {
		var _p18 = _p17;
		var milestone = function () {
			var _p19 = _elm_lang$core$List$head(issues);
			if (_p19.ctor === 'Just') {
				return _p19._0.milestone;
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		}();
		...
		return A2(
			...
			{ctor: '[]'},
			function (list) {
				return (_elm_lang$core$List$isEmpty(list) && (!_elm_lang$core$Native_Utils.eq(model.filterStoriesBy, ''))) ? {ctor: '[]'} : {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
										...
										_0: A2(
											...
											},
											{
												...
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														A2(_elm_lang$core$Maybe$withDefault, '', _p18._0),
														' ')),
												_1: {
													ctor: '::',
													_0: _p18._1,
															...
															_0: _elm_lang$core$Native_Utils.eq(issue.number, model.highlightStory) ? A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: A2(_moarwick$elm_webpack_starter$GithubMarkdown$ghMd, model.repo, issue.description),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
...
var _moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones = F4(
	function (milestones, issueState, now, model) {
		var pinnedMilestoneNumber = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
		var milestoneSortingRule = function (ems) {
			if (_elm_lang$core$Native_Utils.eq(ems.milestone.number, pinnedMilestoneNumber)) {
				return 0;
			} else {
				var _p22 = ems.milestone.dueOn;
				if (_p22.ctor === 'Nothing') {
					return 1 / 0;
				} else {
					return _elm_lang$core$Time$inSeconds(
						_elm_lang$core$Date$toTime(_p22._0));
				}
			}
		};
		var renderMilestoneWithIssues = function (expandedMilestone) {
			var heading = {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.eq(expandedMilestone.milestone.number, pinnedMilestoneNumber) ? _elm_lang$core$Maybe$Just('📌') : _elm_lang$core$Maybe$Just('🏁'),
				_1: A2(
					_elm_lang$html$Html$span,
					{
						ctor: '::',
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								function () {
									var _p23 = expandedMilestone.milestone.dueOn;
									if (_p23.ctor === 'Just') {
										var _p24 = _p23._0;
										return (_elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Time$inSeconds(
												_elm_lang$core$Date$toTime(_p24)),
											_elm_lang$core$Time$inSeconds(
												_elm_lang$core$Date$toTime(now))) < 0) ? ' overdue' : A2(
											_elm_lang$core$Basics_ops['++'],
											' due in ',
											A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p24));
									} else {
										return ' (no due date)';
									}
								}())),
				...
				function (head, issues) {
					...
					if (_p25.ctor === 'Just') {
						...
						if (_p26.ctor === 'OpenIssue') {
							...
							return A7(_moarwick$elm_webpack_starter$Main$listIssues, head, true, _p27, _moarwick$elm_webpack_starter$Models$Done, model, _moarwick$elm_webpack_starter$Models$Done, expandedMilestone.milestone.number);
						}
					} else {
						return A2(
							_elm_lang$html$Html$span,
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				renderMilestoneWithIssues,
				A2(
					_elm_lang$core$List$sortBy,
					milestoneSortingRule,
					_elm_lang$core$Dict$values(milestones))));
	});
var _moarwick$elm_webpack_starter$Main$viewPage = F3(
	function (user, model, route) {
		var column = F3(
			function (col, colHtml, content) {
				var _p30 = _moarwick$elm_webpack_starter$Main$columnTitle(col);
				var icon = _p30._0;
				var title = _p30._1;
				var comment = _p30._2;
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_0: {
									...
									_0: 'width',
									_1: function () {
										var _p31 = _elm_lang$core$List$length(model.showColumns);
										switch (_p31) {
											case 3:
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'transition', _1: 'width .1s'},
									_1: {
										ctor: '::',
													...
													_0: _elm_lang$html$Html_Attributes$style(
														{
															...
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'right', _1: '1px'},
																_1: {
																	ctor: '::',
		...
		var milestonesIndex = function () {
			var _p33 = A2(_elm_lang$core$Dict$get, model.repo, model.milestones);
			if (_p33.ctor === 'Just') {
				return A2(
					_elm_lang$html$Html$ul,
					{
					...
					A2(
						...
						function (s) {
							var isOverdue = function () {
								var _p34 = s.milestone.dueOn;
								if (_p34.ctor === 'Just') {
									return _elm_lang$core$Native_Utils.cmp(
										_elm_lang$core$Date$toTime(_p34._0),
													...
													_1: {
														...
														_1: {
															...
															_0: {
																...
																_0: 'border-left',
																_1: function () {
																	var _p35 = s.milestone.dueOn;
																	if (_p35.ctor === 'Just') {
																		return A2(
																			_elm_lang$core$Basics_ops['++'],
																			_elm_lang$core$Basics$toString(
																				(_elm_lang$core$Time$inHours(
																					_elm_lang$core$Date$toTime(_p35._0)) / 12) - (_elm_lang$core$Time$inHours(
													...
													function () {
														...
														if (_p36.ctor === 'Just') {
															...
															return isOverdue ? A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p37, model.now),
																	' overdue)')) : A2(
																_elm_lang$core$Basics_ops['++'],
																' (due in ',
																A2(
						...
						A2(
							_elm_lang$core$List$sortBy,
							function (s) {
								var _p38 = s.milestone.dueOn;
								if (_p38.ctor === 'Just') {
									return _elm_lang$core$Time$inHours(
										_elm_lang$core$Date$toTime(_p38._0));
								} else {
									return 1 / 0;
								}
							},
			...
			function (head, filter, issues, col, addto, milestoneNumber) {
				...
				if (_p39.ctor === 'Just') {
					return A7(
						...
						head,
						true,
						A2(_elm_lang$core$List$filter, filter, _p39._0),
						col,
						model,
						addto,
						milestoneNumber);
		...
		var displayIssuesWithinMilestones = F2(
			function (milestones, issueState) {
				...
				if (_p40.ctor === 'Just') {
					var _p44 = _p40._0;
					var mss = _elm_lang$core$Dict$values(_p44);
					var loaded = A3(
						_elm_lang$core$List$foldl,
						F2(
							function (ms, res) {
								var _p41 = issueState;
								if (_p41.ctor === 'ClosedIssue') {
									var _p42 = ms.closedIssues;
					...
					return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
						A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p44, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'width', _1: 'calc(100% - 42px)'},
								_1: {
									ctor: '::',
				...
				_0: A3(
					...
					_elm_lang$core$Maybe$Just(
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('search-issue'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'width', _1: 'calc(100% - 128px)'},
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onSubmit(_moarwick$elm_webpack_starter$Messages$SearchIssues),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('search-term'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.searchTerms),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_moarwick$elm_webpack_starter$Messages$ChangeSearchTerms),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p45 = model.searchResults;
										if (_p45.ctor === 'Loaded') {
											return A2(
												_elm_lang$html$Html$span,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('clear-search'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Messages$ClearSearch),
														_1: {ctor: '[]'}
													}
												},
												{
									...
									_1: {
										ctor: '::',
										_0: function () {
											if (!_elm_lang$core$Native_Utils.eq(model.searchTerms, '')) {
												var _p46 = model.searchResults;
												if (_p46.ctor === 'Loaded') {
													return A2(
														_elm_lang$html$Html$span,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class(
																A2(_elm_lang$core$Dict$member, model.searchTerms, model.savedSearches) ? 'saved-search' : 'not-saved-search'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Messages$ToggleSaveSearch),
																_1: {ctor: '[]'}
															}
														},
														{
							...
							switch (_p47.ctor) {
									...
									return A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _moarwick$elm_webpack_starter$Main$cellStyle('calc(100% - 10px)'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$target('_blank'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href('https://help.github.com/articles/searching-issues/#search-within-a-users-or-organizations-repositories'),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Github search documentation'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													A2(
														...
														function (search) {
															return A2(
																_elm_lang$html$Html$li,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(
																		_moarwick$elm_webpack_starter$Messages$SearchBy(search)),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
														...
														_elm_lang$core$Dict$values(model.savedSearches))),
												_1: {ctor: '[]'}
											}
										});
								case 'Loading':
								...
								default:
									return A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(displayIssuesGroupedByDate, _p47._0, _moarwick$elm_webpack_starter$Models$Icebox));
							}
						}())),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A3(
							...
							A2(
								...
								function (htmlNode) {
									var _p48 = A2(
										displayIssuesWithinMilestones,
										A2(_elm_lang$core$Dict$get, model.repo, model.milestones),
										_moarwick$elm_webpack_starter$Models$OpenIssue);
									if (_p48.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
									...
									A2(
										...
										function (htmlNode) {
											var _p49 = A2(
												displayIssuesWithinMilestones,
												A2(_elm_lang$core$Dict$get, model.repo, model.milestones),
												_moarwick$elm_webpack_starter$Models$ClosedIssue);
											if (_p49.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
			...
			switch (_p51.ctor) {
				...
				default:
					return A2(
						...
						_moarwick$elm_webpack_starter$Messages$SettingsMsgProxy,
						_moarwick$elm_webpack_starter$Main$viewSettings(model));
			}
		}
	});
var _moarwick$elm_webpack_starter$Main$view = function (model) {
	...
	var error = function () {
		...
		if (_p52.ctor === 'Just') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_p52._0),
					_1: {ctor: '[]'}
				});
		} else {
			return _elm_lang$html$Html$text('');
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_moarwick$elm_webpack_starter$Main$viewNavigation, model.user, model),
			_1: {
				ctor: '::',
				_0: A3(
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								...
								function (_p53) {
									return _elm_lang$core$Maybe$Just(
										pickMilestoneModal(_p53));
								},
								model.pickMilestoneForIssue)),
						_1: {
							ctor: '::',
							_0: function () {
								var _p54 = model.accessToken;
								if (_p54.ctor === 'Just') {
									return _elm_lang$html$Html$text('');
								} else {
									return A2(
...
var _moarwick$elm_webpack_starter$Main$init = F2(
	function (_p55, location) {
		var _p56 = _p55;
		var _p61 = _p56._0;
		var recentRepos = _p61.recentRepos;
		var initSettings = function (x) {
			return A4(_moarwick$elm_webpack_starter$Models$Settings, x.defaultRepositoryType, x.defaultRepository, x.doneLimit, x.powerOfNow);
		};
		var settings = initSettings(_p61);
		...
		var showColumns = A2(
			...
			function (s) {
				...
				switch (_p57) {
					...
					case 'Search':
						return _moarwick$elm_webpack_starter$Models$Search;
					default:
						return _moarwick$elm_webpack_starter$Models$Backlog;
				}
			},
			_p61.columns);
		var pinnedMilestones = _elm_lang$core$Dict$fromList(_p61.pinnedMilestones);
		var a = A2(_elm_lang$core$Debug$log, 'persistent data', _p61);
		var page = _moarwick$elm_webpack_starter$Route$parseHash(location);
		var highlightStory = function () {
			var _p58 = page;
			if ((_p58.ctor === 'Just') && (_p58._0.ctor === 'Story')) {
				return _p58._0._2;
			} else {
				return '';
			}
		}();
		var needFocus = !_elm_lang$core$Native_Utils.eq(highlightStory, '');
		var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_p56._1)(_elm_lang$core$Maybe$Nothing)('')(_p61.accessToken)(
			_moarwick$elm_webpack_starter$Main$extractRepo(location.hash))(location)(
			_elm_lang$core$Date$fromTime(
				_elm_lang$core$Time$millisecond * _elm_lang$core$Basics$toFloat(0)))(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Dict$empty)(_elm_lang$core$Maybe$Nothing)('')(highlightStory)('')('')(needFocus)(_moarwick$elm_webpack_starter$Models$Done)('')(_moarwick$elm_webpack_starter$Models$All)(showColumns)(pinnedMilestones)('')(recentRepos)(_elm_lang$core$Dict$empty)('')(_moarwick$elm_webpack_starter$Models$NotRequested)(true)(
			_elm_lang$core$Dict$fromList(_p61.savedSearches));
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_1: {
						ctor: '::',
						_0: function () {
							var _p59 = _p61.accessToken;
							if (_p59.ctor === 'Just') {
								return _moarwick$elm_webpack_starter$Services$fetchUser(_p59._0);
							} else {
								return _elm_lang$core$Platform_Cmd$none;
							}
						}(),
...
var _moarwick$elm_webpack_starter$Main$navigateToIssue = _elm_lang$core$Native_Platform.incomingPort(
	'navigateToIssue',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _moarwick$elm_webpack_starter$Main$navigateToIssue(_moarwick$elm_webpack_starter$Messages$NavigateToIssue),
				_1: {ctor: '[]'}
			}
		});
};
...
var _moarwick$elm_webpack_starter$Main$saveData = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			...
			savedSearches: _elm_lang$core$Native_List.toArray(v.savedSearches).map(
				function (v) {
					return [v._0, v._1];
				}),
...
var _moarwick$elm_webpack_starter$Main$updateLocalStorage = function (model) {
	return _moarwick$elm_webpack_starter$Main$saveData(
		A9(
			...
			model.accessToken,
			_elm_lang$core$Dict$toList(model.savedSearches),
			...
			switch (_p62.ctor) {
				...
				case 'ClearSearch':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{searchTerms: '', searchResults: _moarwick$elm_webpack_starter$Models$NotRequested}),
						{ctor: '[]'});
				case 'ToggleSaveSearch':
					var savedSearches = function (s) {
						return _elm_lang$core$Native_Utils.eq(model.searchTerms, '') ? s : (A2(_elm_lang$core$Dict$member, model.searchTerms, s) ? A2(_elm_lang$core$Dict$remove, model.searchTerms, s) : A3(_elm_lang$core$Dict$insert, model.searchTerms, model.searchTerms, s));
					};
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							savedSearches: savedSearches(model.savedSearches)
						});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
					...
					var updatedModel = function () {
						...
						if (_p63.ctor === 'Ok') {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									searchResults: _moarwick$elm_webpack_starter$Models$Loaded(_p63._0)
								});
						} else {
							return _elm_lang$core$Native_Utils.update(
								model,
				...
				case 'SearchBy':
					...
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Services$searchIssues(updatedModel),
							_1: {ctor: '[]'}
						});
				case 'SearchIssues':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Services$searchIssues(model),
							_1: {ctor: '[]'}
						});
							...
							_0: _elm_lang$navigation$Navigation$modifyUrl(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_p62._0._0,
										A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p62._0._1)))),
							_1: {ctor: '[]'}
						});
				case 'SettingsMsgProxy':
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							settings: A2(_moarwick$elm_webpack_starter$Main$updateSettings, _p62._0, model.settings)
						});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
				...
				case 'FetchComplete':
					...
					if (_p64.ctor === 'Ok') {
							...
							var _v53 = _p72(_p66),
								...
								model,
								{
									etags: A3(
										_elm_lang$core$Dict$insert,
										_p65._0,
										{ctor: '_Tuple2', _0: _p65._1, _1: _p66},
										model.etags)
								});
							msg = _v53;
							model = _v54;
						...
						var _p71 = _p64._0;
						var _p67 = _p71;
						if (_p67.ctor === 'BadStatus') {
							var _p70 = _p67._0;
							var _p68 = function () {
								var _p69 = A2(_elm_lang$core$Dict$get, _p70.url, model.etags);
								if (_p69.ctor === 'Just') {
									return {ctor: '_Tuple2', _0: _p69._0._0, _1: _p69._0._1};
								} else {
									return {ctor: '_Tuple2', _0: '', _1: ''};
								}
							}();
							var etag = _p68._0;
							var body = _p68._1;
							if (_elm_lang$core$Native_Utils.eq(_p70.status.code, 304) && (!_elm_lang$core$Native_Utils.eq(body, ''))) {
								var _v59 = _p72(body),
									_v60 = model;
								msg = _v59;
								model = _v60;
				...
				case 'PinMilestone':
					...
					var pinnedMilestone = A2(
						...
						'',
						A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
					var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p73) ? '' : _p73;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p76) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p77.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p77.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p77.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p62._0, addIssueToMilestone: _p62._1}),
						{
							ctor: '::',
				...
				case 'CreateStory':
					...
					var milestone = A2(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Dict$empty,
								A2(_elm_lang$core$Dict$get, model.repo, model.milestones))));
					var encodedIssue = _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								...
								_1: {
									...
									_0: {
										...
										_1: _elm_lang$core$Json_Encode$list(
											function () {
												...
												switch (_p78.ctor) {
													case 'Backlog':
														var _p79 = model.addIssueToMilestone;
														if (_p79 === '') {
															return {
																ctor: '::',
									...
									_1: {
										...
										_0: {
											...
											_0: 'milestone',
											_1: function () {
												var _p80 = model.addIssueToMilestone;
												if (_p80 === '') {
													...
													return _elm_lang$core$Json_Encode$int(
														A2(
															_elm_lang$core$Result$withDefault,
															0,
															_elm_lang$core$String$toInt(model.addIssueToMilestone)));
												}
											}()
										},
										_1: {
											...
											_0: {
												...
												_1: function () {
													var _p81 = _p83;
													if (_p81.ctor === 'Current') {
														var _p82 = model.user;
														if (_p82.ctor === 'Just') {
															return _elm_lang$core$Json_Encode$list(
																{
																	ctor: '::',
																	_0: _elm_lang$core$Json_Encode$string(_p82._0.login),
																	_1: {ctor: '[]'}
																});
														} else {
															return _elm_lang$core$Json_Encode$list(
					...
					var cmd = (!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Main$setFocus('create-story'),
						_1: {
							ctor: '::',
							_0: A4(
								...
								model.accessToken,
								encodedIssue,
								A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p83, milestone)),
							_1: {ctor: '[]'}
						}
					} : {ctor: '[]'};
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{newIssueTitle: '', etags: _elm_lang$core$Dict$empty}),
						cmd);
				case 'StoryCreated':
					var _p87 = _p62._0;
					var _p84 = _p62._2;
					if (_p84.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p84._0))
								}),
							{ctor: '[]'});
					} else {
						return A2(
							...
							model,
							{
								...
								_0: function () {
									var _p85 = _p87;
									if (_p85.ctor === 'Backlog') {
										var _p86 = _p62._1;
										if (_p86.ctor === 'Just') {
											return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p86._0);
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
										}
									} else {
										return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p87);
									}
								}(),
								_1: {ctor: '[]'}
							});
				...
				case 'LoadUser':
					...
					if (_p88.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p88._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p62._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p92 = _p62._0;
					var _p91 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v73_2:
					do {
						if (_p91.ctor === 'Just') {
							switch (_p91._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p92.number, _p91._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p92.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p94 = _p62._0;
					var highlightStory = function () {
						var _p93 = _moarwick$elm_webpack_starter$Route$parseHash(_p94);
						if ((_p93.ctor === 'Just') && (_p93._0.ctor === 'Story')) {
							return _p93._0._2;
						} else {
							return '';
						}
					}();
					var needFocus = (!_elm_lang$core$Native_Utils.eq(highlightStory, '')) && (!_elm_lang$core$Native_Utils.eq(highlightStory, model.highlightStory));
					var newRepository = _moarwick$elm_webpack_starter$Main$extractRepo(_p94.hash);
					var didSwitch = !_elm_lang$core$Native_Utils.eq(newRepository, model.repo);
					var prependNewRepositoryToRecent = {
						ctor: '::',
						_0: newRepository,
						_1: A2(
							_elm_lang$core$List$take,
					...
					var recentRepos = didSwitch ? model.recentRepos : prependNewRepositoryToRecent;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							location: _p94,
							didSwitch: didSwitch,
							repo: newRepository,
							needFocus: A2(_elm_lang$core$Debug$log, 'need focus', needFocus),
					...
					return A2(
						...
						A2(
							...
							needFocus ? {
								ctor: '::',
								_0: _moarwick$elm_webpack_starter$Main$focus(
									A2(_elm_lang$core$Debug$log, 'loc', _p94)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'}));
				case 'MilestoneIssuesLoaded':
					var _p102 = _p62._1;
					var updateMilestoneIssues = F2(
						function (issues, s) {
							var _p95 = s;
							if (_p95.ctor === 'Just') {
								var _p97 = _p95._0;
								var _p96 = _p102;
								if (_p96.ctor === 'OpenIssue') {
									var m = _p97.milestone;
							...
							return _elm_lang$core$Maybe$Just(
								A3(
									...
									updateMilestoneIssues(
										issues(_p62._2)),
									A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Dict$empty, milestones)));
						},
						model.milestones);
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
					...
					var mss = function () {
						var _p98 = A2(_elm_lang$core$Dict$get, model.repo, updatedModel.milestones);
						if (_p98.ctor === 'Just') {
							return _elm_lang$core$Dict$values(_p98._0);
						} else {
							return {ctor: '[]'};
						}
					}();
					var loaded = A3(
						...
						F2(
							function (ms, res) {
								var _p99 = _p102;
								if (_p99.ctor === 'ClosedIssue') {
									var _p100 = ms.closedIssues;
					...
					if (_p103.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p103._0))
								}),
							{ctor: '[]'});
					} else {
						var updatedMilestones = A3(
							...
							A2(
								_elm_lang$core$List$filter,
								function (ms) {
									return (!model.settings.powerOfNow) || (!_elm_lang$core$Native_Utils.eq(ms.dueOn, _elm_lang$core$Maybe$Nothing));
								},
								_p103._0));
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								milestones: A3(_elm_lang$core$Dict$insert, model.repo, updatedMilestones, model.milestones),
								recentRepos: recentRepos,
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
								...
								if (_p105.ctor === 'Just') {
									return {
										...
										_1: A2(
											...
											A2(
												_elm_lang$core$List$map,
												A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue),
												A2(
													_elm_lang$core$List$filter,
													function (ms) {
													...
													A2(
														...
														_elm_lang$core$Dict$values(updatedMilestones)))),
											A2(
												_elm_lang$core$List$map,
												A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue),
												A2(
													_elm_lang$core$List$filter,
													function (ms) {
					...
					if (_p106.ctor === 'Ok') {
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p106._0))
								}),
							{ctor: '[]'});
					}
				case 'IssuesLoaded':
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p62._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{lockedIssueNumber: '', etags: _elm_lang$core$Dict$empty}),
						{
							ctor: '::',
							_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p62._0),
							_1: {
								ctor: '::',
								_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
								_1: {ctor: '[]'}
				...
				case 'SetMilestone':
					var _p111 = _p62._1;
					var _p110 = _p62._0;
					var _p109 = model.accessToken;
					if (_p109.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p110.number}),
							{
								ctor: '::',
								_0: A5(
											...
											_0: {
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														0,
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p111.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p109._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p111)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p112.ctor === 'Just') {
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p112._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
					...
					return A2(
						...
						function () {
							...
							if (_p113.ctor === 'Just') {
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$OpenIssue, _p113._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
					...
					return A2(
						...
						function () {
							...
							if (_p114.ctor === 'Just') {
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$ClosedIssue, _p114._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
				...
				default:
					var _p121 = _p62._0;
					var _p115 = model.accessToken;
					if (_p115.ctor === 'Just') {
						var _p120 = _p115._0;
						var _p116 = _p62._1;
						switch (_p116) {
							case 'unplan':
								var _p117 = _p121.milestone;
								if (_p117.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p121.number}),
										{
											ctor: '::',
											_0: A5(
												_moarwick$elm_webpack_starter$Services$updateIssueWith,
												...
												_p120,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p117._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p121.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p118._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p120,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p121.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p121.number}),
									{
										...
										_0: A5(
											...
											_p120,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p121.milestone)),
										_1: {ctor: '[]'}
									});
							case 'restart':
								return A2(
										...
										{lockedIssueNumber: _p121.number}),
									{
										...
										_0: A5(
											...
											_p120,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p121.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p121)
										}),
									{ctor: '[]'});
							case 'ice':
								return A2(
													...
													return A2(
														...
														function (pinnedMilestones) {
															return A2(
																		...
																		function (recentRepos) {
																			return A2(
																				...
																				function (savedSearches) {
																					return _elm_lang$core$Json_Decode$succeed(
																						{accessToken: accessToken, columns: columns, defaultRepository: defaultRepository, defaultRepositoryType: defaultRepositoryType, doneLimit: doneLimit, pinnedMilestones: pinnedMilestones, powerOfNow: powerOfNow, recentRepos: recentRepos, savedSearches: savedSearches});
																				},
																				A2(
																					_elm_lang$core$Json_Decode$field,
																					'savedSearches',
																...
																A2(_elm_lang$core$Json_Decode$field, 'powerOfNow', _elm_lang$core$Json_Decode$bool));
														},
														A2(
															_elm_lang$core$Json_Decode$field,
															'pinnedMilestones',
...
if (typeof _moarwick$elm_webpack_starter$Main$main !== 'undefined') {
    _moarwick$elm_webpack_starter$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Models.IssueState":{"args":[],"tags":{"OpenIssue":[],"ClosedIssue":[]}},"Models.Column":{"args":[],"tags":{"Backlog":[],"Done":[],"Current":[],"Icebox":[],"Search":[]}},"Messages.Msg":{"args":[],"tags":{"CurrentTime":["Time.Time"],"ClearSearch":[],"UnsetMilestone":["Models.Milestone","Result.Result Http.Error Models.Issue"],"IssueAction":["Models.Issue","String"],"IssueRestarted":["Maybe.Maybe Models.Milestone","Result.Result Http.Error Models.Issue"],"CreateStory":["Models.Column"],"SearchBy":["String"],"NavigateToIssue":["( String, String )"],"CopyText":["String"],"StoryCreated":["Models.Column","Maybe.Maybe Models.Milestone","Result.Result Http.Error Models.Issue"],"IssueFinished":["Maybe.Maybe Models.Milestone","Result.Result Http.Error Models.Issue"],"EditAccessToken":["String"],"SelectStory":["Models.Issue"],"MilestoneIssuesLoaded":["String","Models.IssueState","String"],"EditNewStoryTitle":["String"],"MilestoneCreated":["Result.Result Http.Error Models.Milestone"],"IssuesSearchResults":["String"],"StoryFocused":[],"EditNewMilestoneTitle":["String"],"CreateNewMilestone":[],"SetMilestone":["Models.Issue","Models.Milestone"],"MilestoneSet":["Models.Milestone","Result.Result Http.Error Models.Issue"],"SearchIssues":[],"LoadUser":["Result.Result Http.Error Models.User"],"ShowIssueCreationForm":["Models.Column","String"],"UrlChange":["Navigation.Location"],"ChangeSearchTerms":["String"],"FilterStories":["String"],"FetchComplete":["String -> Messages.Msg","Result.Result Http.Error Models.CachedData"],"CurrentDate":["Date.Date"],"ReopenColumn":["Models.Column"],"ToggleSaveSearch":[],"IssuesLoaded":["Models.Column","String"],"IssueStarted":["Maybe.Maybe Models.Milestone","Result.Result Http.Error Models.Issue"],"SettingsMsgProxy":["Messages.SettingsMsg"],"LoadMilestones":["String"],"ChangeFilter":["String"],"SaveAccessToken":[],"NoOp":[],"UrgentIssueAdded":["Result.Result Http.Error Models.Issue"],"HideColumn":["Models.Column"],"DismissPlanningIssue":[],"PinMilestone":["String"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Models.CachedData":{"args":[],"tags":{"NotCached":["String"],"CachedData":["String","String","String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Messages.SettingsMsg":{"args":[],"tags":{"ChangeDefaultRepositoryType":["String"],"UpdateDefaultRepository":["String"],"ChangeDoneLimit":["String"],"IgnoreIdeas":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Models.Label":{"args":[],"type":"{ id : Base.Id, name : String, color : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Models.User":{"args":[],"type":"{ login : String, avatar : String }"},"Base.Id":{"args":[],"type":"String"},"Models.Milestone":{"args":[],"type":"{ id : Base.Id , number : Base.Id , state : String , title : String , description : Maybe.Maybe String , openIssues : Int , closedIssues : Int , dueOn : Maybe.Maybe Date.Date , htmlUrl : String }"},"Models.Issue":{"args":[],"type":"{ number : Base.Id , state : String , title : String , description : String , creator : Models.User , assignees : List Models.User , milestone : Maybe.Maybe Models.Milestone , htmlUrl : String , labels : List Models.Label , createdAt : Date.Date , updatedAt : Date.Date }"},"Time.Time":{"args":[],"type":"Float"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
