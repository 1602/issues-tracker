...
/***/ function(module, exports) {
			...
			_elm_lang$http$Http$request(
				{
					...
					expect: _elm_lang$http$Http$expectJson(_moarwick$elm_webpack_starter$Decoders$userDecoder),
					body: _elm_lang$http$Http$emptyBody,
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
				}));
	...
	var _moarwick$elm_webpack_starter$Services$repo = 'universalbasket/engineering';
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F3(
		function (accessToken, issueState, ms) {
			var state = function () {
				var _p0 = issueState;
				if (_p0.ctor === 'IssueOpen') {
					return '&state=open';
				} else {
					return '&state=closed';
				}
				...
				_elm_lang$http$Http$request(
					{
						...
						url: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_moarwick$elm_webpack_starter$Services$repo,
								A2(
									_elm_lang$core$Basics_ops['++'],
									'/issues?access_token=',
									A2(
	...
	var _moarwick$elm_webpack_starter$Services$updateIssueWith = F4(
		function (issueNumber, issue, accessToken, onComplete) {
			return A2(
				_elm_lang$http$Http$send,
				onComplete,
				_elm_lang$http$Http$request(
	...
	var _moarwick$elm_webpack_starter$Services$updateIssue = F3(
		function (issue, accessToken, onComplete) {
			return A2(
				_elm_lang$http$Http$send,
				onComplete,
				_elm_lang$http$Http$request(
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestones = function (accessToken) {
		return A2(
			_elm_lang$http$Http$send,
	...
	var _moarwick$elm_webpack_starter$Main$viewLink = F3(
		function (src, childNode, location) {
			var url = A2(_elm_lang$core$Basics_ops['++'], '#/', src);
			var isActive = A2(_elm_lang$core$String$startsWith, url, location.hash);
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											ctor: '::',
											_0: function () {
												var _p7 = expandedMilestone.milestone.dueOn;
												if (_p7.ctor === 'Just') {
													var _p8 = _p7._0;
													return (_elm_lang$core$Native_Utils.cmp(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															' due in ',
															A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, now, _p8)));
												} else {
						...
						A2(
							...
							function (s) {
								var isOverdue = function () {
									...
									if (_p11.ctor === 'Just') {
										return _elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$Date$toTime(_p11._0),
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p12._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p13.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p14, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
							...
							A2(
								_elm_lang$core$List$sortBy,
								function (s) {
									var _p15 = s.milestone.dueOn;
									if (_p15.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p15._0));
									} else {
										return 1 / 0;
									}
								},
		...
		if (_p25.ctor === 'Just') {
			...
			if (_p29.ctor === 'Nothing') {
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Bear the me. I\'m currently loading user information...'),
						_1: {ctor: '[]'}
					});
			}
		}
	...
	var _moarwick$elm_webpack_starter$Main$focus = function (loc) {
		var _p31 = _moarwick$elm_webpack_starter$Route$parseHash(loc);
		if ((_p31.ctor === 'Just') && (_p31._0.ctor === 'Story')) {
			return A2(
				_elm_lang$core$Task$attempt,
				function (s) {
					return A2(
				...
				_elm_lang$dom$Dom$focus(
					A2(_elm_lang$core$Basics_ops['++'], 'story-', _p31._0._0)));
		} else {
	...
	var _moarwick$elm_webpack_starter$Main$loadResource = function (model) {
		var _p32 = model.currentIssues;
		if (_p32.ctor === 'Nothing') {
			var _p33 = model.accessToken;
			if (_p33.ctor === 'Just') {
				var _p35 = _p33._0;
				var _p34 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
				if (_p34.ctor === 'Just') {
					switch (_p34._0.ctor) {
						case 'Story':
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p35);
						case 'IssuesIndex':
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p35);
						default:
							return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p35);
	...
	var _moarwick$elm_webpack_starter$Main$aboutToLoadResource = F2(
		function (loc, model) {
			...
			var _p36 = page;
			if ((_p36.ctor === 'Just') && (_p36._0.ctor === 'IssuesIndex')) {
				return model;
			} else {
				return model;
			}
	...
	var _moarwick$elm_webpack_starter$Main$update = F2(
		function (msg, model) {
			...
			switch (_p37.ctor) {
					...
					if (_p38.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									user: _elm_lang$core$Maybe$Just(_p38._0),
									error: _elm_lang$core$Maybe$Nothing
								}),
							{ctor: '[]'});
					} else {
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p37._0)
							}),
						function () {
							var _p39 = model.accessToken;
							if (_p39.ctor === 'Just') {
								return _moarwick$elm_webpack_starter$Main$loadAllIssues(_p39._0);
							} else {
								return {ctor: '[]'};
							}
						}());
				case 'SelectStory':
					var _p41 = _p37._0;
					var _p40 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v34_2:
					do {
						if (_p40.ctor === 'Just') {
							switch (_p40._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p41.number, _p40._0._0) ? _elm_lang$navigation$Navigation$modifyUrl('#/stories') : _elm_lang$navigation$Navigation$modifyUrl(
												A2(_elm_lang$core$Basics_ops['++'], '#/stories/', _p41.number)),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
										...
										A3(
											...
											function (s) {
												...
												if (_p44.ctor === 'Just') {
													var _p46 = _p44._0;
													var _p45 = _p37._1;
													if (_p45.ctor === 'IssueOpen') {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p46,
																{
																	openIssues: _elm_lang$core$Maybe$Just(_p47)
																}));
													} else {
														return _elm_lang$core$Maybe$Just(
															_elm_lang$core$Native_Utils.update(
																_p46,
																{
																	closedIssues: _elm_lang$core$Maybe$Just(_p47)
																}));
													}
												} else {
													return _elm_lang$core$Maybe$Nothing;
							...
							function () {
								...
								if (_p50.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p51, _moarwick$elm_webpack_starter$Models$IssueOpen),
											_p52),
										A2(
											_elm_lang$core$List$map,
											A2(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p51, _moarwick$elm_webpack_starter$Models$IssueClosed),
											_p52));
								} else {
									return {ctor: '[]'};
								}
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p55),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p55),
											error: _elm_lang$core$Maybe$Nothing
										}),
									{
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p37._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p56.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p57, _moarwick$elm_webpack_starter$Models$IssueOpen, _p37._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p57, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					var _p60 = _p37._1;
					var _p59 = _p37._0;
					var _p58 = model.accessToken;
					if (_p58.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p59.number}),
							{
								ctor: '::',
								_0: A4(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p60.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p58._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p60)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p61.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p62, _moarwick$elm_webpack_starter$Models$IssueOpen, _p37._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p62, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'IssueRestarted':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{lockedIssueNumber: ''}),
						function () {
							var _p63 = model.accessToken;
							if (_p63.ctor === 'Just') {
								var _p64 = _p63._0;
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p64, _moarwick$elm_webpack_starter$Models$IssueClosed, _p37._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p64, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p65.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p66, _moarwick$elm_webpack_starter$Models$IssueOpen, _p37._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p66, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
					...
					return A2(
						...
						function () {
							...
							if (_p67.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, _p68, _moarwick$elm_webpack_starter$Models$IssueClosed, _p37._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, _p68, _moarwick$elm_webpack_starter$Models$Current),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				default:
					...
					if (_p69.ctor === 'Just') {
						...
						switch (_p70) {
							case 'unplan':
								var _p71 = _p77.milestone;
								if (_p71.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p77.number}),
										{
											ctor: '::',
											_0: A3(
												...
												_p77,
												_p76,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p71._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p77.number}),
										{
											...
											_0: A4(
												...
												_p76,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p72._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p77.number}),
										{
											...
											_0: A4(
												...
												_p76,
												_moarwick$elm_webpack_starter$Messages$IssueFinished(_p73._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p77.number}),
										{
											...
											_0: A4(
												...
												_p76,
												_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p74._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'gh':
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$load(_p77.htmlUrl),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								var _p75 = _p77.milestone;
								if (_p75.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											...
											{lockedIssueNumber: _p77.number}),
										{
											...
											_0: A4(
												...
												_p76,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p75._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p77)
										}),
									{ctor: '[]'});
							default:
								return A2(
								...
								return function (h) {
									return function (i) {
										return function (j) {
											return function (k) {
												return function (l) {
													return {user: a, token: b, accessToken: c, location: d, now: e, error: f, currentIssues: g, iceboxIssues: h, closedIssues: i, milestones: j, pickMilestoneForIssue: k, lockedIssueNumber: l};
												};
											};
										};
									};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(location)(
				_elm_lang$core$Date$fromTime(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p78 = persistentData.accessToken;
								if (_p78.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p78._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
							_1: {
								ctor: '::',
								_0: function () {
									var _p79 = _moarwick$elm_webpack_starter$Route$parseHash(location);
