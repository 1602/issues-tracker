...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Services$fetchIssues = F2(
		function (model, column) {
			...
			var filterByUser = function () {
				...
				switch (_p5.ctor) {
					case 'CreatedBy':
						return A2(_elm_lang$core$Basics_ops['++'], '&creator=', _p5._0);
					case 'AssignedTo':
						return A2(_elm_lang$core$Basics_ops['++'], '&assignee=', _p5._0);
					case 'HasMentionOf':
						return A2(_elm_lang$core$Basics_ops['++'], '&mentioned=', _p5._0);
					default:
						return '';
				}
			}();
				...
				function (duration, interval) {
					return A2(
						...
						_justinmimbs$elm_date_extra$Date_Extra$toUtcIsoString(
							A3(_justinmimbs$elm_date_extra$Date_Extra$add, interval, duration, now)));
				});
			var since = function () {
				var _p6 = column;
				if (_p6.ctor === 'Done') {
	...
	var _moarwick$elm_webpack_starter$Services$fetchMilestoneIssues = F3(
		function (model, issueState, ms) {
			...
			var since = function () {
				var _p8 = issueState;
				if (_p8.ctor === 'IssueClosed') {
					var _p9 = model.settings.doneLimit;
					switch (_p9) {
						case 'a day':
							return A2(pastMoment, -1, _justinmimbs$elm_date_extra$Date_Extra$Day);
						case 'a week':
			...
			return {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Services$fetchMilestones, model.repo, _p5._0),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p43.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Main$viewTopbar, _p46, model),
					_1: {
						ctor: '::',
						_0: A3(
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p50 = page;
				if ((_p50.ctor === 'Just') && (_p50._0.ctor === 'Story')) {
					return _p50._0._2;
				} else {
					return '';
				}
			...
			var model = _moarwick$elm_webpack_starter$Models$Model(settings)(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				!_elm_lang$core$Native_Utils.eq(highlightStory, ''))(_moarwick$elm_webpack_starter$Models$Done)('')(_moarwick$elm_webpack_starter$Models$All)(showColumns)(pinnedMilestones)('')(recentRepos);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p51 = persistentData.accessToken;
								if (_p51.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p51._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
			...
			switch (_p53.ctor) {
				...
				case 'PinMilestone':
					...
					var pinnedMilestone = A2(
						...
						'',
						A2(_elm_lang$core$Dict$get, model.repo, model.pinnedMilestones));
					var n = _elm_lang$core$Native_Utils.eq(pinnedMilestone, _p54) ? '' : _p54;
					var updatedModel = _elm_lang$core$Native_Utils.update(
						model,
						{
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p57) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p58.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p58.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p58.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p53._0, addIssueToMilestone: _p53._1}),
						{
							ctor: '::',
													...
													_1: {
														...
														_0: {
															...
															_1: _elm_lang$core$Json_Encode$list(
																function () {
																	...
																	switch (_p60.ctor) {
																		case 'Backlog':
																			var _p61 = model.addIssueToMilestone;
																			if (_p61 === '') {
																				return {
																					ctor: '::',
														...
														_1: {
															...
															_0: {
																...
																_0: 'milestone',
																_1: function () {
																	var _p62 = model.addIssueToMilestone;
																	if (_p62 === '') {
															...
															_1: {
																...
																_0: {
																	...
																	_1: function () {
																		var _p63 = _p65;
																		if (_p63.ctor === 'Current') {
																			var _p64 = model.user;
																			if (_p64.ctor === 'Just') {
																				return _elm_lang$core$Json_Encode$list(
																					{
																						ctor: '::',
																						_0: _elm_lang$core$Json_Encode$string(_p64._0.login),
																						_1: {ctor: '[]'}
																					});
																			} else {
																				return _elm_lang$core$Json_Encode$list(
						...
						if (_p67.ctor === 'Just') {
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p68 = _p70;
										if (_p68.ctor === 'Backlog') {
											var _p69 = _p53._1;
											if (_p69.ctor === 'Just') {
												return A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p69._0);
											} else {
												return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _p70);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p71.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p71._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p53._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p73 = _p53._0;
					var _p72 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v59_2:
					do {
						if (_p72.ctor === 'Just') {
							switch (_p72._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p73.number, _p72._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p73.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p74 = _p53._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p74.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p74, repo: repo, currentIssues: issues, milestones: milestones, recentRepos: recentRepos}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
				case 'MilestoneIssuesLoaded':
					...
					if (_p75.ctor === 'Err') {
									...
									A3(
										...
										function (s) {
											...
											if (_p76.ctor === 'Just') {
												var _p78 = _p76._0;
												var _p77 = _p84;
												if (_p77.ctor === 'IssueOpen') {
													var m = _p78.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p83)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p78,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p83),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p83)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p78,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p83),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p79 = updatedModel.milestones;
							if (_p79.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p79._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p80 = _p84;
									if (_p80.ctor === 'IssueClosed') {
										var _p81 = ms.closedIssues;
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p92),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p92),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p92),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
				...
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p53._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p93.ctor === 'Just') {
								return {
									ctor: '::',
									_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p53._0),
									_1: {
										ctor: '::',
										_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p98.ctor === 'Just') {
								...
								if (_p99.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p99._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p100.ctor === 'Just') {
								...
								if (_p101.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueOpen, _p101._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p102.ctor === 'Just') {
								...
								if (_p103.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A3(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model, _moarwick$elm_webpack_starter$Models$IssueClosed, _p103._0),
										_1: {
											ctor: '::',
											_0: A2(_moarwick$elm_webpack_starter$Services$fetchIssues, model, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
