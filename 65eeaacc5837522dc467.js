		...
		function (user, model, route) {
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_0: 'width',
										_1: function () {
											var _p25 = _elm_lang$core$List$length(model.showColumns);
											switch (_p25) {
												case 3:
													return '33.33%';
												case 2:
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'padding-left', _1: '2px'},
											_1: {ctor: '[]'}
										}
									}
								}),
																			...
																			return A2(
																				...
																				_elm_lang$core$Basics$toString(
																					(_elm_lang$core$Time$inHours(
																						_elm_lang$core$Date$toTime(_p28._0)) / 12) - (_elm_lang$core$Time$inHours(
														...
														function () {
															...
															if (_p29.ctor === 'Just') {
																...
																return isOverdue ? A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		A2(_alpacaaa$elm_date_distance$Date_Distance$inWords, _p30, model.now),
																		' overdue)')) : A2(
																	_elm_lang$core$Basics_ops['++'],
																	' (due in ',
																	A2(
								...
								function (s) {
									...
									if (_p31.ctor === 'Just') {
										return _elm_lang$core$Time$inHours(
											_elm_lang$core$Date$toTime(_p31._0));
									} else {
										return 1 / 0;
									}
								},
				...
				function (head, filter, issues, col, addto, milestoneNumber) {
					...
					if (_p32.ctor === 'Just') {
						return A7(
							...
							head,
							true,
							A2(_elm_lang$core$List$filter, filter, _p32._0),
							col,
							model,
							addto,
							milestoneNumber);
			...
			var displayIssuesWithinMilestones = F2(
				function (milestones, issueState) {
					...
					if (_p33.ctor === 'Just') {
						var _p37 = _p33._0;
						var mss = _elm_lang$core$Dict$values(_p37);
						var loaded = A3(
							_elm_lang$core$List$foldl,
							F2(
								function (ms, res) {
									var _p34 = issueState;
									if (_p34.ctor === 'IssueClosed') {
										var _p35 = ms.closedIssues;
						...
						return _elm_lang$core$Native_Utils.eq(total, loaded) ? _elm_lang$core$Maybe$Just(
							A4(_moarwick$elm_webpack_starter$Main$listIssuesWithinMilestones, _p37, issueState, model.now, model)) : _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$span,
								{
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Maybe$andThen,
								function (htmlNode) {
									var _p38 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueOpen);
									if (_p38.ctor === 'Just') {
										return _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Maybe$andThen,
										function (htmlNode) {
											var _p39 = A2(displayIssuesWithinMilestones, model.milestones, _moarwick$elm_webpack_starter$Models$IssueClosed);
											if (_p39.ctor === 'Just') {
												return _elm_lang$core$Maybe$Just(
													A2(
														_elm_lang$html$Html$div,
	...
	var _moarwick$elm_webpack_starter$Main$view = function (model) {
		...
		if (_p43.ctor === 'Just') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: A3(_moarwick$elm_webpack_starter$Main$viewTopbar, _p46, model.location, model),
					_1: {
						ctor: '::',
						_0: A3(
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p44 = model.pickMilestoneForIssue;
									if (_p44.ctor === 'Just') {
										var _p45 = _p44._0;
										return A2(
											_elm_lang$html$Html$div,
												...
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], '#', _p45.number)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p45.title)),
														_1: {
															ctor: '::',
															_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							_elm_lang$html$Html$button,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(
																									A2(_moarwick$elm_webpack_starter$Messages$SetMilestone, _p45, s.milestone)),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
			...
			switch (_p49.ctor) {
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								showColumns: A2(
									_elm_lang$core$List$filter,
									function (a) {
										return !_elm_lang$core$Native_Utils.eq(a, _p49._0);
									},
									model.showColumns)
							}),
						{ctor: '[]'});
						...
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								filter: function () {
									...
									switch (_p51) {
										case 'assigned to me':
											return _moarwick$elm_webpack_starter$Models$AssignedTo(_p52.login);
										case 'created by me':
											return _moarwick$elm_webpack_starter$Models$CreatedBy(_p52.login);
										case 'mentioning me':
											return _moarwick$elm_webpack_starter$Models$HasMentionOf(_p52.login);
										default:
				...
				case 'ShowIssueCreationForm':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{addIssueToColumn: _p49._0, addIssueToMilestone: _p49._1}),
						{ctor: '[]'});
						...
						return A2(
							...
							(!_elm_lang$core$Native_Utils.eq(model.newIssueTitle, '')) ? {
								...
								_0: A4(
													...
													_1: {
																...
																if (_p55.ctor === 'Just') {
																	return _elm_lang$core$Json_Encode$int(
																		A2(
																			_elm_lang$core$Result$withDefault,
																			0,
																			_elm_lang$core$String$toInt(_p55._0.number)));
																} else {
														...
														_1: {
															...
															_0: {
																...
																_1: function () {
																	var _p56 = _p58;
																	if (_p56.ctor === 'Current') {
																		var _p57 = model.user;
																		if (_p57.ctor === 'Just') {
																			return _elm_lang$core$Json_Encode$list(
																				{
																					ctor: '::',
																					_0: _elm_lang$core$Json_Encode$string(_p57._0.login),
																					_1: {ctor: '[]'}
																				});
																		} else {
																			return _elm_lang$core$Json_Encode$list(
									...
									A2(_moarwick$elm_webpack_starter$Messages$StoryCreated, _p58, _p59)),
								_1: {ctor: '[]'}
							} : {ctor: '[]'});
					} else {
						return A2(
						...
						if (_p61.ctor === 'Just') {
							...
							return A2(
								...
								model,
								{
									...
									_0: function () {
										var _p62 = _p65;
										if (_p62.ctor === 'Backlog') {
											var _p63 = _p49._1;
											if (_p63.ctor === 'Just') {
												return A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p64, _moarwick$elm_webpack_starter$Models$IssueOpen, _p63._0);
											} else {
												return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p64, _moarwick$elm_webpack_starter$Models$Icebox);
											}
										} else {
											return A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p64, _p65);
										}
									}(),
									_1: {ctor: '[]'}
								});
				...
				case 'LoadUser':
					...
					if (_p66.ctor === 'Ok') {
						var updatedModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p66._0),
								error: _elm_lang$core$Maybe$Nothing
							});
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'CurrentTime':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								now: _elm_lang$core$Date$fromTime(_p49._0)
							}),
						_moarwick$elm_webpack_starter$Main$loadAllIssues(model));
				case 'SelectStory':
					var _p68 = _p49._0;
					var _p67 = _moarwick$elm_webpack_starter$Route$parseHash(model.location);
					_v53_2:
					do {
						if (_p67.ctor === 'Just') {
							switch (_p67._0.ctor) {
								case 'Story':
									return A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(_p68.number, _p67._0._2) ? _elm_lang$navigation$Navigation$modifyUrl(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'#/',
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														model.repo,
														A2(_elm_lang$core$Basics_ops['++'], '/stories/', _p68.number)))),
											_1: {ctor: '[]'}
										});
								case 'IssuesIndex':
									return A2(
				...
				case 'UrlChange':
					var _p69 = _p49._0;
					var repo = _moarwick$elm_webpack_starter$Main$extractRepo(_p69.hash);
					...
					var updatedModel = A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{location: _p69, repo: repo, currentIssues: issues, milestones: milestones}));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						updatedModel,
						_moarwick$elm_webpack_starter$Main$loadResource(updatedModel));
					...
					if (_p70.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p70._0))
								}),
							{ctor: '[]'});
					} else {
						var _p78 = _p70._0;
									...
									A3(
										...
										function (s) {
											...
											if (_p71.ctor === 'Just') {
												var _p73 = _p71._0;
												var _p72 = _p79;
												if (_p72.ctor === 'IssueOpen') {
													var m = _p73.milestone;
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															openIssues: _elm_lang$core$List$length(_p78)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p73,
															{
																openIssues: _elm_lang$core$Maybe$Just(_p78),
													...
													var updatedMilestone = _elm_lang$core$Native_Utils.update(
														m,
														{
															closedIssues: _elm_lang$core$List$length(_p78)
														});
													return _elm_lang$core$Maybe$Just(
														_elm_lang$core$Native_Utils.update(
															_p73,
															{
																closedIssues: _elm_lang$core$Maybe$Just(_p78),
																milestone: m
															}));
												}
											} else {
						...
						var mss = function () {
							var _p74 = updatedModel.milestones;
							if (_p74.ctor === 'Just') {
								return _elm_lang$core$Dict$values(_p74._0);
							} else {
								return {ctor: '[]'};
							}
						}();
						var loaded = A3(
							...
							F2(
								function (ms, res) {
									var _p75 = _p79;
									if (_p75.ctor === 'IssueClosed') {
										var _p76 = ms.closedIssues;
					...
					if (_p80.ctor === 'Err') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p80._0))
								}),
							{ctor: '[]'});
					} else {
						var _p84 = _p80._0;
							...
							function () {
								...
								if (_p82.ctor === 'Just') {
									...
									return A2(
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p83, _moarwick$elm_webpack_starter$Models$IssueOpen),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
										...
										A2(
											_elm_lang$core$List$map,
											A4(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p83, _moarwick$elm_webpack_starter$Models$IssueClosed),
											A2(
												_elm_lang$core$List$filter,
												function (ms) {
					...
					if (_p86.ctor === 'Ok') {
							...
							case 'Current':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											currentIssues: _elm_lang$core$Maybe$Just(_p88),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Icebox':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											iceboxIssues: _elm_lang$core$Maybe$Just(_p88),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
							...
							case 'Done':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											closedIssues: _elm_lang$core$Maybe$Just(_p88),
											error: _elm_lang$core$Maybe$Nothing
										}),
									model.needFocus ? {
										ctor: '::',
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Basics$toString(_p86._0))
								}),
							{ctor: '[]'});
					}
				case 'CopyText':
					return A2(
						...
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$clipboard(_p49._0),
							_1: {ctor: '[]'}
						});
				case 'UnsetMilestone':
					return A2(
						...
						function () {
							...
							if (_p89.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p90, _moarwick$elm_webpack_starter$Models$IssueOpen, _p49._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p90, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
				...
				case 'SetMilestone':
					...
					if (_p91.ctor === 'Just') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{pickMilestoneForIssue: _elm_lang$core$Maybe$Nothing, lockedIssueNumber: _p92.number}),
							{
								ctor: '::',
								_0: A5(
												...
												_1: _elm_lang$core$Json_Encode$int(
													A2(
														...
														_elm_lang$core$Result$toMaybe(
															_elm_lang$core$String$toInt(_p93.number))))
											},
											_1: {ctor: '[]'}
										}),
									_p91._0,
									_moarwick$elm_webpack_starter$Messages$MilestoneSet(_p93)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
					...
					return A2(
						...
						function () {
							...
							if (_p94.ctor === 'Just') {
								...
								return {
									ctor: '::',
									_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p95, _moarwick$elm_webpack_starter$Models$IssueOpen, _p49._0),
									_1: {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p95, _moarwick$elm_webpack_starter$Models$Icebox),
										_1: {ctor: '[]'}
									}
								};
							} else {
						...
						function () {
							...
							if (_p96.ctor === 'Just') {
								...
								if (_p97.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$IssueClosed, _p97._0),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
										}
									};
								} else {
									return {
										ctor: '::',
										_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$Done),
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p98, _moarwick$elm_webpack_starter$Models$Current),
											_1: {ctor: '[]'}
						...
						function () {
							...
							if (_p99.ctor === 'Just') {
								...
								if (_p100.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$IssueOpen, _p100._0),
										_1: {
											ctor: '::',
									...
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p101, _moarwick$elm_webpack_starter$Models$Icebox),
											_1: {ctor: '[]'}
										}
									};
								}
						...
						function () {
							...
							if (_p102.ctor === 'Just') {
								...
								if (_p103.ctor === 'Just') {
									return {
										ctor: '::',
										_0: A5(_moarwick$elm_webpack_starter$Services$fetchMilestoneIssues, model.filter, model.repo, _p104, _moarwick$elm_webpack_starter$Models$IssueClosed, _p103._0),
										_1: {
											ctor: '::',
									...
									return {
										...
										_1: {
											ctor: '::',
											_0: A4(_moarwick$elm_webpack_starter$Services$fetchIssues, model.filter, model.repo, _p104, _moarwick$elm_webpack_starter$Models$Done),
											_1: {ctor: '[]'}
										}
									};
								}
				...
				default:
					...
					if (_p105.ctor === 'Just') {
						...
						switch (_p106) {
							case 'unplan':
								var _p107 = _p110.milestone;
								if (_p107.ctor === 'Just') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
											{lockedIssueNumber: _p110.number}),
										{
											ctor: '::',
											_0: A4(
												...
												_p110,
												_p109,
												_moarwick$elm_webpack_starter$Messages$UnsetMilestone(_p107._0)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
									...
									return A2(
											...
											{lockedIssueNumber: _p110.number}),
										{
											...
											_0: A5(
														...
														_1: {
															...
															_0: {
																...
																_1: _elm_lang$core$Json_Encode$list(
																	{
																		ctor: '::',
																		_0: _elm_lang$core$Json_Encode$string(_p108._0.login),
																		_1: {ctor: '[]'}
																	})
															},
															_1: {ctor: '[]'}
												...
												_p109,
												_moarwick$elm_webpack_starter$Messages$IssueStarted(_p110.milestone)),
											_1: {ctor: '[]'}
										});
								} else {
									return A2(
								...
								return A2(
										...
										{lockedIssueNumber: _p110.number}),
									{
										...
										_0: A5(
											...
											_p109,
											_moarwick$elm_webpack_starter$Messages$IssueFinished(_p110.milestone)),
										_1: {ctor: '[]'}
									});
							case 'reopen':
								return A2(
										...
										{lockedIssueNumber: _p110.number}),
									{
										...
										_0: A5(
											...
											_p109,
											_moarwick$elm_webpack_starter$Messages$IssueRestarted(_p110.milestone)),
										_1: {ctor: '[]'}
									});
							case 'unstart':
								return A2(
							...
							case 'plan':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											pickMilestoneForIssue: _elm_lang$core$Maybe$Just(_p110)
										}),
									{ctor: '[]'});
							case 'put on ice':
								return A2(
																	...
																	return function (q) {
																		return function (r) {
																			return function (s) {
																				return function (t) {
																					return function (u) {
																						return {user: a, token: b, accessToken: c, repo: d, location: e, now: f, error: g, currentIssues: h, iceboxIssues: i, closedIssues: j, milestones: k, pickMilestoneForIssue: l, lockedIssueNumber: m, highlightStory: n, newMilestoneTitle: o, newIssueTitle: p, needFocus: q, addIssueToColumn: r, addIssueToMilestone: s, filter: t, showColumns: u};
																					};
																				};
																			};
																		};
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p111 = page;
				if ((_p111.ctor === 'Just') && (_p111._0.ctor === 'Story')) {
					return _p111._0._2;
				} else {
					return '';
				}
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p112 = persistentData.accessToken;
								if (_p112.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p112._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
