...
/***/ function(module, exports) {
	...
	var _moarwick$elm_webpack_starter$Models$PersistedData = F3(
		function (a, b, c) {
			return {accessToken: a, pinnedMilestones: b, columns: c};
		});
	...
	var _moarwick$elm_webpack_starter$Main$init = F2(
		function (persistentData, location) {
			...
			var highlightStory = function () {
				var _p115 = page;
				if ((_p115.ctor === 'Just') && (_p115._0.ctor === 'Story')) {
					return _p115._0._2;
				} else {
					return '';
				}
			...
			var model = _moarwick$elm_webpack_starter$Main$Model(_elm_lang$core$Maybe$Nothing)('')(persistentData.accessToken)(
				...
				!_elm_lang$core$Native_Utils.eq(highlightStory, ''))(_moarwick$elm_webpack_starter$Models$Done)('')(_moarwick$elm_webpack_starter$Models$All)(showColumns)(pinnedMilestones);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							ctor: '::',
							_0: function () {
								var _p116 = persistentData.accessToken;
								if (_p116.ctor === 'Just') {
									return _moarwick$elm_webpack_starter$Services$fetchUser(_p116._0);
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
					...
					function (columns) {
						return A2(
							...
							function (pinnedMilestones) {
								return _elm_lang$core$Json_Decode$succeed(
									{accessToken: accessToken, columns: columns, pinnedMilestones: pinnedMilestones});
							},
							A2(
